...
(function() {
  ...
  MediaMetricsProvider_SetVideoPipelineInfo_Params.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, media_types$.VideoDecoderInfo, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  MediaMetricsProvider_SetVideoPipelineInfo_Params.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.info =
        decoder.decodeStructPointer(media_types$.VideoDecoderInfo);
    return val;
  };
  ...
  MediaMetricsProvider_SetVideoPipelineInfo_Params.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    encoder.encodeStructPointer(media_types$.VideoDecoderInfo, val.info);
  };
  ...
  MediaMetricsProvider_SetAudioPipelineInfo_Params.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, media_types$.AudioDecoderInfo, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  MediaMetricsProvider_SetAudioPipelineInfo_Params.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.info =
        decoder.decodeStructPointer(media_types$.AudioDecoderInfo);
    return val;
  };
  ...
  MediaMetricsProvider_SetAudioPipelineInfo_Params.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    encoder.encodeStructPointer(media_types$.AudioDecoderInfo, val.info);
  };
  var kMediaMetricsProvider_Initialize_Name = 630730718;
  var kMediaMetricsProvider_OnError_Name = 577405163;
  var kMediaMetricsProvider_SetHasPlayed_Name = 1316474168;
  var kMediaMetricsProvider_SetHaveEnough_Name = 1473158543;
  var kMediaMetricsProvider_SetIsEME_Name = 23314818;
  var kMediaMetricsProvider_SetTimeToMetadata_Name = 720006698;
  var kMediaMetricsProvider_SetTimeToFirstFrame_Name = 1669971122;
  var kMediaMetricsProvider_SetTimeToPlayReady_Name = 714218122;
  var kMediaMetricsProvider_SetContainerName_Name = 530365286;
  var kMediaMetricsProvider_AcquireWatchTimeRecorder_Name = 117038429;
  var kMediaMetricsProvider_AcquireVideoDecodeStatsRecorder_Name = 10688362;
  var kMediaMetricsProvider_AcquireLearningTaskController_Name = 1775070434;
  var kMediaMetricsProvider_AcquirePlaybackEventsRecorder_Name = 755894110;
  var kMediaMetricsProvider_SetHasAudio_Name = 492197537;
  var kMediaMetricsProvider_SetHasVideo_Name = 445754801;
  var kMediaMetricsProvider_SetVideoPipelineInfo_Name = 1761104394;
  var kMediaMetricsProvider_SetAudioPipelineInfo_Name = 1054419926;
