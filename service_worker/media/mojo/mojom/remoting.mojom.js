...
(function() {
  ...
  Remoter_Stop_Params.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.reason =
        decoder.decodeStruct(new codec.Enum(remoting_common$.RemotingStopReason));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  RemotingSource_OnStartFailed_Params.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.reason =
        decoder.decodeStruct(new codec.Enum(remoting_common$.RemotingStartFailReason));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  var kRemoterFactory_Create_Name = 1377467876;
  ...
  var kRemotingDataStreamSender_SendFrame_Name = 301949018;
  var kRemotingDataStreamSender_CancelInFlightData_Name = 1627315954;
  ...
  var kRemoter_Start_Name = 1957859074;
  var kRemoter_StartDataStreams_Name = 1169701755;
  var kRemoter_Stop_Name = 1315980222;
  var kRemoter_SendMessageToSink_Name = 1867559106;
  var kRemoter_EstimateTransmissionCapacity_Name = 188637876;
  ...
  var kRemotingSource_OnSinkAvailable_Name = 888415498;
  var kRemotingSource_OnSinkGone_Name = 781412975;
  var kRemotingSource_OnStarted_Name = 1230992057;
  var kRemotingSource_OnStartFailed_Name = 1098809954;
  var kRemotingSource_OnMessageFromSink_Name = 2139245909;
  var kRemotingSource_OnStopped_Name = 1277894170;
  ...
  var kRemotee_OnRemotingSinkReady_Name = 758899071;
  var kRemotee_SendMessageToSource_Name = 1776776353;
  var kRemotee_StartDataStreams_Name = 1216865062;
  var kRemotee_OnFlushUntil_Name = 1292719986;
  var kRemotee_OnVideoNaturalSizeChange_Name = 1630125044;
  ...
  var kRemotingSink_OnMessageFromSource_Name = 1362702173;
  ...
  var kRemotingDataStreamReceiver_InitializeDataPipe_Name = 868833827;
  var kRemotingDataStreamReceiver_ReceiveFrame_Name = 1725149626;
  var kRemotingDataStreamReceiver_FlushUntil_Name = 2037944600;
