...
(function() {
  ...
  Decryptor_Decrypt_Params.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.streamType =
        decoder.decodeStruct(new codec.Enum(Decryptor.StreamType));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  Decryptor_Decrypt_ResponseParams.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.status =
        decoder.decodeStruct(new codec.Enum(Decryptor.Status));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  var kDecryptor_Initialize_Name = 1379273779;
  var kDecryptor_Decrypt_Name = 1543462971;
  var kDecryptor_CancelDecrypt_Name = 1525797326;
  var kDecryptor_InitializeAudioDecoder_Name = 1385440553;
  var kDecryptor_InitializeVideoDecoder_Name = 2049775977;
  var kDecryptor_DecryptAndDecodeAudio_Name = 1225261663;
  var kDecryptor_DecryptAndDecodeVideo_Name = 1106238359;
  var kDecryptor_ResetDecoder_Name = 1571409523;
  var kDecryptor_DeinitializeDecoder_Name = 549552200;
  ...
  Decryptor.Status.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  Decryptor.StreamType.toKnownEnumValue = function(value) {
    return value;
  };
