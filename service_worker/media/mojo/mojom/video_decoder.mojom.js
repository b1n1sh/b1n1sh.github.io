...
(function() {
  ...
  VideoDecoderImplementation.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  VideoDecoder_Construct_Params.decode = function(decoder) {
    ...
    val.implementation =
        decoder.decodeStruct(new codec.Enum(VideoDecoderImplementation));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  var kVideoFrameHandleReleaser_ReleaseVideoFrame_Name = 1978957482;
  ...
  var kVideoDecoder_GetSupportedConfigs_Name = 1274729986;
  var kVideoDecoder_Construct_Name = 1965233525;
  var kVideoDecoder_Initialize_Name = 1734849782;
  var kVideoDecoder_Decode_Name = 2059137776;
  var kVideoDecoder_Reset_Name = 1970932482;
  var kVideoDecoder_OnOverlayInfoChanged_Name = 1836032868;
  ...
  var kVideoDecoderClient_OnVideoFrameDecoded_Name = 322354009;
  var kVideoDecoderClient_OnWaiting_Name = 673173539;
  var kVideoDecoderClient_RequestOverlayInfo_Name = 871853623;
