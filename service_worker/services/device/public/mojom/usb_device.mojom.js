...
(function() {
  ...
  UsbOpenDeviceError.ACCESS_DENIED = 1;
  UsbOpenDeviceError.ALREADY_OPEN = 2;
  ...
  UsbOpenDeviceError.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  UsbTransferDirection.OUTBOUND = 1;
  ...
  UsbTransferDirection.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  UsbControlTransferType.CLASS = 1;
  UsbControlTransferType.VENDOR = 2;
  UsbControlTransferType.RESERVED = 3;
  ...
  UsbControlTransferType.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  UsbControlTransferRecipient.INTERFACE = 1;
  UsbControlTransferRecipient.ENDPOINT = 2;
  UsbControlTransferRecipient.OTHER = 3;
  ...
  UsbControlTransferRecipient.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  UsbTransferType.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  UsbSynchronizationType.ASYNCHRONOUS = 1;
  UsbSynchronizationType.ADAPTIVE = 2;
  UsbSynchronizationType.SYNCHRONOUS = 3;
  ...
  UsbSynchronizationType.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  var UsbUsageType = {};
  UsbUsageType.DATA = 0;
  UsbUsageType.FEEDBACK = 1;
  UsbUsageType.EXPLICIT_FEEDBACK = 2;
  UsbUsageType.PERIODIC = 3;
  UsbUsageType.NOTIFICATION = 4;
  UsbUsageType.RESERVED = 5;
  ...
  UsbUsageType.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  UsbTransferStatus.TRANSFER_ERROR = 1;
  UsbTransferStatus.TIMEOUT = 2;
  UsbTransferStatus.CANCELLED = 3;
  UsbTransferStatus.STALLED = 4;
  UsbTransferStatus.DISCONNECT = 5;
  UsbTransferStatus.BABBLE = 6;
  UsbTransferStatus.SHORT_PACKET = 7;
  UsbTransferStatus.PERMISSION_DENIED = 8;
  ...
  UsbTransferStatus.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  UsbEndpointInfo.decode = function(decoder) {
    ...
    decoder.skip(1);
    val.direction =
        decoder.decodeStruct(new codec.Enum(UsbTransferDirection));
    val.type =
        decoder.decodeStruct(new codec.Enum(UsbTransferType));
    val.packetSize =
        decoder.decodeStruct(codec.Uint32);
    val.synchronizationType =
        decoder.decodeStruct(new codec.Enum(UsbSynchronizationType));
    val.usageType =
        decoder.decodeStruct(new codec.Enum(UsbUsageType));
    val.extraData =
  ...
  UsbAlternateInterfaceInfo.decode = function(decoder) {
    ...
    val.endpoints =
        decoder.decodeArrayPointer(new codec.PointerTo(UsbEndpointInfo));
    val.extraData =
        decoder.decodeArrayPointer(codec.Uint8);
    return val;
  };
  ...
  UsbInterfaceInfo.decode = function(decoder) {
    ...
    decoder.skip(1);
    val.alternates =
        decoder.decodeArrayPointer(new codec.PointerTo(UsbAlternateInterfaceInfo));
    return val;
  };
  ...
  UsbConfigurationInfo.decode = function(decoder) {
    ...
    val.configurationName =
        decoder.decodeStructPointer(string16$.String16);
    val.interfaces =
        decoder.decodeArrayPointer(new codec.PointerTo(UsbInterfaceInfo));
    val.extraData =
        decoder.decodeArrayPointer(codec.Uint8);
    return val;
  };
  ...
  UsbDeviceInfo.decode = function(decoder) {
    ...
    val.productId =
        decoder.decodeStruct(codec.Uint16);
    val.deviceVersionMajor =
        decoder.decodeStruct(codec.Uint8);
    val.deviceVersionMinor =
        decoder.decodeStruct(codec.Uint8);
    val.deviceVersionSubminor =
        decoder.decodeStruct(codec.Uint8);
    ...
    val.serialNumber =
        decoder.decodeStructPointer(string16$.String16);
    val.webusbLandingPage =
        decoder.decodeStructPointer(url$.Url);
    val.configurations =
        decoder.decodeArrayPointer(new codec.PointerTo(UsbConfigurationInfo));
    return val;
  };
  ...
  UsbControlTransferParams.SECURITY_KEY_AOA_MODEL = "12eba9f901039b36";
  ...
  UsbControlTransferParams.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.type =
        decoder.decodeStruct(new codec.Enum(UsbControlTransferType));
    val.recipient =
        decoder.decodeStruct(new codec.Enum(UsbControlTransferRecipient));
    val.request =
        decoder.decodeStruct(codec.Uint8);
    decoder.skip(1);
    val.value =
  ...
  UsbIsochronousPacket.decode = function(decoder) {
    ...
    val.length =
        decoder.decodeStruct(codec.Uint32);
    val.transferredLength =
        decoder.decodeStruct(codec.Uint32);
    val.status =
        decoder.decodeStruct(new codec.Enum(UsbTransferStatus));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  UsbDevice_Open_ResponseParams.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.error =
        decoder.decodeStruct(new codec.Enum(UsbOpenDeviceError));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  UsbDevice_ClearHalt_Params.validate = function(messageValidator, offset) {
    ...
    // validate UsbDevice_ClearHalt_Params.direction
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 0, UsbTransferDirection);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  UsbDevice_ControlTransferIn_Params.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.params =
        decoder.decodeStructPointer(UsbControlTransferParams);
    val.length =
        decoder.decodeStruct(codec.Uint32);
    val.timeout =
        decoder.decodeStruct(codec.Uint32);
  ...
  UsbDevice_IsochronousTransferIn_ResponseParams.decode = function(decoder) {
    ...
    val.data =
        decoder.decodeArrayPointer(codec.Uint8);
    val.packets =
        decoder.decodeArrayPointer(new codec.PointerTo(UsbIsochronousPacket));
    return val;
  };
  ...
  UsbDeviceProxy.prototype.clearHalt = function(direction, endpointNumber) {
  ...
  UsbDeviceStub.prototype.clearHalt = function(direction, endpointNumber) {
    return this.delegate_ && this.delegate_.clearHalt && this.delegate_.clearHalt(direction, endpointNumber);
  }
  ...
  UsbDeviceStub.prototype.acceptWithResponder =
    ...
    case kUsbDevice_ClearHalt_Name:
      ...
      this.clearHalt(params.direction, params.endpointNumber).then(function(response) {
        var responseParams =
