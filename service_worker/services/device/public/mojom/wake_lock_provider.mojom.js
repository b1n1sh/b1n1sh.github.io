...
(function() {
  ...
  WakeLockProvider_GetWakeLockWithoutContext_Params.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.type =
        decoder.decodeStruct(new codec.Enum(wake_lock$.WakeLockType));
    val.reason =
        decoder.decodeStruct(new codec.Enum(wake_lock$.WakeLockReason));
    val.description =
  ...
  var kWakeLockProvider_GetWakeLockContextForID_Name = 2091582122;
  var kWakeLockProvider_GetWakeLockWithoutContext_Name = 1518916744;
  var kWakeLockProvider_NotifyOnWakeLockDeactivation_Name = 276921000;
  var kWakeLockProvider_GetActiveWakeLocksForTests_Name = 1487222062;
  ...
  var kWakeLockObserver_OnWakeLockDeactivated_Name = 588053497;
