...
(function() {
  ...
  HostResolveOperation.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  ProxyResolverRequestClient_ResolveDns_Params.decode = function(decoder) {
    ...
    val.host =
        decoder.decodeStruct(codec.String);
    val.operation =
        decoder.decodeStruct(new codec.Enum(HostResolveOperation));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  var kHostResolverRequestClient_ReportResult_Name = 589363905;
  ...
  var kProxyResolver_GetProxyForUrl_Name = 18014856;
  ...
  var kProxyResolverRequestClient_ReportResult_Name = 1379670924;
  var kProxyResolverRequestClient_Alert_Name = 1832820094;
  var kProxyResolverRequestClient_OnError_Name = 1255265175;
  var kProxyResolverRequestClient_ResolveDns_Name = 1292741664;
  ...
  var kProxyResolverFactory_CreateResolver_Name = 686035766;
  ...
  var kProxyResolverFactoryRequestClient_ReportResult_Name = 147776941;
  var kProxyResolverFactoryRequestClient_Alert_Name = 1457785647;
  var kProxyResolverFactoryRequestClient_OnError_Name = 1509967180;
  var kProxyResolverFactoryRequestClient_ResolveDns_Name = 1897571638;
