...
(function() {
  ...
  var auth_and_certificate_observer$ =
      mojo.internal.exposeNamespace('network.mojom');
  if (mojo.config.autoLoadMojomDeps) {
    mojo.internal.loadMojomIfNecessary(
        'services/network/public/mojom/auth_and_certificate_observer.mojom', 'auth_and_certificate_observer.mojom.js');
  }
  ...
  NetworkContextParams.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 176, CertVerifierServiceRemoteParams, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate NetworkContextParams.cookieManagerParams
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 184, cookie_manager$.CookieManagerParams, true);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 200, time$.TimeDelta, true);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 208, 8, new codec.PointerTo(cors_origin_pattern$.CorsOriginAccessPatterns), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 232, file_path$.FilePath, true);
    if (err !== validator.validationError.NONE)
        return err;


    // validate NetworkContextParams.httpAuthStaticNetworkContextParams
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 240, HttpAuthStaticNetworkContextParams, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  URLLoaderFactoryParams.prototype.initDefaults_ = function() {
    ...
    this.authCertObserver = new auth_and_certificate_observer$.AuthenticationAndCertificateObserverPtr();
  ...
  URLLoaderFactoryParams.validate = function(messageValidator, offset) {
    ...
    // validate URLLoaderFactoryParams.authCertObserver
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 80, TrustTokenRedemptionPolicy);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  URLLoaderFactoryParams.encodedSize = codec.kStructHeaderSize + 96;
  ...
  URLLoaderFactoryParams.decode = function(decoder) {
    ...
    val.authCertObserver =
        decoder.decodeStruct(new codec.NullableInterface(auth_and_certificate_observer$.AuthenticationAndCertificateObserverPtr));
  ...
  URLLoaderFactoryParams.encode = function(encoder, val) {
    ...
    encoder.encodeStruct(new codec.NullableInterface(auth_and_certificate_observer$.AuthenticationAndCertificateObserverPtr), val.authCertObserver);
  ...
  NetworkContext_CreateWebSocket_Params.validate = function(messageValidator, offset) {
    ...
    // validate NetworkContext_CreateWebSocket_Params.authCertObserver
    err = messageValidator.validateInterface(offset + codec.kStructHeaderSize + 72, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  var kCustomProxyConnectionObserver_OnFallback_Name = 1239540293;
  var kCustomProxyConnectionObserver_OnTunnelHeadersReceived_Name = 29446618;
  ...
  var kCustomProxyConfigClient_OnCustomProxyConfigUpdated_Name = 391707953;
  var kCustomProxyConfigClient_MarkProxiesAsBad_Name = 216259748;
  var kCustomProxyConfigClient_ClearBadProxiesCache_Name = 1483759146;
  ...
  var kTrustedHeaderClient_OnBeforeSendHeaders_Name = 1105155680;
  var kTrustedHeaderClient_OnHeadersReceived_Name = 1461540985;
  ...
  var kTrustedURLLoaderHeaderClient_OnLoaderCreated_Name = 1342064365;
  var kTrustedURLLoaderHeaderClient_OnLoaderForCorsPreflightCreated_Name = 1797415714;
  ...
  var kNetworkContextClient_OnFileUploadRequested_Name = 1789320661;
  var kNetworkContextClient_OnCanSendReportingReports_Name = 1499691113;
  var kNetworkContextClient_OnCanSendDomainReliabilityUpload_Name = 243367972;
  var kNetworkContextClient_OnClearSiteData_Name = 751126659;
  var kNetworkContextClient_OnTrustTokenIssuanceDivertedToSystem_Name = 524617655;
  ...
  var kNetworkContext_SetClient_Name = 640295623;
  var kNetworkContext_CreateURLLoaderFactory_Name = 833140864;
  var kNetworkContext_ResetURLLoaderFactories_Name = 1402478490;
  var kNetworkContext_GetCookieManager_Name = 1053414061;
  var kNetworkContext_GetRestrictedCookieManager_Name = 367165344;
  var kNetworkContext_GetHasTrustTokensAnswerer_Name = 282625543;
  var kNetworkContext_ClearTrustTokenData_Name = 1560731167;
  var kNetworkContext_GetStoredTrustTokenCounts_Name = 1405671144;
  var kNetworkContext_ClearNetworkingHistoryBetween_Name = 1156895313;
  var kNetworkContext_ClearHttpCache_Name = 21190103;
  var kNetworkContext_ComputeHttpCacheSize_Name = 684035425;
  var kNetworkContext_NotifyExternalCacheHit_Name = 235706114;
  var kNetworkContext_ClearHostCache_Name = 544280972;
  var kNetworkContext_ClearHttpAuthCache_Name = 2135063823;
  var kNetworkContext_ClearReportingCacheReports_Name = 777326246;
  var kNetworkContext_ClearReportingCacheClients_Name = 1839838653;
  var kNetworkContext_ClearNetworkErrorLogging_Name = 1310121475;
  var kNetworkContext_ClearDomainReliability_Name = 39886879;
  var kNetworkContext_GetDomainReliabilityJSON_Name = 463491282;
  var kNetworkContext_QueueReport_Name = 1071805322;
  var kNetworkContext_QueueSignedExchangeReport_Name = 1918163633;
  var kNetworkContext_CloseAllConnections_Name = 1205891172;
  var kNetworkContext_CloseIdleConnections_Name = 1881021468;
  var kNetworkContext_SetNetworkConditions_Name = 166532626;
  var kNetworkContext_SetAcceptLanguage_Name = 1957243821;
  var kNetworkContext_SetEnableReferrers_Name = 1234615270;
  var kNetworkContext_SetCTPolicy_Name = 1695270975;
  var kNetworkContext_AddExpectCT_Name = 1318797948;
  var kNetworkContext_SetExpectCTTestReport_Name = 1971826219;
  var kNetworkContext_GetExpectCTState_Name = 1461579383;
  var kNetworkContext_CreateUDPSocket_Name = 1569651842;
  var kNetworkContext_CreateTCPServerSocket_Name = 399621487;
  var kNetworkContext_CreateTCPConnectedSocket_Name = 67508819;
  var kNetworkContext_CreateTCPBoundSocket_Name = 393079871;
  var kNetworkContext_CreateProxyResolvingSocketFactory_Name = 1820325083;
  var kNetworkContext_LookUpProxyForURL_Name = 1711803055;
  var kNetworkContext_ForceReloadProxyConfig_Name = 1468813436;
  var kNetworkContext_ClearBadProxiesCache_Name = 461832694;
  var kNetworkContext_CreateWebSocket_Name = 1614017399;
  var kNetworkContext_CreateQuicTransport_Name = 449425188;
  var kNetworkContext_CreateNetLogExporter_Name = 462758288;
  var kNetworkContext_PreconnectSockets_Name = 958081881;
  var kNetworkContext_CreateP2PSocketManager_Name = 1554806321;
  var kNetworkContext_CreateMdnsResponder_Name = 1179589259;
  var kNetworkContext_ResolveHost_Name = 632382308;
  var kNetworkContext_CreateHostResolver_Name = 1955764251;
  var kNetworkContext_VerifyCertForSignedExchange_Name = 773479565;
  var kNetworkContext_ParseHeaders_Name = 693914648;
  var kNetworkContext_AddHSTS_Name = 878067934;
  var kNetworkContext_IsHSTSActiveForHost_Name = 1580191173;
  var kNetworkContext_GetHSTSState_Name = 429410644;
  var kNetworkContext_SetCorsOriginAccessListsForOrigin_Name = 1764173310;
  var kNetworkContext_DeleteDynamicDataForHost_Name = 53619933;
  var kNetworkContext_SetSplitAuthCacheByNetworkIsolationKey_Name = 1404727876;
  var kNetworkContext_SaveHttpAuthCacheProxyEntries_Name = 1222014041;
  var kNetworkContext_LoadHttpAuthCacheProxyEntries_Name = 1584484135;
  var kNetworkContext_AddAuthCacheEntry_Name = 1423487302;
  var kNetworkContext_LookupServerBasicAuthCredentials_Name = 1554376720;
  var kNetworkContext_EnableStaticKeyPinningForTesting_Name = 1397116503;
  var kNetworkContext_VerifyCertificateForTesting_Name = 1439592963;
  var kNetworkContext_AddDomainReliabilityContextForTesting_Name = 192038742;
  var kNetworkContext_ForceDomainReliabilityUploadsForTesting_Name = 1962043855;
  var kNetworkContext_GetOriginPolicyManager_Name = 1095740304;
  var kNetworkContext_SetSCTAuditingEnabled_Name = 2040336604;
  ...
  NetworkContextProxy.prototype.createWebSocket = function(url, requestedProtocols, siteForCookies, isolationInfo, additionalHeaders, processId, origin, options, trafficAnnotation, handshakeClient, authCertObserver, authHandler, headerClient) {
    ...
    params_.authCertObserver = authCertObserver;
  ...
  NetworkContextStub.prototype.createWebSocket = function(url, requestedProtocols, siteForCookies, isolationInfo, additionalHeaders, processId, origin, options, trafficAnnotation, handshakeClient, authCertObserver, authHandler, headerClient) {
    return this.delegate_ && this.delegate_.createWebSocket && this.delegate_.createWebSocket(url, requestedProtocols, siteForCookies, isolationInfo, additionalHeaders, processId, origin, options, trafficAnnotation, handshakeClient, authCertObserver, authHandler, headerClient);
  }
  ...
  NetworkContextStub.prototype.accept = function(message) {
    ...
    case kNetworkContext_CreateWebSocket_Name:
      ...
      this.createWebSocket(params.url, params.requestedProtocols, params.siteForCookies, params.isolationInfo, params.additionalHeaders, params.processId, params.origin, params.options, params.trafficAnnotation, params.handshakeClient, params.authCertObserver, params.authHandler, params.headerClient);
      return true;
