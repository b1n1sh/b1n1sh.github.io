...
(function() {
  ...
  function NetworkServiceClient_OnPrivateNetworkRequest_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  NetworkServiceClient_OnPrivateNetworkRequest_Params.prototype.initDefaults_ = function() {
    this.processId = 0;
    this.routingId = 0;
    this.devtoolRequestId = null;
    this.url = null;
  ...
  NetworkServiceClient_OnPrivateNetworkRequest_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  NetworkServiceClient_OnPrivateNetworkRequest_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate NetworkServiceClient_OnPrivateNetworkRequest_Params.devtoolRequestId
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 8, true)
    if (err !== validator.validationError.NONE)
        return err;


    // validate NetworkServiceClient_OnPrivateNetworkRequest_Params.url
    ...
    // validate NetworkServiceClient_OnPrivateNetworkRequest_Params.resourceAddressSpace
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 28, ip_address_space$.IPAddressSpace);
    if (err !== validator.validationError.NONE)
        return err;


    // validate NetworkServiceClient_OnPrivateNetworkRequest_Params.clientSecurityState
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 32, client_security_state$.ClientSecurityState, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkServiceClient_OnPrivateNetworkRequest_Params.encodedSize = codec.kStructHeaderSize + 40;

  NetworkServiceClient_OnPrivateNetworkRequest_Params.decode = function(decoder) {
    var packed;
    var val = new NetworkServiceClient_OnPrivateNetworkRequest_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.processId =
        decoder.decodeStruct(codec.Int32);
  ...
  NetworkServiceClient_OnPrivateNetworkRequest_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(NetworkServiceClient_OnPrivateNetworkRequest_Params.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.Int32, val.processId);
    encoder.encodeStruct(codec.Int32, val.routingId);
  ...
  var kNetworkServiceClient_OnLoadingStateUpdate_Name = 1212096919;
  var kNetworkServiceClient_OnDataUseUpdate_Name = 790366615;
  var kNetworkServiceClient_OnRawRequest_Name = 950554404;
  var kNetworkServiceClient_OnRawResponse_Name = 1757592949;
  var kNetworkServiceClient_OnPrivateNetworkRequest_Name = 1615640331;
  var kNetworkServiceClient_OnCorsPreflightRequest_Name = 859608726;
  var kNetworkServiceClient_OnCorsPreflightResponse_Name = 346115128;
  var kNetworkServiceClient_OnCorsPreflightRequestCompleted_Name = 912143115;
  var kNetworkServiceClient_OnTrustTokenOperationDone_Name = 161033105;
  ...
  NetworkServiceClientPtr.prototype.onPrivateNetworkRequest = function() {
    return NetworkServiceClientProxy.prototype.onPrivateNetworkRequest
        .apply(this.ptr.getProxy(), arguments);
  };

  NetworkServiceClientProxy.prototype.onPrivateNetworkRequest = function(processId, routingId, devtoolRequestId, url, isWarning, resourceAddressSpace, clientSecurityState) {
    var params_ = new NetworkServiceClient_OnPrivateNetworkRequest_Params();
    params_.processId = processId;
    params_.routingId = routingId;
    params_.devtoolRequestId = devtoolRequestId;
    params_.url = url;
    ...
    params_.clientSecurityState = clientSecurityState;
    var builder = new codec.MessageV0Builder(
        kNetworkServiceClient_OnPrivateNetworkRequest_Name,
        codec.align(NetworkServiceClient_OnPrivateNetworkRequest_Params.encodedSize));
    builder.encodeStruct(NetworkServiceClient_OnPrivateNetworkRequest_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };
  ...
  NetworkServiceClientStub.prototype.onPrivateNetworkRequest = function(processId, routingId, devtoolRequestId, url, isWarning, resourceAddressSpace, clientSecurityState) {
    return this.delegate_ && this.delegate_.onPrivateNetworkRequest && this.delegate_.onPrivateNetworkRequest(processId, routingId, devtoolRequestId, url, isWarning, resourceAddressSpace, clientSecurityState);
  }
  ...
  NetworkServiceClientStub.prototype.accept = function(message) {
    ...
    case kNetworkServiceClient_OnRawResponse_Name:
      ...
      return true;
    case kNetworkServiceClient_OnPrivateNetworkRequest_Name:
      var params = reader.decodeStruct(NetworkServiceClient_OnPrivateNetworkRequest_Params);
      this.onPrivateNetworkRequest(params.processId, params.routingId, params.devtoolRequestId, params.url, params.isWarning, params.resourceAddressSpace, params.clientSecurityState);
      return true;
  ...
  function validateNetworkServiceClientRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kNetworkServiceClient_OnPrivateNetworkRequest_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = NetworkServiceClient_OnPrivateNetworkRequest_Params;
      break;
      case kNetworkServiceClient_OnCorsPreflightRequest_Name:
        if (!message.expectsResponse() && !message.isResponse())
  ...
  var kNetworkService_SetClient_Name = 369138269;
  var kNetworkService_StartNetLog_Name = 957742242;
  var kNetworkService_AttachNetLogProxy_Name = 334485051;
  var kNetworkService_SetSSLKeyLogFile_Name = 718958212;
  var kNetworkService_CreateNetworkContext_Name = 61782709;
  var kNetworkService_ConfigureStubHostResolver_Name = 483209714;
  var kNetworkService_DisableQuic_Name = 102639593;
  var kNetworkService_SetUpHttpAuth_Name = 1643270381;
  var kNetworkService_ConfigureHttpAuthPrefs_Name = 2099438598;
  var kNetworkService_SetRawHeadersAccess_Name = 1174646820;
  var kNetworkService_SetMaxConnectionsPerProxy_Name = 1704739860;
  var kNetworkService_GetNetworkChangeManager_Name = 1156719190;
  var kNetworkService_GetNetworkQualityEstimatorManager_Name = 1486409543;
  var kNetworkService_GetDnsConfigChangeManager_Name = 669182993;
  var kNetworkService_GetTotalNetworkUsages_Name = 1025907480;
  var kNetworkService_GetNetworkList_Name = 893607079;
  var kNetworkService_UpdateCRLSet_Name = 1593936906;
  var kNetworkService_OnCertDBChanged_Name = 740967106;
  var kNetworkService_SetCryptConfig_Name = 873191787;
  var kNetworkService_AddAllowedRequestInitiatorForPlugin_Name = 1322718607;
  var kNetworkService_RemoveSecurityExceptionsForPlugin_Name = 1329241256;
  var kNetworkService_OnMemoryPressure_Name = 1408912959;
  var kNetworkService_OnPeerToPeerConnectionsCountChange_Name = 2093734757;
  var kNetworkService_SetEnvironment_Name = 1884585094;
  var kNetworkService_SetTrustTokenKeyCommitments_Name = 1641300224;
  var kNetworkService_ClearSCTAuditingCache_Name = 1863510527;
  var kNetworkService_ConfigureSCTAuditing_Name = 311341503;
  var kNetworkService_BindTestInterface_Name = 501444939;
  var kNetworkService_SetPreloadedFirstPartySets_Name = 1479072624;
