...
(function() {
  ...
  TransferableResource.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 8, ResourceFormat);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 48, vulkan_ycbcr_info$.VulkanYCbCrInfo, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  TransferableResource.encodedSize = codec.kStructHeaderSize + 56;
  ...
  TransferableResource.decode = function(decoder) {
    ...
    val.format =
        decoder.decodeStruct(new codec.Enum(ResourceFormat));
    val.filter =
