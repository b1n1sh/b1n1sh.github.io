...
(function() {
  ...
  BucketPolicies.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 12, BucketDurability);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  BucketPolicies.encodedSize = codec.kStructHeaderSize + 32;
