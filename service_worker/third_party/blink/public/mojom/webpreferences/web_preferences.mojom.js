...
(function() {
  ...
  WebPreferences.decode = function(decoder) {
    ...
    val.allowNonEmptyNavigatorPlugins = (packed >> 1) & 1 ? true : false;
    val.supportsMultipleWindows = (packed >> 2) & 1 ? true : false;
    val.viewportEnabled = (packed >> 3) & 1 ? true : false;
    val.viewportMetaEnabled = (packed >> 4) & 1 ? true : false;
    val.shrinksViewportContentsToFit = (packed >> 5) & 1 ? true : false;
    val.smoothScrollForFindEnabled = (packed >> 6) & 1 ? true : false;
    val.mainFrameResizesAreOrientationChanges = (packed >> 7) & 1 ? true : false;
    ...
    packed = decoder.readUint8();
    val.initializeAtMinimumPageScale = (packed >> 0) & 1 ? true : false;
    val.smartInsertDeleteEnabled = (packed >> 1) & 1 ? true : false;
    val.spatialNavigationEnabled = (packed >> 2) & 1 ? true : false;
    val.navigateOnDragDrop = (packed >> 3) & 1 ? true : false;
    val.recordWholeDocument = (packed >> 4) & 1 ? true : false;
    val.cookieEnabled = (packed >> 5) & 1 ? true : false;
    val.acceleratedVideoDecodeEnabled = (packed >> 6) & 1 ? true : false;
    val.userGestureRequiredForPresentation = (packed >> 7) & 1 ? true : false;
    packed = decoder.readUint8();
    val.textTracksEnabled = (packed >> 0) & 1 ? true : false;
    val.immersiveModeEnabled = (packed >> 1) & 1 ? true : false;
    val.doubleTapToZoomEnabled = (packed >> 2) & 1 ? true : false;
    val.fullscreenSupported = (packed >> 3) & 1 ? true : false;
    val.textAutosizingEnabled = (packed >> 4) & 1 ? true : false;
    val.forceDarkModeEnabled = (packed >> 5) & 1 ? true : false;
    val.hideDownloadUi = (packed >> 6) & 1 ? true : false;
    val.presentationReceiver = (packed >> 7) & 1 ? true : false;
    packed = decoder.readUint8();
    val.mediaControlsEnabled = (packed >> 0) & 1 ? true : false;
    val.doNotUpdateSelectionOnMutatingSelectionRange = (packed >> 1) & 1 ? true : false;
  ...
  WebPreferences.encode = function(encoder, val) {
    ...
    packed |= (val.allowNonEmptyNavigatorPlugins & 1) << 1
    packed |= (val.supportsMultipleWindows & 1) << 2
    packed |= (val.viewportEnabled & 1) << 3
    packed |= (val.viewportMetaEnabled & 1) << 4
    packed |= (val.shrinksViewportContentsToFit & 1) << 5
    packed |= (val.smoothScrollForFindEnabled & 1) << 6
    packed |= (val.mainFrameResizesAreOrientationChanges & 1) << 7
    encoder.writeUint8(packed);
    ...
    packed = 0;
    packed |= (val.initializeAtMinimumPageScale & 1) << 0
    packed |= (val.smartInsertDeleteEnabled & 1) << 1
    packed |= (val.spatialNavigationEnabled & 1) << 2
    packed |= (val.navigateOnDragDrop & 1) << 3
    packed |= (val.recordWholeDocument & 1) << 4
    packed |= (val.cookieEnabled & 1) << 5
    packed |= (val.acceleratedVideoDecodeEnabled & 1) << 6
    packed |= (val.userGestureRequiredForPresentation & 1) << 7
    encoder.writeUint8(packed);
    packed = 0;
    packed |= (val.textTracksEnabled & 1) << 0
    packed |= (val.immersiveModeEnabled & 1) << 1
    packed |= (val.doubleTapToZoomEnabled & 1) << 2
    packed |= (val.fullscreenSupported & 1) << 3
    packed |= (val.textAutosizingEnabled & 1) << 4
    packed |= (val.forceDarkModeEnabled & 1) << 5
    packed |= (val.hideDownloadUi & 1) << 6
    packed |= (val.presentationReceiver & 1) << 7
    encoder.writeUint8(packed);
    packed = 0;
    packed |= (val.mediaControlsEnabled & 1) << 0
    packed |= (val.doNotUpdateSelectionOnMutatingSelectionRange & 1) << 1
