...
(function() {
  ...
  ClientToAuthenticatorProtocol.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  Ctap2Version.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  VirtualAuthenticatorOptions.decode = function(decoder) {
    ...
    val.protocol =
        decoder.decodeStruct(new codec.Enum(ClientToAuthenticatorProtocol));
    val.ctap2Version =
        decoder.decodeStruct(new codec.Enum(Ctap2Version));
    val.transport =
        decoder.decodeStruct(new codec.Enum(authenticator$.AuthenticatorTransport));
    val.attachment =
        decoder.decodeStruct(new codec.Enum(authenticator$.AuthenticatorAttachment));
