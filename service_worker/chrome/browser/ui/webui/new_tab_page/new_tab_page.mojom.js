...
(function() {
  ...
  VoiceSearchAction.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  VoiceSearchError.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  PageHandler_OnVoiceSearchAction_Params.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.action =
        decoder.decodeStruct(new codec.Enum(VoiceSearchAction));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  PageHandler_OnVoiceSearchError_Params.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.error =
        decoder.decodeStruct(new codec.Enum(VoiceSearchError));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  var kPageHandlerFactory_CreatePageHandler_Name = 233843337;
  ...
  var kPageHandler_AddMostVisitedTile_Name = 1114323466;
  var kPageHandler_DeleteMostVisitedTile_Name = 1733706205;
  var kPageHandler_ReorderMostVisitedTile_Name = 1489278844;
  var kPageHandler_RestoreMostVisitedDefaults_Name = 675430288;
  var kPageHandler_SetBackgroundImage_Name = 1564726150;
  var kPageHandler_SetDailyRefreshCollectionId_Name = 1560096776;
  var kPageHandler_SetNoBackgroundImage_Name = 979990131;
  var kPageHandler_SetMostVisitedSettings_Name = 1724569703;
  var kPageHandler_UndoMostVisitedTileAction_Name = 1322134943;
  var kPageHandler_UpdateMostVisitedInfo_Name = 1144332150;
  var kPageHandler_UpdateMostVisitedTile_Name = 1803474814;
  var kPageHandler_GetBackgroundCollections_Name = 362044023;
  var kPageHandler_GetBackgroundImages_Name = 1687487202;
  var kPageHandler_GetDoodle_Name = 772392457;
  var kPageHandler_ChooseLocalCustomBackground_Name = 401170554;
  var kPageHandler_GetOneGoogleBarParts_Name = 1954711022;
  var kPageHandler_GetPromo_Name = 193105885;
  var kPageHandler_OnDismissModule_Name = 2113923020;
  var kPageHandler_OnRestoreModule_Name = 1100889957;
  var kPageHandler_SetModulesVisible_Name = 1968290468;
  var kPageHandler_SetModuleDisabled_Name = 692855852;
  var kPageHandler_UpdateDisabledModules_Name = 2064073492;
  var kPageHandler_OnMostVisitedTilesRendered_Name = 1265567977;
  var kPageHandler_OnOneGoogleBarRendered_Name = 1750398414;
  var kPageHandler_OnPromoRendered_Name = 1513760839;
  var kPageHandler_OnMostVisitedTileNavigation_Name = 787077163;
  var kPageHandler_OnCustomizeDialogAction_Name = 508782117;
  var kPageHandler_OnDoodleImageClicked_Name = 1425568129;
  var kPageHandler_OnDoodleImageRendered_Name = 708310517;
  var kPageHandler_OnDoodleShared_Name = 101259412;
  var kPageHandler_OnPromoLinkClicked_Name = 899255158;
  var kPageHandler_OnVoiceSearchAction_Name = 158452433;
  var kPageHandler_OnVoiceSearchError_Name = 789593771;
  var kPageHandler_OnModuleImpression_Name = 971457368;
  var kPageHandler_OnModuleLoaded_Name = 509018407;
  var kPageHandler_OnModuleUsage_Name = 855962351;
  var kPageHandler_OnModulesRendered_Name = 1490757242;
  var kPageHandler_OnAppRendered_Name = 657010222;
  ...
  var kPage_SetMostVisitedInfo_Name = 994293282;
  var kPage_SetTheme_Name = 182105634;
  var kPage_SetDisabledModules_Name = 2053689179;
