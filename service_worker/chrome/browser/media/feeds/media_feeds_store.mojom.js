...
(function() {
  ...
  FetchResult.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  ResetReason.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  FeedUserStatus.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  MediaFeedItemType.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  MediaFeedItemActionStatus.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  InteractionCounterType.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  SafeSearchResult.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  ContentAttribute.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  IsFamilyFriendly.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  MediaFeed.decode = function(decoder) {
    ...
    val.lastFetchTime =
        decoder.decodeStructPointer(time$.Time);
    val.userStatus =
        decoder.decodeStruct(new codec.Enum(FeedUserStatus));
    val.lastFetchResult =
        decoder.decodeStruct(new codec.Enum(FetchResult));
    ...
    val.lastFetchSafeItemCount =
        decoder.decodeStruct(codec.Int64);
    val.resetReason =
        decoder.decodeStruct(new codec.Enum(ResetReason));
    val.safeSearchResult =
        decoder.decodeStruct(new codec.Enum(SafeSearchResult));
    val.resetToken =
  ...
  Identifier.Type.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  Identifier.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.type =
        decoder.decodeStruct(new codec.Enum(Identifier.Type));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  MediaFeedItem.decode = function(decoder) {
    ...
    val.id =
        decoder.decodeStruct(codec.Int64);
    val.type =
        decoder.decodeStruct(new codec.Enum(MediaFeedItemType));
    val.isFamilyFriendly =
        decoder.decodeStruct(new codec.Enum(IsFamilyFriendly));
    val.name =
    ...
    val.datePublished =
        decoder.decodeStructPointer(time$.Time);
    val.actionStatus =
        decoder.decodeStruct(new codec.Enum(MediaFeedItemActionStatus));
  ...
  var kMediaFeedsStore_GetDebugInformation_Name = 1017502678;
  var kMediaFeedsStore_SetSafeSearchEnabledPref_Name = 1632990989;
  var kMediaFeedsStore_SetBackgroundFetchingPref_Name = 599856472;
  var kMediaFeedsStore_GetMediaFeeds_Name = 1254729848;
  var kMediaFeedsStore_GetItemsForMediaFeed_Name = 4546366;
  var kMediaFeedsStore_FetchMediaFeed_Name = 121282829;
