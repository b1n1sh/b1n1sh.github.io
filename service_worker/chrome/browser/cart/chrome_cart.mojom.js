...
(function() {
  ...
  function CartHandler_OnCartItemClicked_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  CartHandler_OnCartItemClicked_Params.prototype.initDefaults_ = function() {
    this.index = 0;
  };
  CartHandler_OnCartItemClicked_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  CartHandler_OnCartItemClicked_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  CartHandler_OnCartItemClicked_Params.encodedSize = codec.kStructHeaderSize + 8;

  CartHandler_OnCartItemClicked_Params.decode = function(decoder) {
    var packed;
    var val = new CartHandler_OnCartItemClicked_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.index =
  ...
  CartHandler_OnCartItemClicked_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(CartHandler_OnCartItemClicked_Params.encodedSize);
    encoder.writeUint32(0);
  ...
  function CartHandler_OnModuleCreated_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  CartHandler_OnModuleCreated_Params.prototype.initDefaults_ = function() {
    this.count = 0;
  };
  CartHandler_OnModuleCreated_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  CartHandler_OnModuleCreated_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  CartHandler_OnModuleCreated_Params.encodedSize = codec.kStructHeaderSize + 8;

  CartHandler_OnModuleCreated_Params.decode = function(decoder) {
    var packed;
    var val = new CartHandler_OnModuleCreated_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.count =
        decoder.decodeStruct(codec.Uint32);
  ...
  CartHandler_OnModuleCreated_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(CartHandler_OnModuleCreated_Params.encodedSize);
    encoder.writeUint32(0);
  ...
  var kCartHandler_GetMerchantCarts_Name = 1325336530;
  var kCartHandler_HideCartModule_Name = 552948232;
  var kCartHandler_RestoreHiddenCartModule_Name = 1788187571;
  var kCartHandler_HideCart_Name = 604114912;
  var kCartHandler_RestoreHiddenCart_Name = 1850732492;
  var kCartHandler_RemoveCart_Name = 630918895;
  var kCartHandler_RestoreRemovedCart_Name = 742799054;
  var kCartHandler_GetWarmWelcomeVisible_Name = 531363804;
  var kCartHandler_OnCartItemClicked_Name = 83041365;
  var kCartHandler_OnModuleCreated_Name = 903695572;
  ...
  CartHandlerPtr.prototype.onCartItemClicked = function() {
    return CartHandlerProxy.prototype.onCartItemClicked
        .apply(this.ptr.getProxy(), arguments);
  };

  CartHandlerProxy.prototype.onCartItemClicked = function(index) {
    var params_ = new CartHandler_OnCartItemClicked_Params();
    params_.index = index;
    var builder = new codec.MessageV0Builder(
        kCartHandler_OnCartItemClicked_Name,
        codec.align(CartHandler_OnCartItemClicked_Params.encodedSize));
    builder.encodeStruct(CartHandler_OnCartItemClicked_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };
  CartHandlerPtr.prototype.onModuleCreated = function() {
    return CartHandlerProxy.prototype.onModuleCreated
        .apply(this.ptr.getProxy(), arguments);
  };

  CartHandlerProxy.prototype.onModuleCreated = function(count) {
    var params_ = new CartHandler_OnModuleCreated_Params();
    params_.count = count;
    var builder = new codec.MessageV0Builder(
        kCartHandler_OnModuleCreated_Name,
        codec.align(CartHandler_OnModuleCreated_Params.encodedSize));
    builder.encodeStruct(CartHandler_OnModuleCreated_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };
  ...
  CartHandlerStub.prototype.onCartItemClicked = function(index) {
    return this.delegate_ && this.delegate_.onCartItemClicked && this.delegate_.onCartItemClicked(index);
  }
  CartHandlerStub.prototype.onModuleCreated = function(count) {
    return this.delegate_ && this.delegate_.onModuleCreated && this.delegate_.onModuleCreated(count);
  }
  ...
  CartHandlerStub.prototype.accept = function(message) {
    ...
    case kCartHandler_RestoreHiddenCartModule_Name:
      ...
      return true;
    case kCartHandler_OnCartItemClicked_Name:
      var params = reader.decodeStruct(CartHandler_OnCartItemClicked_Params);
      this.onCartItemClicked(params.index);
      return true;
    case kCartHandler_OnModuleCreated_Name:
      var params = reader.decodeStruct(CartHandler_OnModuleCreated_Params);
      this.onModuleCreated(params.count);
      return true;
    default:
      return false;
    }
  ...
  function validateCartHandlerRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kCartHandler_OnCartItemClicked_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = CartHandler_OnCartItemClicked_Params;
      break;
      case kCartHandler_OnModuleCreated_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = CartHandler_OnModuleCreated_Params;
      break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
