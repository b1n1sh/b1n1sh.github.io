...
(function() {
  ...
  VideoCaptureObserver_OnStateChanged_Params.decode = function(decoder) {
    ...
    val.state =
        decoder.decodeStruct(new codec.Enum(VideoCaptureState));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  VideoCaptureObserver_OnBufferReady_Params.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 8, 8, new codec.PointerTo(video_capture_buffer$.ReadyBuffer), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  VideoCaptureObserver_OnBufferReady_Params.decode = function(decoder) {
    ...
    val.scaledBuffers =
        decoder.decodeArrayPointer(new codec.PointerTo(video_capture_buffer$.ReadyBuffer));
    return val;
  };
  ...
  VideoCaptureObserver_OnBufferReady_Params.encode = function(encoder, val) {
    ...
    encoder.encodeArrayPointer(new codec.PointerTo(video_capture_buffer$.ReadyBuffer), val.scaledBuffers);
  };
  ...
  var kVideoCaptureObserver_OnStateChanged_Name = 2138927707;
  var kVideoCaptureObserver_OnNewBuffer_Name = 805700940;
  var kVideoCaptureObserver_OnBufferReady_Name = 479933047;
  var kVideoCaptureObserver_OnBufferDestroyed_Name = 1447569559;
  ...
  var kVideoCaptureHost_Start_Name = 1415458272;
  var kVideoCaptureHost_Stop_Name = 920827238;
  var kVideoCaptureHost_Pause_Name = 1853905492;
  var kVideoCaptureHost_Resume_Name = 1790319476;
  var kVideoCaptureHost_RequestRefreshFrame_Name = 1286386406;
  var kVideoCaptureHost_ReleaseBuffer_Name = 474384372;
  var kVideoCaptureHost_GetDeviceSupportedFormats_Name = 2053003707;
  var kVideoCaptureHost_GetDeviceFormatsInUse_Name = 219939214;
  var kVideoCaptureHost_OnFrameDropped_Name = 1831319748;
  var kVideoCaptureHost_OnLog_Name = 1814107051;
