...
(function() {
  ...
  RendererEvictionReason.kNetworkRequestDatapipeDrainedAsBytesConsumer = 1;
  ...
  RendererEvictionReason.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  BackForwardCacheControllerHost_EvictFromBackForwardCache_Params.decode = function(decoder) {
    ...
    val.reason =
        decoder.decodeStruct(new codec.Enum(RendererEvictionReason));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  var kBackForwardCacheControllerHost_EvictFromBackForwardCache_Name = 39873965;
