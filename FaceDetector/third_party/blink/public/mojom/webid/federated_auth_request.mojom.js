...
(function() {
  ...
  FederatedAuthRequest_Logout_Params.validate = function(messageValidator, offset) {
    ...
    // validate FederatedAuthRequest_Logout_Params.rpLogoutEndpoints
  ...
  FederatedAuthRequest_Logout_Params.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    encoder.encodeArrayPointer(codec.String, val.rpLogoutEndpoints);
  };
  ...
  FederatedAuthRequestProxy.prototype.requestIdToken = function(provider, clientId, nonce, mode) {
  ...
  FederatedAuthRequestProxy.prototype.logout = function(rpLogoutEndpoints) {
    var params_ = new FederatedAuthRequest_Logout_Params();
    params_.rpLogoutEndpoints = rpLogoutEndpoints;
    return new Promise(function(resolve, reject) {
      var builder = new codec.MessageV1Builder(
  ...
  FederatedAuthRequestStub.prototype.requestIdToken = function(provider, clientId, nonce, mode) {
    return this.delegate_ && this.delegate_.requestIdToken && this.delegate_.requestIdToken(provider, clientId, nonce, mode);
  }
  FederatedAuthRequestStub.prototype.logout = function(rpLogoutEndpoints) {
    return this.delegate_ && this.delegate_.logout && this.delegate_.logout(rpLogoutEndpoints);
  }
  ...
  FederatedAuthRequestStub.prototype.acceptWithResponder =
    ...
    case kFederatedAuthRequest_RequestIdToken_Name:
      ...
      this.requestIdToken(params.provider, params.clientId, params.nonce, params.mode).then(function(response) {
        var responseParams =
    ...
    case kFederatedAuthRequest_Logout_Name:
      ...
      this.logout(params.rpLogoutEndpoints).then(function(response) {
        var responseParams =
