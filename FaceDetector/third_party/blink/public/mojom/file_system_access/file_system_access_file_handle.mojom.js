...
(function() {
  ...
  FileSystemAccessFileHandle_OpenAccessHandle_Params.encodedSize = codec.kStructHeaderSize + 0;
  ...
  Object.defineProperty(FileSystemAccessAccessHandleFile.prototype, "incognitoFileDelegate", {
    ...
    FileSystemAccessAccessHandleFile.encode = function(encoder, val) {
      ...
      switch (val.$tag) {
        case FileSystemAccessAccessHandleFile.Tags.regularFile:
          encoder.encodeStructPointer(file$.File, val.regularFile);
          break;
    ...
    FileSystemAccessAccessHandleFile.decode = function(decoder) {
      ...
      switch (tag) {
        case FileSystemAccessAccessHandleFile.Tags.regularFile:
          result.regularFile = decoder.decodeStructPointer(file$.File);
          break;
        case FileSystemAccessAccessHandleFile.Tags.incognitoFileDelegate:
  ...
  var kFileSystemAccessFileHandle_Remove_Name = 4;
  var kFileSystemAccessFileHandle_OpenAccessHandle_Name = 5;
  var kFileSystemAccessFileHandle_IsSameEntry_Name = 6;
  var kFileSystemAccessFileHandle_Transfer_Name = 7;
  ...
  FileSystemAccessFileHandleProxy.prototype.openAccessHandle = function() {
  ...
  FileSystemAccessFileHandleStub.prototype.openAccessHandle = function() {
    return this.delegate_ && this.delegate_.openAccessHandle && this.delegate_.openAccessHandle();
  }
  ...
  FileSystemAccessFileHandleStub.prototype.acceptWithResponder =
    ...
    case kFileSystemAccessFileHandle_OpenAccessHandle_Name:
      ...
      this.openAccessHandle().then(function(response) {
        var responseParams =
