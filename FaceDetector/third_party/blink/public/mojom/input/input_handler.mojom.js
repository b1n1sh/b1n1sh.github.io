...
(function() {
  ...
  GestureData.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 88, FlingData, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  GestureData.encodedSize = codec.kStructHeaderSize + 96;
  ...
  var kWidgetInputHandler_GetFrameWidgetInputHandler_Name = 12;
