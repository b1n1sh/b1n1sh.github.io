...
(function() {
  ...
  ClipboardFormat.kRtf = 4;
  ClipboardFormat.MIN_VALUE = 0;
  ClipboardFormat.MAX_VALUE = 4;
  ...
  ClipboardHost_GetSequenceNumber_ResponseParams.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, tokens$.ClipboardSequenceNumberToken, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  ClipboardHost_GetSequenceNumber_ResponseParams.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.result =
        decoder.decodeStructPointer(tokens$.ClipboardSequenceNumberToken);
    return val;
  };
  ...
  ClipboardHost_GetSequenceNumber_ResponseParams.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    encoder.encodeStructPointer(tokens$.ClipboardSequenceNumberToken, val.result);
  };
  ...
  var kClipboardHost_ReadImage_Name = 8;
  var kClipboardHost_ReadFiles_Name = 9;
  var kClipboardHost_ReadCustomData_Name = 10;
  var kClipboardHost_ReadAvailableCustomAndStandardFormats_Name = 11;
  var kClipboardHost_ReadUnsanitizedCustomFormat_Name = 12;
  var kClipboardHost_WriteText_Name = 13;
  var kClipboardHost_WriteHtml_Name = 14;
  var kClipboardHost_WriteSvg_Name = 15;
  var kClipboardHost_WriteSmartPasteMarker_Name = 16;
  var kClipboardHost_WriteCustomData_Name = 17;
  var kClipboardHost_WriteBookmark_Name = 18;
  var kClipboardHost_WriteImage_Name = 19;
  var kClipboardHost_WriteUnsanitizedCustomFormat_Name = 20;
  var kClipboardHost_CommitWrite_Name = 21;
