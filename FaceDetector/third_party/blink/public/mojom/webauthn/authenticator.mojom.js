...
(function() {
  ...
  AuthenticatorStatus.FAILED_TO_SAVE_CREDENTIAL_ID_FOR_PAYMENT_EXTENSION = 21;
  AuthenticatorStatus.UNKNOWN_ERROR = 22;
  AuthenticatorStatus.MIN_VALUE = 0;
  AuthenticatorStatus.MAX_VALUE = 22;
  ...
  GetAssertionAuthenticatorResponse.decode = function(decoder) {
    ...
    val.echoGetCredBlob = (packed >> 7) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  GetAssertionAuthenticatorResponse.encode = function(encoder, val) {
    ...
    packed |= (val.echoGetCredBlob & 1) << 7
    encoder.writeUint8(packed);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
  ...
  PaymentOptions.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 8, payment_credential$.PaymentCredentialInstrument, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  PaymentOptions.encodedSize = codec.kStructHeaderSize + 16;
  ...
  PublicKeyCredentialRequestOptions.validate = function(messageValidator, offset) {
    ...
    // validate PublicKeyCredentialRequestOptions.payment
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 72, PaymentOptions, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  PublicKeyCredentialRequestOptions.encodedSize = codec.kStructHeaderSize + 80;
  ...
  PublicKeyCredentialRequestOptions.encode = function(encoder, val) {
    ...
    encoder.encodeStructPointer(PaymentOptions, val.payment);
  };
