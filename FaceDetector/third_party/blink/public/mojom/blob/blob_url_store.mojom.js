...
(function() {
  ...
  BlobURLStore_Register_Params.prototype.initDefaults_ = function() {
    ...
    this.url = null;
    this.unsafeAgentClusterId = null;
  };
  ...
  BlobURLStore_Register_Params.validate = function(messageValidator, offset) {
    ...
    // validate BlobURLStore_Register_Params.unsafeAgentClusterId
  ...
  BlobURLStore_Register_Params.encodedSize = codec.kStructHeaderSize + 24;
  ...
  BlobURLStore_Register_Params.encode = function(encoder, val) {
    ...
    encoder.encodeStructPointer(unguessable_token$.UnguessableToken, val.unsafeAgentClusterId);
  };
  ...
  BlobURLStore_Resolve_ResponseParams.validate = function(messageValidator, offset) {
    ...
    // validate BlobURLStore_Resolve_ResponseParams.unsafeAgentClusterId
  ...
  BlobURLStore_Resolve_ResponseParams.encodedSize = codec.kStructHeaderSize + 16;
  ...
  function BlobURLStore_ResolveAsURLLoaderFactory_ResponseParams(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  BlobURLStore_ResolveAsURLLoaderFactory_ResponseParams.prototype.initDefaults_ = function() {
    this.unsafeAgentClusterId = null;
  };
  BlobURLStore_ResolveAsURLLoaderFactory_ResponseParams.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  BlobURLStore_ResolveAsURLLoaderFactory_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate BlobURLStore_ResolveAsURLLoaderFactory_ResponseParams.unsafeAgentClusterId
  ...
  BlobURLStore_ResolveAsURLLoaderFactory_ResponseParams.encodedSize = codec.kStructHeaderSize + 8;

  BlobURLStore_ResolveAsURLLoaderFactory_ResponseParams.decode = function(decoder) {
    var packed;
    var val = new BlobURLStore_ResolveAsURLLoaderFactory_ResponseParams();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.unsafeAgentClusterId =
        decoder.decodeStructPointer(unguessable_token$.UnguessableToken);
  ...
  BlobURLStore_ResolveAsURLLoaderFactory_ResponseParams.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(BlobURLStore_ResolveAsURLLoaderFactory_ResponseParams.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStructPointer(unguessable_token$.UnguessableToken, val.unsafeAgentClusterId);
  };
  ...
  function BlobURLStore_ResolveForNavigation_ResponseParams(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  BlobURLStore_ResolveForNavigation_ResponseParams.prototype.initDefaults_ = function() {
    this.unsafeAgentClusterId = null;
  };
  BlobURLStore_ResolveForNavigation_ResponseParams.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  BlobURLStore_ResolveForNavigation_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate BlobURLStore_ResolveForNavigation_ResponseParams.unsafeAgentClusterId
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, unguessable_token$.UnguessableToken, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  BlobURLStore_ResolveForNavigation_ResponseParams.encodedSize = codec.kStructHeaderSize + 8;

  BlobURLStore_ResolveForNavigation_ResponseParams.decode = function(decoder) {
    var packed;
    var val = new BlobURLStore_ResolveForNavigation_ResponseParams();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.unsafeAgentClusterId =
        decoder.decodeStructPointer(unguessable_token$.UnguessableToken);
  ...
  BlobURLStore_ResolveForNavigation_ResponseParams.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(BlobURLStore_ResolveForNavigation_ResponseParams.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStructPointer(unguessable_token$.UnguessableToken, val.unsafeAgentClusterId);
  };
  ...
  BlobURLStoreProxy.prototype.register = function(blob, url, unsafeAgentClusterId) {
    var params_ = new BlobURLStore_Register_Params();
    params_.blob = blob;
    params_.url = url;
    params_.unsafeAgentClusterId = unsafeAgentClusterId;
  ...
  BlobURLStoreProxy.prototype.resolveAsURLLoaderFactory = function(url, factory) {
    ...
    return new Promise(function(resolve, reject) {
      ...
      this.receiver_.acceptAndExpectResponse(message).then(function(message) {
        var reader = new codec.MessageReader(message);
        var responseParams =
            reader.decodeStruct(BlobURLStore_ResolveAsURLLoaderFactory_ResponseParams);
        resolve(responseParams);
      }).catch(function(result) {
        reject(Error("Connection error: " + result));
      });
  ...
  BlobURLStoreProxy.prototype.resolveForNavigation = function(url, token) {
    ...
    return new Promise(function(resolve, reject) {
      ...
      this.receiver_.acceptAndExpectResponse(message).then(function(message) {
        var reader = new codec.MessageReader(message);
        var responseParams =
            reader.decodeStruct(BlobURLStore_ResolveForNavigation_ResponseParams);
        resolve(responseParams);
      }).catch(function(result) {
        reject(Error("Connection error: " + result));
      });
  ...
  BlobURLStoreStub.prototype.register = function(blob, url, unsafeAgentClusterId) {
    return this.delegate_ && this.delegate_.register && this.delegate_.register(blob, url, unsafeAgentClusterId);
  }
  ...
  BlobURLStoreStub.prototype.acceptWithResponder =
    ...
    case kBlobURLStore_Register_Name:
      ...
      this.register(params.blob, params.url, params.unsafeAgentClusterId).then(function(response) {
        var responseParams =
    ...
    case kBlobURLStore_Resolve_Name:
      ...
      this.resolve(params.url).then(function(response) {
        ...
        responseParams.unsafeAgentClusterId = response.unsafeAgentClusterId;
        var builder = new codec.MessageV1Builder(
            kBlobURLStore_Resolve_Name,
    ...
    case kBlobURLStore_ResolveAsURLLoaderFactory_Name:
      ...
      this.resolveAsURLLoaderFactory(params.url, params.factory).then(function(response) {
        var responseParams =
            new BlobURLStore_ResolveAsURLLoaderFactory_ResponseParams();
        responseParams.unsafeAgentClusterId = response.unsafeAgentClusterId;
        var builder = new codec.MessageV1Builder(
            kBlobURLStore_ResolveAsURLLoaderFactory_Name,
            codec.align(BlobURLStore_ResolveAsURLLoaderFactory_ResponseParams.encodedSize),
            codec.kMessageIsResponse, reader.requestID);
        builder.encodeStruct(BlobURLStore_ResolveAsURLLoaderFactory_ResponseParams,
                             responseParams);
        var message = builder.finish();
        responder.accept(message);
      });
    ...
    case kBlobURLStore_ResolveForNavigation_Name:
      ...
      this.resolveForNavigation(params.url, params.token).then(function(response) {
        var responseParams =
            new BlobURLStore_ResolveForNavigation_ResponseParams();
        responseParams.unsafeAgentClusterId = response.unsafeAgentClusterId;
        var builder = new codec.MessageV1Builder(
            kBlobURLStore_ResolveForNavigation_Name,
            codec.align(BlobURLStore_ResolveForNavigation_ResponseParams.encodedSize),
            codec.kMessageIsResponse, reader.requestID);
        builder.encodeStruct(BlobURLStore_ResolveForNavigation_ResponseParams,
                             responseParams);
        var message = builder.finish();
        responder.accept(message);
      });
  ...
  function validateBlobURLStoreResponse(messageValidator) {
   ...
   switch (message.getName()) {
      ...
      case kBlobURLStore_ResolveAsURLLoaderFactory_Name:
        if (message.isResponse())
          paramsClass = BlobURLStore_ResolveAsURLLoaderFactory_ResponseParams;
        break;
      case kBlobURLStore_ResolveForNavigation_Name:
        if (message.isResponse())
          paramsClass = BlobURLStore_ResolveForNavigation_ResponseParams;
        break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
