...
(function() {
  ...
  SecurePaymentConfirmationResponse.encodedSize = codec.kStructHeaderSize + 24;
  ...
  SecurePaymentConfirmationRequest.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 16, payment_credential$.PaymentCredentialInstrument, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  SecurePaymentConfirmationRequest.encodedSize = codec.kStructHeaderSize + 32;
  ...
  SecurePaymentConfirmationRequest.decode = function(decoder) {
    ...
    val.challenge =
        decoder.decodeArrayPointer(codec.Uint8);
    val.instrument =
        decoder.decodeStructPointer(payment_credential$.PaymentCredentialInstrument);
    val.timeout =
  ...
  SecurePaymentConfirmationRequest.encode = function(encoder, val) {
    ...
    encoder.encodeStructPointer(payment_credential$.PaymentCredentialInstrument, val.instrument);
