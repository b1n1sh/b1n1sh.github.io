...
(function() {
  ...
  function ClipboardSequenceNumberToken(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  ClipboardSequenceNumberToken.prototype.initDefaults_ = function() {
    this.value = null;
  };
  ClipboardSequenceNumberToken.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  ClipboardSequenceNumberToken.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate ClipboardSequenceNumberToken.value
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, unguessable_token$.UnguessableToken, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  ClipboardSequenceNumberToken.encodedSize = codec.kStructHeaderSize + 8;

  ClipboardSequenceNumberToken.decode = function(decoder) {
    var packed;
    var val = new ClipboardSequenceNumberToken();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.value =
        decoder.decodeStructPointer(unguessable_token$.UnguessableToken);
  ...
  ClipboardSequenceNumberToken.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(ClipboardSequenceNumberToken.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStructPointer(unguessable_token$.UnguessableToken, val.value);
  };
