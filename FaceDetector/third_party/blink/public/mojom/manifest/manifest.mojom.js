...
(function() {
  ...
  Manifest.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 112, ManifestNoteTaking, true);
    if (err !== validator.validationError.NONE)
        return err;


    // validate Manifest.relatedApplications
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 120, 8, new codec.PointerTo(ManifestRelatedApplication), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 144, string16$.String16, true);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 140, capture_links$.CaptureLinks);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 160, ManifestLaunchHandler, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  Manifest.encodedSize = codec.kStructHeaderSize + 168;
  ...
  Manifest.decode = function(decoder) {
    ...
    val.isolatedStorage = (packed >> 3) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    val.themeColor =
    ...
    val.scope =
        decoder.decodeStructPointer(url$.Url);
    val.launchHandler =
        decoder.decodeStructPointer(ManifestLaunchHandler);
    return val;
  };
  ...
  Manifest.encode = function(encoder, val) {
    ...
    packed |= (val.isolatedStorage & 1) << 3
    ...
    encoder.encodeStructPointer(ManifestLaunchHandler, val.launchHandler);
  };
  ...
  ManifestFileHandler.encodedSize = codec.kStructHeaderSize + 32;
  ...
  ManifestLaunchHandler.RouteTo = {};
  ManifestLaunchHandler.RouteTo.kAuto = 0;
  ManifestLaunchHandler.RouteTo.kNewClient = 1;
  ManifestLaunchHandler.RouteTo.kExistingClient = 2;
  ManifestLaunchHandler.RouteTo.MIN_VALUE = 0;
  ManifestLaunchHandler.RouteTo.MAX_VALUE = 2;

  ManifestLaunchHandler.RouteTo.isKnownEnumValue = function(value) {
    switch (value) {
    case 0:
    case 1:
    case 2:
  ...
  ManifestLaunchHandler.RouteTo.toKnownEnumValue = function(value) {
    return value;
  };

  ManifestLaunchHandler.RouteTo.validate = function(enumValue) {
    const isExtensible = false;
    if (isExtensible || this.isKnownEnumValue(enumValue))
      return validator.validationError.NONE;
  ...
  ManifestLaunchHandler.NavigateExistingClient = {};
  ManifestLaunchHandler.NavigateExistingClient.kAlways = 0;
  ManifestLaunchHandler.NavigateExistingClient.kNever = 1;
  ManifestLaunchHandler.NavigateExistingClient.MIN_VALUE = 0;
  ManifestLaunchHandler.NavigateExistingClient.MAX_VALUE = 1;

  ManifestLaunchHandler.NavigateExistingClient.isKnownEnumValue = function(value) {
    switch (value) {
    case 0:
    case 1:
      return true;
  ...
  ManifestLaunchHandler.NavigateExistingClient.toKnownEnumValue = function(value) {
    return value;
  };

  ManifestLaunchHandler.NavigateExistingClient.validate = function(enumValue) {
    const isExtensible = false;
    if (isExtensible || this.isKnownEnumValue(enumValue))
      return validator.validationError.NONE;
  ...
  ManifestLaunchHandler.validate = function(messageValidator, offset) {
    ...
    // validate ManifestLaunchHandler.routeTo
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 0, ManifestLaunchHandler.RouteTo);
    if (err !== validator.validationError.NONE)
        return err;


    // validate ManifestLaunchHandler.navigateExistingClient
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 4, ManifestLaunchHandler.NavigateExistingClient);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  ManifestLaunchHandler.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.routeTo =
        decoder.decodeStruct(new codec.Enum(ManifestLaunchHandler.RouteTo));
    val.navigateExistingClient =
        decoder.decodeStruct(new codec.Enum(ManifestLaunchHandler.NavigateExistingClient));
    return val;
  };
  ...
  ManifestLaunchHandler.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.Int32, val.routeTo);
    encoder.encodeStruct(codec.Int32, val.navigateExistingClient);
  };
