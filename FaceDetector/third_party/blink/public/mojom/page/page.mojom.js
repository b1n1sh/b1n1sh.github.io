...
(function() {
  ...
  PageBroadcast_ActivatePrerenderedPage_Params.validate = function(messageValidator, offset) {
    ...
    // validate PageBroadcast_ActivatePrerenderedPage_Params.activationStart
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, time$.TimeTicks, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  var kPageBroadcast_SetInsidePortal_Name = 3;
  var kPageBroadcast_UpdateWebPreferences_Name = 4;
  var kPageBroadcast_UpdateRendererPreferences_Name = 5;
  var kPageBroadcast_SetHistoryOffsetAndLength_Name = 6;
  var kPageBroadcast_SetPageBaseBackgroundColor_Name = 7;
  ...
  PageBroadcastProxy.prototype.activatePrerenderedPage = function(activationStart) {
    var params_ = new PageBroadcast_ActivatePrerenderedPage_Params();
    params_.activationStart = activationStart;
    return new Promise(function(resolve, reject) {
      var builder = new codec.MessageV1Builder(
  ...
  PageBroadcastStub.prototype.activatePrerenderedPage = function(activationStart) {
    return this.delegate_ && this.delegate_.activatePrerenderedPage && this.delegate_.activatePrerenderedPage(activationStart);
  }
  ...
  PageBroadcastStub.prototype.acceptWithResponder =
    ...
    case kPageBroadcast_ActivatePrerenderedPage_Name:
      ...
      this.activatePrerenderedPage(params.activationStart).then(function(response) {
        var responseParams =
