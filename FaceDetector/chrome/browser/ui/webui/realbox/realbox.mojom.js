...
(function() {
  ...
  AutocompleteMatch.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 8, SuggestionAnswer, true);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 24, 8, new codec.PointerTo(ACMatchClassification), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 40, 8, new codec.PointerTo(ACMatchClassification), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  AutocompleteMatch.encodedSize = codec.kStructHeaderSize + 104;
  ...
  var kPageHandler_QueryAutocomplete_Name = 1962586384;
  var kPageHandler_StopAutocomplete_Name = 1718134429;
  var kPageHandler_OpenAutocompleteMatch_Name = 1770514989;
  var kPageHandler_DeleteAutocompleteMatch_Name = 1004344447;
  var kPageHandler_ToggleSuggestionGroupIdVisibility_Name = 1016706116;
  var kPageHandler_LogCharTypedToRepaintLatency_Name = 1532274342;
  ...
  var kPage_AutocompleteResultChanged_Name = 1002832096;
  var kPage_AutocompleteMatchImageAvailable_Name = 2119873422;
