// chrome/browser/new_tab_page/modules/task_module/task_module.mojom.js is auto generated by mojom_bindings_generator.py, do not edit
...
(function() {
  var mojomId = 'chrome/browser/new_tab_page/modules/task_module/task_module.mojom';
  ...
  TaskModuleType.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  TaskModuleHandler_GetPrimaryTask_Params.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.taskModuleType =
        decoder.decodeStruct(new codec.Enum(TaskModuleType));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  var kTaskModuleHandler_GetPrimaryTask_Name = 533773170;
  var kTaskModuleHandler_DismissTask_Name = 2057370501;
  var kTaskModuleHandler_RestoreTask_Name = 355021241;
  var kTaskModuleHandler_OnTaskItemClicked_Name = 706555503;
  var kTaskModuleHandler_OnRelatedSearchClicked_Name = 507604569;
