...
(function() {
  ...
  WakeLockType.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  WakeLockReason.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  WakeLock_ChangeType_Params.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.type =
        decoder.decodeStruct(new codec.Enum(WakeLockType));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  var kWakeLock_RequestWakeLock_Name = 1545051665;
  var kWakeLock_CancelWakeLock_Name = 540016740;
  var kWakeLock_AddClient_Name = 2078070079;
  var kWakeLock_ChangeType_Name = 415460182;
  var kWakeLock_HasWakeLockForTests_Name = 1063774988;
