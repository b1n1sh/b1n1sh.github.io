...
(function() {
  ...
  NetworkContextParams.prototype.initDefaults_ = function() {
    ...
    this.transportSecurityPersisterFilePath = null;
  ...
  NetworkContextParams.validate = function(messageValidator, offset) {
    ...
    // validate NetworkContextParams.transportSecurityPersisterFilePath
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 152, CTPolicy, true);
    if (err !== validator.validationError.NONE)
        return err;


    // validate NetworkContextParams.certVerifierParams
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 160, CertVerifierServiceRemoteParams, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate NetworkContextParams.cookieManagerParams
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 168, cookie_manager$.CookieManagerParams, true);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 184, time$.TimeDelta, true);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 192, 8, new codec.PointerTo(cors_origin_pattern$.CorsOriginAccessPatterns), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 208, 8, codec.String, false, [0, 0], 0);
    if (err !== validator.validationError.NONE)
        return err;


    // validate NetworkContextParams.reportingAndNelStorePath
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 216, file_path$.FilePath, true);
    if (err !== validator.validationError.NONE)
        return err;


    // validate NetworkContextParams.httpAuthStaticNetworkContextParams
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 224, HttpAuthStaticNetworkContextParams, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkContextParams.decode = function(decoder) {
    ...
    val.httpServerPropertiesPath =
        decoder.decodeStructPointer(file_path$.FilePath);
    val.transportSecurityPersisterFilePath =
        decoder.decodeStructPointer(file_path$.FilePath);
  ...
  NetworkContextParams.encode = function(encoder, val) {
    ...
    encoder.encodeStructPointer(file_path$.FilePath, val.transportSecurityPersisterFilePath);
  ...
  NetworkContext_SetDocumentReportingEndpoints_Params.validate = function(messageValidator, offset) {
    ...
    // validate NetworkContext_SetDocumentReportingEndpoints_Params.networkIsolationKey
  ...
  NetworkContext_SetDocumentReportingEndpoints_Params.encodedSize = codec.kStructHeaderSize + 24;
  ...
  var kCustomProxyConnectionObserver_OnFallback_Name = 676672876;
  var kCustomProxyConnectionObserver_OnTunnelHeadersReceived_Name = 799937019;
  ...
  var kCustomProxyConfigClient_OnCustomProxyConfigUpdated_Name = 1226438614;
  var kCustomProxyConfigClient_MarkProxiesAsBad_Name = 1460860383;
  var kCustomProxyConfigClient_ClearBadProxiesCache_Name = 1981074775;
  ...
  var kTrustedHeaderClient_OnBeforeSendHeaders_Name = 1443206823;
  var kTrustedHeaderClient_OnHeadersReceived_Name = 1486222421;
  ...
  var kTrustedURLLoaderHeaderClient_OnLoaderCreated_Name = 715224820;
  var kTrustedURLLoaderHeaderClient_OnLoaderForCorsPreflightCreated_Name = 1071129242;
  ...
  var kNetworkContextClient_OnFileUploadRequested_Name = 1191674213;
  var kNetworkContextClient_OnCanSendReportingReports_Name = 835002731;
  var kNetworkContextClient_OnCanSendDomainReliabilityUpload_Name = 1563841964;
  var kNetworkContextClient_OnTrustTokenIssuanceDivertedToSystem_Name = 1335560562;
  ...
  var kNetworkContext_SetClient_Name = 101570146;
  var kNetworkContext_CreateURLLoaderFactory_Name = 838336728;
  var kNetworkContext_ResetURLLoaderFactories_Name = 1937745428;
  var kNetworkContext_GetCookieManager_Name = 487336021;
  var kNetworkContext_GetRestrictedCookieManager_Name = 312694691;
  var kNetworkContext_GetHasTrustTokensAnswerer_Name = 1223142580;
  var kNetworkContext_ClearTrustTokenData_Name = 1151459725;
  var kNetworkContext_GetStoredTrustTokenCounts_Name = 613445864;
  var kNetworkContext_DeleteStoredTrustTokens_Name = 926816711;
  var kNetworkContext_ClearNetworkingHistoryBetween_Name = 1808074474;
  var kNetworkContext_ClearHttpCache_Name = 1803037714;
  var kNetworkContext_ComputeHttpCacheSize_Name = 1567054209;
  var kNetworkContext_NotifyExternalCacheHit_Name = 272018178;
  var kNetworkContext_ClearHostCache_Name = 1106807434;
  var kNetworkContext_ClearHttpAuthCache_Name = 1473072826;
  var kNetworkContext_ClearReportingCacheReports_Name = 1093891866;
  var kNetworkContext_ClearReportingCacheClients_Name = 558876492;
  var kNetworkContext_ClearNetworkErrorLogging_Name = 1692219652;
  var kNetworkContext_ClearDomainReliability_Name = 502762;
  var kNetworkContext_GetDomainReliabilityJSON_Name = 954505629;
  var kNetworkContext_SetDocumentReportingEndpoints_Name = 1082354700;
  var kNetworkContext_QueueReport_Name = 2127357966;
  var kNetworkContext_QueueSignedExchangeReport_Name = 1523365636;
  var kNetworkContext_CloseAllConnections_Name = 1193756333;
  var kNetworkContext_CloseIdleConnections_Name = 725574405;
  var kNetworkContext_SetNetworkConditions_Name = 402540737;
  var kNetworkContext_SetAcceptLanguage_Name = 686778430;
  var kNetworkContext_SetEnableReferrers_Name = 1680207628;
  var kNetworkContext_SetCTPolicy_Name = 705713970;
  var kNetworkContext_AddExpectCT_Name = 895980766;
  var kNetworkContext_SetExpectCTTestReport_Name = 478635162;
  var kNetworkContext_GetExpectCTState_Name = 1107933792;
  var kNetworkContext_CreateUDPSocket_Name = 56397222;
  var kNetworkContext_CreateTCPServerSocket_Name = 1476699956;
  var kNetworkContext_CreateTCPConnectedSocket_Name = 2114200709;
  var kNetworkContext_CreateTCPBoundSocket_Name = 1167804621;
  var kNetworkContext_CreateProxyResolvingSocketFactory_Name = 1162586439;
  var kNetworkContext_LookUpProxyForURL_Name = 1672588478;
  var kNetworkContext_ForceReloadProxyConfig_Name = 98435988;
  var kNetworkContext_ClearBadProxiesCache_Name = 1902040896;
  var kNetworkContext_CreateWebSocket_Name = 819190046;
  var kNetworkContext_CreateWebTransport_Name = 1453582830;
  var kNetworkContext_CreateNetLogExporter_Name = 194967512;
  var kNetworkContext_PreconnectSockets_Name = 673213119;
  var kNetworkContext_CreateP2PSocketManager_Name = 164019260;
  var kNetworkContext_CreateMdnsResponder_Name = 346849210;
  var kNetworkContext_ResolveHost_Name = 1938613818;
  var kNetworkContext_CreateHostResolver_Name = 678167147;
  var kNetworkContext_VerifyCertForSignedExchange_Name = 1792247269;
  var kNetworkContext_AddHSTS_Name = 345395834;
  var kNetworkContext_IsHSTSActiveForHost_Name = 2039447756;
  var kNetworkContext_GetHSTSState_Name = 380032139;
  var kNetworkContext_SetCorsOriginAccessListsForOrigin_Name = 358149406;
  var kNetworkContext_DeleteDynamicDataForHost_Name = 198381202;
  var kNetworkContext_SetSplitAuthCacheByNetworkIsolationKey_Name = 275815177;
  var kNetworkContext_SaveHttpAuthCacheProxyEntries_Name = 1659204876;
  var kNetworkContext_LoadHttpAuthCacheProxyEntries_Name = 1889309488;
  var kNetworkContext_AddAuthCacheEntry_Name = 350357990;
  var kNetworkContext_LookupServerBasicAuthCredentials_Name = 7662852;
  var kNetworkContext_EnableStaticKeyPinningForTesting_Name = 96897953;
  var kNetworkContext_VerifyCertificateForTesting_Name = 1209777872;
  var kNetworkContext_AddDomainReliabilityContextForTesting_Name = 2003054056;
  var kNetworkContext_ForceDomainReliabilityUploadsForTesting_Name = 1574573940;
  var kNetworkContext_GetOriginPolicyManager_Name = 573026380;
  var kNetworkContext_SetSCTAuditingEnabled_Name = 1114963712;
  ...
  NetworkContextProxy.prototype.setDocumentReportingEndpoints = function(origin, networkIsolationKey, endpoints) {
  ...
  NetworkContextStub.prototype.setDocumentReportingEndpoints = function(origin, networkIsolationKey, endpoints) {
    return this.delegate_ && this.delegate_.setDocumentReportingEndpoints && this.delegate_.setDocumentReportingEndpoints(origin, networkIsolationKey, endpoints);
  }
  ...
  NetworkContextStub.prototype.accept = function(message) {
    ...
    case kNetworkContext_SetDocumentReportingEndpoints_Name:
      ...
      this.setDocumentReportingEndpoints(params.origin, params.networkIsolationKey, params.endpoints);
      return true;
