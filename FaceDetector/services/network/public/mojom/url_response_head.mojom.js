...
(function() {
  ...
  URLResponseHead.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 96, network_types$.ConnectionInfo);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 120, proxy_resolver$.ProxyServer, false);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 100, fetch_api$.FetchResponseSource);
    if (err !== validator.validationError.NONE)
        return err;


    // validate URLResponseHead.urlListViaServiceWorker
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 128, 8, new codec.PointerTo(url$.Url), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  URLResponseHead.decode = function(decoder) {
    ...
    val.isValidated = (packed >> 4) & 1 ? true : false;
    val.wasFetchedViaCache = (packed >> 5) & 1 ? true : false;
    val.wasFetchedViaServiceWorker = (packed >> 6) & 1 ? true : false;
  ...
  URLResponseHead.encode = function(encoder, val) {
    ...
    packed |= (val.isValidated & 1) << 4
    packed |= (val.wasFetchedViaCache & 1) << 5
    packed |= (val.wasFetchedViaServiceWorker & 1) << 6
