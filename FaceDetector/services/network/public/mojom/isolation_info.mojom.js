...
(function() {
  ...
  IsolationInfo.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 40, 8, new codec.PointerTo(schemeful_site$.SchemefulSite), true, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  IsolationInfo.encodedSize = codec.kStructHeaderSize + 48;
