...
(function() {
  ...
  BindInterfacePriority.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  Connector_BindInterface_Params.decode = function(decoder) {
    ...
    val.priority =
        decoder.decodeStruct(new codec.Enum(BindInterfacePriority));
    return val;
  };
  ...
  var kProcessMetadata_SetPID_Name = 1399311531;
  ...
  var kConnector_BindInterface_Name = 1004875908;
  var kConnector_QueryService_Name = 1235486403;
  var kConnector_WarmService_Name = 436630003;
  var kConnector_RegisterServiceInstance_Name = 516952004;
  var kConnector_Clone_Name = 1593486883;
