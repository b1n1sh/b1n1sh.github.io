...
(function() {
  ...
  function GpuMemoryBufferFactory_CopyGpuMemoryBuffer_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  GpuMemoryBufferFactory_CopyGpuMemoryBuffer_Params.prototype.initDefaults_ = function() {
    this.bufferHandle = null;
    this.sharedMemory = null;
  };
  GpuMemoryBufferFactory_CopyGpuMemoryBuffer_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  GpuMemoryBufferFactory_CopyGpuMemoryBuffer_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate GpuMemoryBufferFactory_CopyGpuMemoryBuffer_Params.bufferHandle
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, buffer_types$.GpuMemoryBufferHandle, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate GpuMemoryBufferFactory_CopyGpuMemoryBuffer_Params.sharedMemory
  ...
  GpuMemoryBufferFactory_CopyGpuMemoryBuffer_Params.encodedSize = codec.kStructHeaderSize + 16;

  GpuMemoryBufferFactory_CopyGpuMemoryBuffer_Params.decode = function(decoder) {
    var packed;
    var val = new GpuMemoryBufferFactory_CopyGpuMemoryBuffer_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.bufferHandle =
        decoder.decodeStructPointer(buffer_types$.GpuMemoryBufferHandle);
  ...
  GpuMemoryBufferFactory_CopyGpuMemoryBuffer_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(GpuMemoryBufferFactory_CopyGpuMemoryBuffer_Params.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStructPointer(buffer_types$.GpuMemoryBufferHandle, val.bufferHandle);
    encoder.encodeStructPointer(shared_memory$.UnsafeSharedMemoryRegion, val.sharedMemory);
  };
  function GpuMemoryBufferFactory_CopyGpuMemoryBuffer_ResponseParams(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  GpuMemoryBufferFactory_CopyGpuMemoryBuffer_ResponseParams.prototype.initDefaults_ = function() {
    this.success = false;
  };
  GpuMemoryBufferFactory_CopyGpuMemoryBuffer_ResponseParams.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  GpuMemoryBufferFactory_CopyGpuMemoryBuffer_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  GpuMemoryBufferFactory_CopyGpuMemoryBuffer_ResponseParams.encodedSize = codec.kStructHeaderSize + 8;

  GpuMemoryBufferFactory_CopyGpuMemoryBuffer_ResponseParams.decode = function(decoder) {
    var packed;
    var val = new GpuMemoryBufferFactory_CopyGpuMemoryBuffer_ResponseParams();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
  ...
  GpuMemoryBufferFactory_CopyGpuMemoryBuffer_ResponseParams.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(GpuMemoryBufferFactory_CopyGpuMemoryBuffer_ResponseParams.encodedSize);
    encoder.writeUint32(0);
    packed = 0;
  ...
  var kGpuMemoryBufferFactory_CreateGpuMemoryBuffer_Name = 1176055957;
  var kGpuMemoryBufferFactory_DestroyGpuMemoryBuffer_Name = 1707997046;
  var kGpuMemoryBufferFactory_CopyGpuMemoryBuffer_Name = 694751093;
  ...
  GpuMemoryBufferFactoryPtr.prototype.copyGpuMemoryBuffer = function() {
    return GpuMemoryBufferFactoryProxy.prototype.copyGpuMemoryBuffer
        .apply(this.ptr.getProxy(), arguments);
  };

  GpuMemoryBufferFactoryProxy.prototype.copyGpuMemoryBuffer = function(bufferHandle, sharedMemory) {
    var params_ = new GpuMemoryBufferFactory_CopyGpuMemoryBuffer_Params();
    params_.bufferHandle = bufferHandle;
    params_.sharedMemory = sharedMemory;
    return new Promise(function(resolve, reject) {
      var builder = new codec.MessageV1Builder(
          kGpuMemoryBufferFactory_CopyGpuMemoryBuffer_Name,
          codec.align(GpuMemoryBufferFactory_CopyGpuMemoryBuffer_Params.encodedSize),
          codec.kMessageExpectsResponse, 0);
      builder.encodeStruct(GpuMemoryBufferFactory_CopyGpuMemoryBuffer_Params, params_);
      var message = builder.finish();
      this.receiver_.acceptAndExpectResponse(message).then(function(message) {
        var reader = new codec.MessageReader(message);
        var responseParams =
            reader.decodeStruct(GpuMemoryBufferFactory_CopyGpuMemoryBuffer_ResponseParams);
        resolve(responseParams);
      }).catch(function(result) {
        reject(Error("Connection error: " + result));
      });
  ...
  GpuMemoryBufferFactoryStub.prototype.copyGpuMemoryBuffer = function(bufferHandle, sharedMemory) {
  ...
  GpuMemoryBufferFactoryStub.prototype.acceptWithResponder =
    ...
    case kGpuMemoryBufferFactory_CreateGpuMemoryBuffer_Name:
      ...
      return true;
    case kGpuMemoryBufferFactory_CopyGpuMemoryBuffer_Name:
      var params = reader.decodeStruct(GpuMemoryBufferFactory_CopyGpuMemoryBuffer_Params);
      this.copyGpuMemoryBuffer(params.bufferHandle, params.sharedMemory).then(function(response) {
        var responseParams =
            new GpuMemoryBufferFactory_CopyGpuMemoryBuffer_ResponseParams();
        responseParams.success = response.success;
        var builder = new codec.MessageV1Builder(
            kGpuMemoryBufferFactory_CopyGpuMemoryBuffer_Name,
            codec.align(GpuMemoryBufferFactory_CopyGpuMemoryBuffer_ResponseParams.encodedSize),
            codec.kMessageIsResponse, reader.requestID);
        builder.encodeStruct(GpuMemoryBufferFactory_CopyGpuMemoryBuffer_ResponseParams,
                             responseParams);
        var message = builder.finish();
        responder.accept(message);
      });
  ...
  function validateGpuMemoryBufferFactoryRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kGpuMemoryBufferFactory_CopyGpuMemoryBuffer_Name:
        if (message.expectsResponse())
          paramsClass = GpuMemoryBufferFactory_CopyGpuMemoryBuffer_Params;
      break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
  ...
  function validateGpuMemoryBufferFactoryResponse(messageValidator) {
   ...
   switch (message.getName()) {
      ...
      case kGpuMemoryBufferFactory_CopyGpuMemoryBuffer_Name:
        if (message.isResponse())
          paramsClass = GpuMemoryBufferFactory_CopyGpuMemoryBuffer_ResponseParams;
        break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
  ...
  var kGpu_CreateGpuMemoryBufferFactory_Name = 857811060;
  var kGpu_EstablishGpuChannel_Name = 504520421;
  var kGpu_CreateVideoEncodeAcceleratorProvider_Name = 1315014979;
