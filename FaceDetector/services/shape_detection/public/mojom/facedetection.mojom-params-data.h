// services/shape_detection/public/mojom/facedetection.mojom-params-data.h is auto generated by mojom_bindings_generator.py, do not edit
...
class  FaceDetection_Detect_Params_Data {
 ...
 private:
  friend class mojo::internal::MessageFragment<FaceDetection_Detect_Params_Data>;
...
class  FaceDetection_Detect_ResponseParams_Data {
 ...
 private:
  friend class mojo::internal::MessageFragment<FaceDetection_Detect_ResponseParams_Data>;
...
class FaceDetection_Detect_ParamsDataView {
 public:
  FaceDetection_Detect_ParamsDataView() = default;
...
class FaceDetection_Detect_ResponseParamsDataView {
 public:
  FaceDetection_Detect_ResponseParamsDataView() = default;
...
inline void FaceDetection_Detect_ResponseParamsDataView::GetResultsDataView(
    mojo::ArrayDataView<FaceDetectionResultDataView>* output) {
  auto pointer = data_->results.Get();
  *output = mojo::ArrayDataView<FaceDetectionResultDataView>(pointer, message_);
}
