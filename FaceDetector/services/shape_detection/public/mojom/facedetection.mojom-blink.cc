// services/shape_detection/public/mojom/facedetection.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
Landmark::Landmark(
    WTF::Vector<::gfx::PointF> locations_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type WTF::Vector<LandmarkPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("results"), in_results,
                        "<value of type WTF::Vector<FaceDetectionResultPtr>>");
   });
#endif
...
bool FaceDetectionRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::shape_detection::mojom::blink::FaceDetection::Name_;
