...
#ifndef SERVICES_SHAPE_DETECTION_PUBLIC_MOJOM_BARCODEDETECTION_MOJOM_BLINK_JUMBO_H_
#define SERVICES_SHAPE_DETECTION_PUBLIC_MOJOM_BARCODEDETECTION_MOJOM_BLINK_JUMBO_H_
#endif
...
static const mojo::internal::GenericValidationInfo kBarcodeDetectionValidationInfo[] = {
...
bool BarcodeDetectionRequestValidator::Accept(mojo::Message* message) {
  ...
  return mojo::internal::ValidateRequestGenericPacked(message, name, kBarcodeDetectionValidationInfo);
}

bool BarcodeDetectionResponseValidator::Accept(mojo::Message* message) {
  const char* name = ::shape_detection::mojom::blink::BarcodeDetection::Name_;
  return mojo::internal::ValidateResponseGenericPacked(message, name, kBarcodeDetectionValidationInfo);
}
}  // namespace blink
}  // namespace mojom
}  // namespace shape_detection
