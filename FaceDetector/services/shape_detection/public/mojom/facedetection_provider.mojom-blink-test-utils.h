...
class  FaceDetectionProviderInterceptorForTesting : public FaceDetectionProvider {
  ...
  void CreateFaceDetection(::mojo::PendingReceiver<::shape_detection::mojom::blink::FaceDetection> receiver, ::shape_detection::mojom::blink::FaceDetectorOptionsPtr options) override;
};
