// services/shape_detection/public/mojom/barcodedetection_provider.mojom-blink-test-utils.h is auto generated by mojom_bindings_generator.py, do not edit
...
class  BarcodeDetectionProviderInterceptorForTesting : public BarcodeDetectionProvider {
  ...
  void CreateBarcodeDetection(::mojo::PendingReceiver<::shape_detection::mojom::blink::BarcodeDetection> receiver, BarcodeDetectorOptionsPtr options) override;
