...
// static
bool TextDetectionResult_Data::Validate(
    const void* data,
  ...
  const TextDetectionResult_Data* object = static_cast<const TextDetectionResult_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->corner_points, 3, validation_context)) {
    return false;
  }
...
// static
bool TextDetection_Detect_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const TextDetection_Detect_Params_Data* object = static_cast<const TextDetection_Detect_Params_Data*>(data);
  ALLOW_UNUSED_LOCAL(object);
...
// static
bool TextDetection_Detect_ResponseParams_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const TextDetection_Detect_ResponseParams_Data* object = static_cast<const TextDetection_Detect_ResponseParams_Data*>(data);
  ALLOW_UNUSED_LOCAL(object);
