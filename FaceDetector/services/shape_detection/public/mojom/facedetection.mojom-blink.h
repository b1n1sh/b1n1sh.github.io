// services/shape_detection/public/mojom/facedetection.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit
...
class  Landmark {
 public:
  ...
  Landmark(
      WTF::Vector<::gfx::PointF> locations,
      LandmarkType type);
