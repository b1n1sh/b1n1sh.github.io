...
static NOINLINE const char* LandmarkTypeToStringHelper(LandmarkType value) {
...
// static
void TraceFormatTraits<::shape_detection::mojom::LandmarkType>::WriteIntoTrace(
   perfetto::TracedValue context, ::shape_detection::mojom::LandmarkType value) {
