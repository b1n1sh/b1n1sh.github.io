...
(function() {
  ...
  GpuInfo.prototype.initDefaults_ = function() {
    ...
    this.videoDecoderCapabilities = null;
  ...
  GpuInfo.validate = function(messageValidator, offset) {
    ...
    // validate GpuInfo.videoDecoderCapabilities
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 144, 8, new codec.PointerTo(VideoDecodeAcceleratorSupportedProfile), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;


    // validate GpuInfo.videoEncodeAcceleratorSupportedProfiles
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 152, 8, new codec.PointerTo(VideoEncodeAcceleratorSupportedProfile), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 160, 8, new codec.PointerTo(ImageDecodeAcceleratorSupportedProfile), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 176, vulkan_info$.VulkanInfo, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  GpuInfo.encode = function(encoder, val) {
    ...
    encoder.encodeArrayPointer(new codec.PointerTo(VideoDecodeAcceleratorSupportedProfile), val.videoDecoderCapabilities);
