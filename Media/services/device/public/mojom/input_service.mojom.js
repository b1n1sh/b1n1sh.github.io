...
(function() {
  ...
  InputDeviceSubsystem.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  InputDeviceType.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  InputDeviceInfo.decode = function(decoder) {
    ...
    val.name =
        decoder.decodeStruct(codec.String);
    val.subsystem =
        decoder.decodeStruct(new codec.Enum(InputDeviceSubsystem));
    val.type =
        decoder.decodeStruct(new codec.Enum(InputDeviceType));
  ...
  var kInputDeviceManagerClient_InputDeviceAdded_Name = 1667858974;
  var kInputDeviceManagerClient_InputDeviceRemoved_Name = 736194286;
  ...
  var kInputDeviceManager_GetDevicesAndSetClient_Name = 1420828961;
  var kInputDeviceManager_GetDevices_Name = 1919966261;
