...
(function() {
  ...
  StreamVideoQuadState.validate = function(messageValidator, offset) {
    ...
    // validate StreamVideoQuadState.resourceId
  ...
  TextureQuadState.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 48, ProtectedVideoState);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 52, OverlayPriority);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  YUVVideoQuadState.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 56, resource_id$.ResourceId, false);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 80, color_space$.ColorSpace, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate YUVVideoQuadState.protectedVideoType
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 76, ProtectedVideoState);
    if (err !== validator.validationError.NONE)
        return err;


    // validate YUVVideoQuadState.hdrMetadata
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 88, hdr_metadata$.HDRMetadata, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  YUVVideoQuadState.encodedSize = codec.kStructHeaderSize + 104;
