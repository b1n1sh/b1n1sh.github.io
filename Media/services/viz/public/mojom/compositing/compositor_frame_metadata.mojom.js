...
(function() {
  ...
  CompositorFrameMetadata.decode = function(decoder) {
    ...
    val.sendFrameTokenToEmbedder = (packed >> 3) & 1 ? true : false;
    val.topControlsVisibleHeightSet = (packed >> 4) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  CompositorFrameMetadata.encode = function(encoder, val) {
    ...
    packed |= (val.sendFrameTokenToEmbedder & 1) << 3
    packed |= (val.topControlsVisibleHeightSet & 1) << 4
