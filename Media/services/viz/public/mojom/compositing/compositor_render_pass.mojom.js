...
(function() {
  ...
  CompositorRenderPass.validate = function(messageValidator, offset) {
    ...
    // validate CompositorRenderPass.captureBounds
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 72, region_capture_bounds$.RegionCaptureBounds, true);
    if (err !== validator.validationError.NONE)
        return err;
