...
(function() {
  ...
  CompositorFrameTransitionDirectiveEffect.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  function CompositorFrameTransitionDirectiveConfig(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  CompositorFrameTransitionDirectiveConfig.prototype.initDefaults_ = function() {
    this.duration = null;
    this.delay = null;
  };
  CompositorFrameTransitionDirectiveConfig.prototype.initFields_ = function(fields) {
  ...
  CompositorFrameTransitionDirectiveConfig.validate = function(messageValidator, offset) {
    var err;
    ...
    // validate CompositorFrameTransitionDirectiveConfig.duration
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, time$.TimeDelta, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate CompositorFrameTransitionDirectiveConfig.delay
  ...
  CompositorFrameTransitionDirectiveConfig.encodedSize = codec.kStructHeaderSize + 16;

  CompositorFrameTransitionDirectiveConfig.decode = function(decoder) {
    var packed;
    var val = new CompositorFrameTransitionDirectiveConfig();
  ...
  CompositorFrameTransitionDirectiveConfig.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(CompositorFrameTransitionDirectiveConfig.encodedSize);
  ...
  CompositorFrameTransitionDirectiveSharedElement.validate = function(messageValidator, offset) {
    ...
    // validate CompositorFrameTransitionDirectiveSharedElement.config
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 8, CompositorFrameTransitionDirectiveConfig, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  CompositorFrameTransitionDirectiveSharedElement.decode = function(decoder) {
    ...
    val.config =
        decoder.decodeStructPointer(CompositorFrameTransitionDirectiveConfig);
    return val;
  };
  ...
  CompositorFrameTransitionDirectiveSharedElement.encode = function(encoder, val) {
    ...
    encoder.encodeStructPointer(CompositorFrameTransitionDirectiveConfig, val.config);
  };
  ...
  CompositorFrameTransitionDirective.validate = function(messageValidator, offset) {
    ...
    // validate CompositorFrameTransitionDirective.rootConfig
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 16, CompositorFrameTransitionDirectiveConfig, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  CompositorFrameTransitionDirective.encodedSize = codec.kStructHeaderSize + 32;
  ...
  CompositorFrameTransitionDirective.decode = function(decoder) {
    ...
    val.effect =
        decoder.decodeStruct(new codec.Enum(CompositorFrameTransitionDirectiveEffect));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  CompositorFrameTransitionDirective.encode = function(encoder, val) {
    ...
    encoder.skip(1);
    encoder.skip(1);
    encoder.encodeStructPointer(CompositorFrameTransitionDirectiveConfig, val.rootConfig);
  ...
  exports.CompositorFrameTransitionDirectiveConfig = CompositorFrameTransitionDirectiveConfig;
