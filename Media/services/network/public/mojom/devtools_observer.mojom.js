...
(function() {
  ...
  URLResponseHeadDevToolsInfo.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 64, fetch_api$.FetchResponseSource);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  DevToolsObserver_OnRawRequest_Params.encodedSize = codec.kStructHeaderSize + 40;
  ...
  var kDevToolsObserver_OnRawRequest_Name = 460524508;
  var kDevToolsObserver_OnRawResponse_Name = 2060283105;
  var kDevToolsObserver_OnPrivateNetworkRequest_Name = 1034902593;
  var kDevToolsObserver_OnCorsPreflightRequest_Name = 1828282001;
  var kDevToolsObserver_OnCorsPreflightResponse_Name = 1544825452;
  var kDevToolsObserver_OnCorsPreflightRequestCompleted_Name = 2059674476;
  var kDevToolsObserver_OnTrustTokenOperationDone_Name = 1352679909;
  var kDevToolsObserver_OnCorsError_Name = 251514639;
  var kDevToolsObserver_OnSubresourceWebBundleMetadata_Name = 2052343763;
  var kDevToolsObserver_OnSubresourceWebBundleMetadataError_Name = 426213766;
  var kDevToolsObserver_OnSubresourceWebBundleInnerResponse_Name = 1037137712;
  var kDevToolsObserver_OnSubresourceWebBundleInnerResponseError_Name = 1006235089;
  var kDevToolsObserver_Clone_Name = 361008218;
  ...
  DevToolsObserverProxy.prototype.onRawRequest = function(devtoolRequestId, cookiesWithAccessResult, headers, timestamp, clientSecurityState) {
  ...
  DevToolsObserverProxy.prototype.onRawResponse = function(devtoolRequestId, cookiesWithAccessResult, headers, rawResponseHeaders, resourceAddressSpace, httpStatusCode) {
  ...
  DevToolsObserverStub.prototype.onRawRequest = function(devtoolRequestId, cookiesWithAccessResult, headers, timestamp, clientSecurityState) {
    return this.delegate_ && this.delegate_.onRawRequest && this.delegate_.onRawRequest(devtoolRequestId, cookiesWithAccessResult, headers, timestamp, clientSecurityState);
  }
  DevToolsObserverStub.prototype.onRawResponse = function(devtoolRequestId, cookiesWithAccessResult, headers, rawResponseHeaders, resourceAddressSpace, httpStatusCode) {
    return this.delegate_ && this.delegate_.onRawResponse && this.delegate_.onRawResponse(devtoolRequestId, cookiesWithAccessResult, headers, rawResponseHeaders, resourceAddressSpace, httpStatusCode);
  }
  ...
  DevToolsObserverStub.prototype.accept = function(message) {
    ...
    case kDevToolsObserver_OnRawRequest_Name:
      ...
      this.onRawRequest(params.devtoolRequestId, params.cookiesWithAccessResult, params.headers, params.timestamp, params.clientSecurityState);
      return true;
    case kDevToolsObserver_OnRawResponse_Name:
      var params = reader.decodeStruct(DevToolsObserver_OnRawResponse_Params);
      this.onRawResponse(params.devtoolRequestId, params.cookiesWithAccessResult, params.headers, params.rawResponseHeaders, params.resourceAddressSpace, params.httpStatusCode);
      return true;
