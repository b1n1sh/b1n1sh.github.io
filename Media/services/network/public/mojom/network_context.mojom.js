...
(function() {
  ...
  var reporting_report$ =
      mojo.internal.exposeNamespace('network.mojom');
  if (mojo.config.autoLoadMojomDeps) {
    mojo.internal.loadMojomIfNecessary(
        'services/network/public/mojom/reporting_report.mojom', 'reporting_report.mojom.js');
  }
  ...
  TrustTokenRedemptionPolicy.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  NetworkContextFilePaths.validate = function(messageValidator, offset) {
    ...
    // validate NetworkContextFilePaths.dataPath
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 32, file_path$.FilePath, true);
    if (err !== validator.validationError.NONE)
        return err;


    // validate NetworkContextFilePaths.transportSecurityPersisterFileName
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 40, file_path$.FilePath, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkContextFilePaths.encodedSize = codec.kStructHeaderSize + 64;
  ...
  NetworkContextFilePaths.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    encoder.encodeStructPointer(file_path$.FilePath, val.dataPath);
  ...
  NetworkContextParams.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 48, ssl_config$.SSLConfig, true);
    if (err !== validator.validationError.NONE)
        return err;


    // validate NetworkContextParams.sslConfigClientReceiver
    err = messageValidator.validateInterfaceRequest(offset + codec.kStructHeaderSize + 56, true)
    if (err !== validator.validationError.NONE)
        return err;


    // validate NetworkContextParams.initialProxyConfig
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 64, proxy_config_with_annotation$.ProxyConfigWithAnnotation, true);
    if (err !== validator.validationError.NONE)
        return err;


    // validate NetworkContextParams.proxyConfigClientReceiver
    err = messageValidator.validateInterfaceRequest(offset + codec.kStructHeaderSize + 60, true)
    if (err !== validator.validationError.NONE)
        return err;


    // validate NetworkContextParams.initialCustomProxyConfig
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 72, CustomProxyConfig, true);
    if (err !== validator.validationError.NONE)
        return err;


    // validate NetworkContextParams.customProxyConfigClientReceiver
    err = messageValidator.validateInterfaceRequest(offset + codec.kStructHeaderSize + 80, true)
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkContextParams.encodedSize = codec.kStructHeaderSize + 192;
  ...
  NetworkContextParams.decode = function(decoder) {
    ...
    val.disableIdleSocketsCloseOnMemoryPressure = (packed >> 7) & 1 ? true : false;
    packed = decoder.readUint8();
    val.pacQuickCheckEnabled = (packed >> 0) & 1 ? true : false;
    val.enableCertificateReporting = (packed >> 1) & 1 ? true : false;
    val.enforceChromeCtPolicy = (packed >> 2) & 1 ? true : false;
    val.enableExpectCtReporting = (packed >> 3) & 1 ? true : false;
    val.enableSctAuditing = (packed >> 4) & 1 ? true : false;
    ...
    val.splitAuthCacheByNetworkIsolationKey = (packed >> 2) & 1 ? true : false;
    val.requireNetworkIsolationKey = (packed >> 3) & 1 ? true : false;
    decoder.skip(1);
  ...
  NetworkContextParams.encode = function(encoder, val) {
    ...
    packed |= (val.disableIdleSocketsCloseOnMemoryPressure & 1) << 7
    encoder.writeUint8(packed);
    packed = 0;
    packed |= (val.pacQuickCheckEnabled & 1) << 0
    packed |= (val.enableCertificateReporting & 1) << 1
    packed |= (val.enforceChromeCtPolicy & 1) << 2
    packed |= (val.enableExpectCtReporting & 1) << 3
    packed |= (val.enableSctAuditing & 1) << 4
    ...
    packed |= (val.splitAuthCacheByNetworkIsolationKey & 1) << 2
    packed |= (val.requireNetworkIsolationKey & 1) << 3
    encoder.writeUint8(packed);
    encoder.skip(1);
  ...
  URLLoaderFactoryParams.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 88, TrustTokenRedemptionPolicy);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  URLLoaderFactoryParams.encodedSize = codec.kStructHeaderSize + 104;
  ...
  URLLoaderFactoryParams.decode = function(decoder) {
    ...
    val.trustTokenRedemptionPolicy =
        decoder.decodeStruct(new codec.Enum(TrustTokenRedemptionPolicy));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  NetworkContext_CreateWebTransport_Params.validate = function(messageValidator, offset) {
    ...
    // validate NetworkContext_CreateWebTransport_Params.networkIsolationKey
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 16, network_isolation_key$.NetworkIsolationKey, false);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 24, 8, new codec.PointerTo(web_transport$.WebTransportCertificateFingerprint), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkContext_CreateWebTransport_Params.encodedSize = codec.kStructHeaderSize + 40;
  ...
  NetworkContext_AddReportingApiObserver_Params.prototype.initDefaults_ = function() {
    this.observer = new reporting_report$.ReportingApiObserverPtr();
  };
  ...
  NetworkContext_AddReportingApiObserver_Params.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.observer =
        decoder.decodeStruct(new codec.Interface(reporting_report$.ReportingApiObserverPtr));
    return val;
  };
  ...
  NetworkContext_AddReportingApiObserver_Params.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    encoder.encodeStruct(new codec.Interface(reporting_report$.ReportingApiObserverPtr), val.observer);
  };
  var kCustomProxyConnectionObserver_OnFallback_Name = 1711099836;
  var kCustomProxyConnectionObserver_OnTunnelHeadersReceived_Name = 257099133;
  ...
  var kCustomProxyConfigClient_OnCustomProxyConfigUpdated_Name = 857134512;
  var kCustomProxyConfigClient_MarkProxiesAsBad_Name = 1429129998;
  var kCustomProxyConfigClient_ClearBadProxiesCache_Name = 592495471;
  ...
  var kTrustedHeaderClient_OnBeforeSendHeaders_Name = 1325138475;
  var kTrustedHeaderClient_OnHeadersReceived_Name = 1994033716;
  ...
  var kTrustedURLLoaderHeaderClient_OnLoaderCreated_Name = 1134186721;
  var kTrustedURLLoaderHeaderClient_OnLoaderForCorsPreflightCreated_Name = 1879182125;
  ...
  var kNetworkContextClient_OnFileUploadRequested_Name = 534801928;
  var kNetworkContextClient_OnCanSendReportingReports_Name = 139400245;
  var kNetworkContextClient_OnCanSendDomainReliabilityUpload_Name = 784927223;
  var kNetworkContextClient_OnTrustTokenIssuanceDivertedToSystem_Name = 1520443556;
  ...
  var kNetworkContext_SetClient_Name = 136953152;
  var kNetworkContext_CreateURLLoaderFactory_Name = 195734497;
  var kNetworkContext_ResetURLLoaderFactories_Name = 2059625117;
  var kNetworkContext_GetCookieManager_Name = 1760275957;
  var kNetworkContext_GetRestrictedCookieManager_Name = 630269826;
  var kNetworkContext_GetHasTrustTokensAnswerer_Name = 1515510367;
  var kNetworkContext_ClearTrustTokenData_Name = 498969430;
  var kNetworkContext_GetStoredTrustTokenCounts_Name = 276854014;
  var kNetworkContext_DeleteStoredTrustTokens_Name = 2003800312;
  var kNetworkContext_ClearNetworkingHistoryBetween_Name = 1471770894;
  var kNetworkContext_ClearHttpCache_Name = 1090164838;
  var kNetworkContext_ComputeHttpCacheSize_Name = 286914222;
  var kNetworkContext_NotifyExternalCacheHit_Name = 14249580;
  var kNetworkContext_ClearHostCache_Name = 1412905562;
  var kNetworkContext_ClearHttpAuthCache_Name = 1659247907;
  var kNetworkContext_ClearReportingCacheReports_Name = 1468097568;
  var kNetworkContext_ClearReportingCacheClients_Name = 85352247;
  var kNetworkContext_ClearNetworkErrorLogging_Name = 2078514838;
  var kNetworkContext_ClearDomainReliability_Name = 845960443;
  var kNetworkContext_GetDomainReliabilityJSON_Name = 666198615;
  var kNetworkContext_SetDocumentReportingEndpoints_Name = 619587423;
  var kNetworkContext_SendReportsAndRemoveSource_Name = 1248084269;
  var kNetworkContext_QueueReport_Name = 1471488430;
  var kNetworkContext_QueueSignedExchangeReport_Name = 1025572394;
  var kNetworkContext_CloseAllConnections_Name = 1575073988;
  var kNetworkContext_CloseIdleConnections_Name = 406718872;
  var kNetworkContext_SetNetworkConditions_Name = 1871743053;
  var kNetworkContext_SetAcceptLanguage_Name = 460046606;
  var kNetworkContext_SetEnableReferrers_Name = 1479997878;
  var kNetworkContext_SetCTPolicy_Name = 1675034126;
  var kNetworkContext_AddExpectCT_Name = 2077668357;
  var kNetworkContext_SetExpectCTTestReport_Name = 1126552219;
  var kNetworkContext_GetExpectCTState_Name = 727043136;
  var kNetworkContext_CreateUDPSocket_Name = 806056095;
  var kNetworkContext_CreateTCPServerSocket_Name = 1799208647;
  var kNetworkContext_CreateTCPConnectedSocket_Name = 782672301;
  var kNetworkContext_CreateTCPBoundSocket_Name = 1267378888;
  var kNetworkContext_CreateProxyResolvingSocketFactory_Name = 465111968;
  var kNetworkContext_LookUpProxyForURL_Name = 2058609096;
  var kNetworkContext_ForceReloadProxyConfig_Name = 821874723;
  var kNetworkContext_ClearBadProxiesCache_Name = 1088011920;
  var kNetworkContext_CreateWebSocket_Name = 202018158;
  var kNetworkContext_CreateWebTransport_Name = 17811873;
  var kNetworkContext_CreateNetLogExporter_Name = 1282444382;
  var kNetworkContext_PreconnectSockets_Name = 236165145;
  var kNetworkContext_CreateP2PSocketManager_Name = 244619152;
  var kNetworkContext_CreateMdnsResponder_Name = 1264220550;
  var kNetworkContext_ResolveHost_Name = 810857464;
  var kNetworkContext_CreateHostResolver_Name = 1468479815;
  var kNetworkContext_VerifyCertForSignedExchange_Name = 2059795932;
  var kNetworkContext_AddHSTS_Name = 1304523657;
  var kNetworkContext_IsHSTSActiveForHost_Name = 804846675;
  var kNetworkContext_GetHSTSState_Name = 389687681;
  var kNetworkContext_SetCorsOriginAccessListsForOrigin_Name = 679635371;
  var kNetworkContext_DeleteDynamicDataForHost_Name = 664044166;
  var kNetworkContext_SetSplitAuthCacheByNetworkIsolationKey_Name = 1880345434;
  var kNetworkContext_SaveHttpAuthCacheProxyEntries_Name = 1547002524;
  var kNetworkContext_LoadHttpAuthCacheProxyEntries_Name = 485715185;
  var kNetworkContext_AddAuthCacheEntry_Name = 1340784459;
  var kNetworkContext_LookupServerBasicAuthCredentials_Name = 1432534665;
  var kNetworkContext_EnableStaticKeyPinningForTesting_Name = 754172536;
  var kNetworkContext_VerifyCertificateForTesting_Name = 1493004432;
  var kNetworkContext_AddDomainReliabilityContextForTesting_Name = 1334909346;
  var kNetworkContext_ForceDomainReliabilityUploadsForTesting_Name = 932552369;
  var kNetworkContext_GetOriginPolicyManager_Name = 436524092;
  var kNetworkContext_SetSCTAuditingEnabled_Name = 736432318;
  var kNetworkContext_AddReportingApiObserver_Name = 655248352;
  ...
  NetworkContextProxy.prototype.queueReport = function(type, group, url, reportingSource, networkIsolationKey, userAgent, body) {
  ...
  NetworkContextProxy.prototype.createWebTransport = function(url, origin, networkIsolationKey, fingerprints, handshakeClient) {
  ...
  NetworkContextStub.prototype.queueReport = function(type, group, url, reportingSource, networkIsolationKey, userAgent, body) {
    return this.delegate_ && this.delegate_.queueReport && this.delegate_.queueReport(type, group, url, reportingSource, networkIsolationKey, userAgent, body);
  }
  ...
  NetworkContextStub.prototype.createWebTransport = function(url, origin, networkIsolationKey, fingerprints, handshakeClient) {
    return this.delegate_ && this.delegate_.createWebTransport && this.delegate_.createWebTransport(url, origin, networkIsolationKey, fingerprints, handshakeClient);
  }
  ...
  NetworkContextStub.prototype.accept = function(message) {
    ...
    case kNetworkContext_QueueReport_Name:
      ...
      this.queueReport(params.type, params.group, params.url, params.reportingSource, params.networkIsolationKey, params.userAgent, params.body);
      return true;
    ...
    case kNetworkContext_CreateWebTransport_Name:
      ...
      this.createWebTransport(params.url, params.origin, params.networkIsolationKey, params.fingerprints, params.handshakeClient);
      return true;
