...
(function() {
  ...
  function NetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  NetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_Params.prototype.initDefaults_ = function() {
    this.persistedSets = null;
  };
  NetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  NetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate NetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_Params.persistedSets
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 0, false)
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_Params.encodedSize = codec.kStructHeaderSize + 8;

  NetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_Params.decode = function(decoder) {
    var packed;
    var val = new NetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.persistedSets =
        decoder.decodeStruct(codec.String);
  ...
  NetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(NetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_Params.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.String, val.persistedSets);
  };
  function NetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_ResponseParams(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  NetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_ResponseParams.prototype.initDefaults_ = function() {
    this.upToDateSets = null;
  };
  NetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_ResponseParams.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  NetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate NetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_ResponseParams.upToDateSets
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 0, false)
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_ResponseParams.encodedSize = codec.kStructHeaderSize + 8;

  NetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_ResponseParams.decode = function(decoder) {
    var packed;
    var val = new NetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_ResponseParams();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.upToDateSets =
        decoder.decodeStruct(codec.String);
  ...
  NetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_ResponseParams.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(NetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_ResponseParams.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.String, val.upToDateSets);
  };
  ...
  var kNetworkService_SetParams_Name = 632180652;
  var kNetworkService_StartNetLog_Name = 688598926;
  var kNetworkService_AttachNetLogProxy_Name = 1458916648;
  var kNetworkService_SetSSLKeyLogFile_Name = 1583039794;
  var kNetworkService_CreateNetworkContext_Name = 415493232;
  var kNetworkService_ConfigureStubHostResolver_Name = 481645950;
  var kNetworkService_DisableQuic_Name = 100586354;
  var kNetworkService_SetUpHttpAuth_Name = 1971960339;
  var kNetworkService_ConfigureHttpAuthPrefs_Name = 2120108260;
  var kNetworkService_SetRawHeadersAccess_Name = 359209151;
  var kNetworkService_SetMaxConnectionsPerProxy_Name = 1006585739;
  var kNetworkService_GetNetworkChangeManager_Name = 958634665;
  var kNetworkService_GetNetworkQualityEstimatorManager_Name = 35597507;
  var kNetworkService_GetDnsConfigChangeManager_Name = 420224257;
  var kNetworkService_GetNetworkList_Name = 1635598423;
  var kNetworkService_UpdateCRLSet_Name = 433841035;
  var kNetworkService_OnCertDBChanged_Name = 575914589;
  var kNetworkService_SetCryptConfig_Name = 1897168641;
  var kNetworkService_AddAllowedRequestInitiatorForPlugin_Name = 983905699;
  var kNetworkService_RemoveSecurityExceptionsForPlugin_Name = 347455908;
  var kNetworkService_OnMemoryPressure_Name = 1644499326;
  var kNetworkService_OnPeerToPeerConnectionsCountChange_Name = 1669448576;
  var kNetworkService_SetEnvironment_Name = 1078010487;
  var kNetworkService_SetTrustTokenKeyCommitments_Name = 878896141;
  var kNetworkService_ClearSCTAuditingCache_Name = 1096774170;
  var kNetworkService_ConfigureSCTAuditing_Name = 213177052;
  var kNetworkService_UpdateCtLogList_Name = 1371660839;
  var kNetworkService_SetCtEnforcementEnabled_Name = 640526740;
  var kNetworkService_BindTestInterface_Name = 1644257048;
  var kNetworkService_SetFirstPartySets_Name = 1629859738;
  var kNetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_Name = 652669252;
  var kNetworkService_SetExplicitlyAllowedPorts_Name = 1060856123;
  var kNetworkService_ParseHeaders_Name = 1318029359;
  ...
  NetworkServicePtr.prototype.setPersistedFirstPartySetsAndGetCurrentSets = function() {
    return NetworkServiceProxy.prototype.setPersistedFirstPartySetsAndGetCurrentSets
        .apply(this.ptr.getProxy(), arguments);
  };

  NetworkServiceProxy.prototype.setPersistedFirstPartySetsAndGetCurrentSets = function(persistedSets) {
    var params_ = new NetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_Params();
    params_.persistedSets = persistedSets;
    return new Promise(function(resolve, reject) {
      var builder = new codec.MessageV1Builder(
          kNetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_Name,
          codec.align(NetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_Params.encodedSize),
          codec.kMessageExpectsResponse, 0);
      builder.encodeStruct(NetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_Params, params_);
      var message = builder.finish();
      this.receiver_.acceptAndExpectResponse(message).then(function(message) {
        var reader = new codec.MessageReader(message);
        var responseParams =
            reader.decodeStruct(NetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_ResponseParams);
        resolve(responseParams);
      }).catch(function(result) {
        reject(Error("Connection error: " + result));
      });
  ...
  NetworkServiceStub.prototype.setPersistedFirstPartySetsAndGetCurrentSets = function(persistedSets) {
    return this.delegate_ && this.delegate_.setPersistedFirstPartySetsAndGetCurrentSets && this.delegate_.setPersistedFirstPartySetsAndGetCurrentSets(persistedSets);
  }
  ...
  NetworkServiceStub.prototype.accept = function(message) {
    ...
    case kNetworkService_UpdateCtLogList_Name:
      ...
      this.updateCtLogList(params.logList, params.updateTime);
      return true;
  ...
  NetworkServiceStub.prototype.acceptWithResponder =
    ...
    case kNetworkService_SetTrustTokenKeyCommitments_Name:
      ...
      return true;
    case kNetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_Name:
      var params = reader.decodeStruct(NetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_Params);
      this.setPersistedFirstPartySetsAndGetCurrentSets(params.persistedSets).then(function(response) {
        var responseParams =
            new NetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_ResponseParams();
        responseParams.upToDateSets = response.upToDateSets;
        var builder = new codec.MessageV1Builder(
            kNetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_Name,
            codec.align(NetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_ResponseParams.encodedSize),
            codec.kMessageIsResponse, reader.requestID);
        builder.encodeStruct(NetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_ResponseParams,
                             responseParams);
        var message = builder.finish();
        responder.accept(message);
      });
  ...
  function validateNetworkServiceRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kNetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_Name:
        if (message.expectsResponse())
          paramsClass = NetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_Params;
      break;
      case kNetworkService_SetExplicitlyAllowedPorts_Name:
        if (!message.expectsResponse() && !message.isResponse())
  ...
  function validateNetworkServiceResponse(messageValidator) {
   ...
   switch (message.getName()) {
      ...
      case kNetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_Name:
        if (message.isResponse())
          paramsClass = NetworkService_SetPersistedFirstPartySetsAndGetCurrentSets_ResponseParams;
        break;
      case kNetworkService_ParseHeaders_Name:
        if (message.isResponse())
