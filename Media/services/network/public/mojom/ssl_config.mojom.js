...
(function() {
  ...
  SSLVersion.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  SSLConfig.decode = function(decoder) {
    ...
    val.cecpq2Enabled = (packed >> 4) & 1 ? true : false;
    val.tripleDesEnabled = (packed >> 5) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    val.versionMin =
        decoder.decodeStruct(new codec.Enum(SSLVersion));
    val.versionMinWarn =
        decoder.decodeStruct(new codec.Enum(SSLVersion));
    val.versionMax =
        decoder.decodeStruct(new codec.Enum(SSLVersion));
  ...
  SSLConfig.encode = function(encoder, val) {
    ...
    packed |= (val.cecpq2Enabled & 1) << 4
    packed |= (val.tripleDesEnabled & 1) << 5
  ...
  var kSSLConfigClient_OnSSLConfigUpdated_Name = 588101433;
