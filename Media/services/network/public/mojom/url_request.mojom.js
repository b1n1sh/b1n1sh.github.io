...
(function() {
  ...
  URLRequest.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 80, request_priority$.RequestPriority);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 200, NetLogSource, true);
    if (err !== validator.validationError.NONE)
        return err;


    // validate URLRequest.netLogReferenceInfo
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 208, NetLogSource, true);
    if (err !== validator.validationError.NONE)
        return err;


    // validate URLRequest.targetIpAddressSpace
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 216, ip_address_space$.IPAddressSpace);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  URLRequest.encodedSize = codec.kStructHeaderSize + 224;
  ...
  URLRequest.decode = function(decoder) {
    ...
    val.upgradeIfInsecure = (packed >> 4) & 1 ? true : false;
    val.isRevalidating = (packed >> 5) & 1 ? true : false;
    val.isSignedExchangePrefetchCacheEnabled = (packed >> 6) & 1 ? true : false;
    val.isFetchLikeApi = (packed >> 7) & 1 ? true : false;
    packed = decoder.readUint8();
    val.isFavicon = (packed >> 0) & 1 ? true : false;
    val.obeyOriginPolicy = (packed >> 1) & 1 ? true : false;
    decoder.skip(1);
    val.referrerPolicy =
    ...
    val.netLogCreateInfo =
        decoder.decodeStructPointer(NetLogSource);
  ...
  URLRequest.encode = function(encoder, val) {
    ...
    packed |= (val.upgradeIfInsecure & 1) << 4
    packed |= (val.isRevalidating & 1) << 5
    packed |= (val.isSignedExchangePrefetchCacheEnabled & 1) << 6
    packed |= (val.isFetchLikeApi & 1) << 7
    encoder.writeUint8(packed);
    packed = 0;
    packed |= (val.isFavicon & 1) << 0
    packed |= (val.obeyOriginPolicy & 1) << 1
    encoder.writeUint8(packed);
    encoder.skip(1);
    ...
    encoder.encodeStructPointer(NetLogSource, val.netLogCreateInfo);
    encoder.encodeStructPointer(NetLogSource, val.netLogReferenceInfo);
