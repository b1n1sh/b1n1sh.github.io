...
(function() {
  ...
  P2PSocketType.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  P2PSocketOption.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  P2PSocketManager_CreateSocket_Params.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.type =
        decoder.decodeStruct(new codec.Enum(P2PSocketType));
    val.socket =
  ...
  P2PSocket_SetOption_Params.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.option =
        decoder.decodeStruct(new codec.Enum(P2PSocketOption));
    val.value =
  ...
  var kP2PNetworkNotificationClient_NetworkListChanged_Name = 1497815143;
  ...
  var kP2PSocketManager_StartNetworkNotifications_Name = 1290340312;
  var kP2PSocketManager_GetHostAddress_Name = 1686343466;
  var kP2PSocketManager_CreateSocket_Name = 222598494;
  ...
  var kP2PSocket_Send_Name = 929348305;
  var kP2PSocket_SetOption_Name = 1679962580;
  ...
  var kP2PSocketClient_SocketCreated_Name = 122804772;
  var kP2PSocketClient_SendComplete_Name = 1908940713;
  var kP2PSocketClient_IncomingTcpConnection_Name = 592604607;
  var kP2PSocketClient_DataReceived_Name = 1240310557;
