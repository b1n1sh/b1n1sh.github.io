...
(function() {
  ...
  CookieSameSiteContextMetadata.encodedSize = codec.kStructHeaderSize + 8;
  ...
  CookieOptions.validate = function(messageValidator, offset) {
    ...
    // validate CookieOptions.samePartyContext
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 16, SamePartyContext, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  CookieOptions.encode = function(encoder, val) {
    ...
    encoder.encodeStructPointer(SamePartyContext, val.samePartyContext);
  };
  ...
  CookiePartitionKey.encodedSize = codec.kStructHeaderSize + 8;
  ...
  function CookiePartitionKeychain(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  CookiePartitionKeychain.prototype.initDefaults_ = function() {
    this.containsAllPartitions = false;
    this.keys = null;
  };
  CookiePartitionKeychain.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  CookiePartitionKeychain.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate CookiePartitionKeychain.keys
  ...
  CookiePartitionKeychain.encodedSize = codec.kStructHeaderSize + 16;

  CookiePartitionKeychain.decode = function(decoder) {
    var packed;
    var val = new CookiePartitionKeychain();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    packed = decoder.readUint8();
  ...
  CookiePartitionKeychain.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(CookiePartitionKeychain.encodedSize);
    encoder.writeUint32(0);
    packed = 0;
  ...
  CanonicalCookie.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 72, CookiePartitionKey, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  CanonicalCookie.encodedSize = codec.kStructHeaderSize + 88;
  ...
  CanonicalCookie.decode = function(decoder) {
    ...
    val.partitionKey =
        decoder.decodeStructPointer(CookiePartitionKey);
    val.sourcePort =
  ...
  CanonicalCookie.encode = function(encoder, val) {
    ...
    encoder.encodeStructPointer(CookiePartitionKey, val.partitionKey);
  ...
  SamePartyContext.prototype.initDefaults_ = function() {
    ...
    this.ancestorsForMetricsOnly = SamePartyCookieContextType.kCrossParty;
    this.topResourceForMetricsOnly = SamePartyCookieContextType.kCrossParty;
  };
  ...
  SamePartyContext.validate = function(messageValidator, offset) {
    ...
    // validate SamePartyContext.ancestorsForMetricsOnly
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 4, SamePartyCookieContextType);
    if (err !== validator.validationError.NONE)
        return err;


    // validate SamePartyContext.topResourceForMetricsOnly
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 8, SamePartyCookieContextType);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  SamePartyContext.encodedSize = codec.kStructHeaderSize + 16;
  ...
  SamePartyContext.decode = function(decoder) {
    ...
    val.ancestorsForMetricsOnly =
        decoder.decodeStruct(new codec.Enum(SamePartyCookieContextType));
    val.topResourceForMetricsOnly =
        decoder.decodeStruct(new codec.Enum(SamePartyCookieContextType));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  SamePartyContext.encode = function(encoder, val) {
    ...
    encoder.encodeStruct(codec.Int32, val.ancestorsForMetricsOnly);
    encoder.encodeStruct(codec.Int32, val.topResourceForMetricsOnly);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
  ...
  CookieManager_GetCookieList_Params.prototype.initDefaults_ = function() {
    ...
    this.cookiePartitionKeychain = null;
  };
  ...
  CookieManager_GetCookieList_Params.validate = function(messageValidator, offset) {
    ...
    // validate CookieManager_GetCookieList_Params.cookiePartitionKeychain
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 16, CookiePartitionKeychain, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  CookieManager_GetCookieList_Params.decode = function(decoder) {
    ...
    val.cookiePartitionKeychain =
        decoder.decodeStructPointer(CookiePartitionKeychain);
    return val;
  };
  ...
  CookieManager_GetCookieList_Params.encode = function(encoder, val) {
    ...
    encoder.encodeStructPointer(CookiePartitionKeychain, val.cookiePartitionKeychain);
  };
  ...
  var kCookieChangeListener_OnCookieChange_Name = 1903163954;
  ...
  var kCookieManager_GetAllCookies_Name = 323481877;
  var kCookieManager_GetAllCookiesWithAccessSemantics_Name = 516554986;
  var kCookieManager_GetCookieList_Name = 1137532568;
  var kCookieManager_SetCanonicalCookie_Name = 771713912;
  var kCookieManager_DeleteCanonicalCookie_Name = 2036586179;
  var kCookieManager_DeleteCookies_Name = 1851989523;
  var kCookieManager_DeleteSessionOnlyCookies_Name = 1462337379;
  var kCookieManager_AddCookieChangeListener_Name = 1806593311;
  var kCookieManager_AddGlobalChangeListener_Name = 257454478;
  var kCookieManager_CloneInterface_Name = 1481189807;
  var kCookieManager_FlushCookieStore_Name = 186440197;
  var kCookieManager_AllowFileSchemeCookies_Name = 591145582;
  var kCookieManager_SetContentSettings_Name = 480990832;
  var kCookieManager_SetForceKeepSessionState_Name = 74724367;
  var kCookieManager_BlockThirdPartyCookies_Name = 309576561;
  var kCookieManager_SetContentSettingsForLegacyCookieAccess_Name = 539706518;
  var kCookieManager_SetStorageAccessGrantSettings_Name = 1398176721;
  ...
  CookieManagerProxy.prototype.getCookieList = function(url, cookieOptions, cookiePartitionKeychain) {
    var params_ = new CookieManager_GetCookieList_Params();
    params_.url = url;
    params_.cookieOptions = cookieOptions;
    params_.cookiePartitionKeychain = cookiePartitionKeychain;
    return new Promise(function(resolve, reject) {
      var builder = new codec.MessageV1Builder(
  ...
  CookieManagerStub.prototype.getCookieList = function(url, cookieOptions, cookiePartitionKeychain) {
    return this.delegate_ && this.delegate_.getCookieList && this.delegate_.getCookieList(url, cookieOptions, cookiePartitionKeychain);
  }
  ...
  CookieManagerStub.prototype.acceptWithResponder =
    ...
    case kCookieManager_GetCookieList_Name:
      ...
      this.getCookieList(params.url, params.cookieOptions, params.cookiePartitionKeychain).then(function(response) {
        var responseParams =
  ...
  exports.CookiePartitionKeychain = CookiePartitionKeychain;
