...
(function() {
  ...
  var kWebTransport_SendDatagram_Name = 9198814;
  var kWebTransport_CreateStream_Name = 491749646;
  var kWebTransport_AcceptBidirectionalStream_Name = 812566556;
  var kWebTransport_AcceptUnidirectionalStream_Name = 1575173537;
  var kWebTransport_SendFin_Name = 1477928351;
  var kWebTransport_AbortStream_Name = 1953854925;
  var kWebTransport_StopSending_Name = 436916235;
  var kWebTransport_SetOutgoingDatagramExpirationDuration_Name = 41142863;
  var kWebTransport_Close_Name = 792737720;
  ...
  var kWebTransportClient_OnDatagramReceived_Name = 289454906;
  var kWebTransportClient_OnIncomingStreamClosed_Name = 1241273715;
  var kWebTransportClient_OnOutgoingStreamClosed_Name = 23837517;
  var kWebTransportClient_OnReceivedStopSending_Name = 1427223817;
  var kWebTransportClient_OnReceivedResetStream_Name = 2054582422;
  var kWebTransportClient_OnClosed_Name = 1195439257;
  ...
  WebTransportClientProxy.prototype.onReceivedStopSending = function(streamId, code) {
  ...
  WebTransportClientProxy.prototype.onReceivedResetStream = function(streamId, code) {
  ...
  WebTransportClientStub.prototype.onReceivedStopSending = function(streamId, code) {
    return this.delegate_ && this.delegate_.onReceivedStopSending && this.delegate_.onReceivedStopSending(streamId, code);
  }
  WebTransportClientStub.prototype.onReceivedResetStream = function(streamId, code) {
    return this.delegate_ && this.delegate_.onReceivedResetStream && this.delegate_.onReceivedResetStream(streamId, code);
  }
  ...
  WebTransportClientStub.prototype.accept = function(message) {
    ...
    case kWebTransportClient_OnReceivedStopSending_Name:
      ...
      this.onReceivedStopSending(params.streamId, params.code);
      return true;
    case kWebTransportClient_OnReceivedResetStream_Name:
      ...
      this.onReceivedResetStream(params.streamId, params.code);
      return true;
  ...
  var kWebTransportHandshakeClient_OnConnectionEstablished_Name = 729576155;
  var kWebTransportHandshakeClient_OnHandshakeFailed_Name = 1057860573;
