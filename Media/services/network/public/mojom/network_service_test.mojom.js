...
(function() {
  ...
  ResolverType.kResolverTypeFailHTTPSServiceFormRecord = 2;
  ResolverType.kResolverTypeSystem = 3;
  ResolverType.kResolverTypeIPLiteral = 4;
  ResolverType.kResolverTypeDirectLookup = 5;
  ResolverType.MIN_VALUE = 0;
  ResolverType.MAX_VALUE = 5;
  ...
  function NetworkServiceTest_GetSCTAuditingPendingReportsCount_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  NetworkServiceTest_GetSCTAuditingPendingReportsCount_Params.prototype.initDefaults_ = function() {
  };
  NetworkServiceTest_GetSCTAuditingPendingReportsCount_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  NetworkServiceTest_GetSCTAuditingPendingReportsCount_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkServiceTest_GetSCTAuditingPendingReportsCount_Params.encodedSize = codec.kStructHeaderSize + 0;

  NetworkServiceTest_GetSCTAuditingPendingReportsCount_Params.decode = function(decoder) {
    var packed;
    var val = new NetworkServiceTest_GetSCTAuditingPendingReportsCount_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    return val;
  };

  NetworkServiceTest_GetSCTAuditingPendingReportsCount_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(NetworkServiceTest_GetSCTAuditingPendingReportsCount_Params.encodedSize);
    encoder.writeUint32(0);
  };
  function NetworkServiceTest_GetSCTAuditingPendingReportsCount_ResponseParams(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  NetworkServiceTest_GetSCTAuditingPendingReportsCount_ResponseParams.prototype.initDefaults_ = function() {
    this.reports = 0;
  };
  NetworkServiceTest_GetSCTAuditingPendingReportsCount_ResponseParams.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  NetworkServiceTest_GetSCTAuditingPendingReportsCount_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkServiceTest_GetSCTAuditingPendingReportsCount_ResponseParams.encodedSize = codec.kStructHeaderSize + 8;

  NetworkServiceTest_GetSCTAuditingPendingReportsCount_ResponseParams.decode = function(decoder) {
    var packed;
    var val = new NetworkServiceTest_GetSCTAuditingPendingReportsCount_ResponseParams();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.reports =
  ...
  NetworkServiceTest_GetSCTAuditingPendingReportsCount_ResponseParams.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(NetworkServiceTest_GetSCTAuditingPendingReportsCount_ResponseParams.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.Uint64, val.reports);
  };
  function NetworkServiceTest_SetSCTAuditingReportCompletionCallback_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  NetworkServiceTest_SetSCTAuditingReportCompletionCallback_Params.prototype.initDefaults_ = function() {
  };
  NetworkServiceTest_SetSCTAuditingReportCompletionCallback_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  NetworkServiceTest_SetSCTAuditingReportCompletionCallback_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkServiceTest_SetSCTAuditingReportCompletionCallback_Params.encodedSize = codec.kStructHeaderSize + 0;

  NetworkServiceTest_SetSCTAuditingReportCompletionCallback_Params.decode = function(decoder) {
    var packed;
    var val = new NetworkServiceTest_SetSCTAuditingReportCompletionCallback_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    return val;
  };

  NetworkServiceTest_SetSCTAuditingReportCompletionCallback_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(NetworkServiceTest_SetSCTAuditingReportCompletionCallback_Params.encodedSize);
    encoder.writeUint32(0);
  };
  function NetworkServiceTest_SetSCTAuditingReportCompletionCallback_ResponseParams(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  NetworkServiceTest_SetSCTAuditingReportCompletionCallback_ResponseParams.prototype.initDefaults_ = function() {
  };
  NetworkServiceTest_SetSCTAuditingReportCompletionCallback_ResponseParams.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  NetworkServiceTest_SetSCTAuditingReportCompletionCallback_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkServiceTest_SetSCTAuditingReportCompletionCallback_ResponseParams.encodedSize = codec.kStructHeaderSize + 0;

  NetworkServiceTest_SetSCTAuditingReportCompletionCallback_ResponseParams.decode = function(decoder) {
    var packed;
    var val = new NetworkServiceTest_SetSCTAuditingReportCompletionCallback_ResponseParams();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    return val;
  };

  NetworkServiceTest_SetSCTAuditingReportCompletionCallback_ResponseParams.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(NetworkServiceTest_SetSCTAuditingReportCompletionCallback_ResponseParams.encodedSize);
    encoder.writeUint32(0);
  };
  var kNetworkServiceTest_AddRules_Name = 1899972559;
  var kNetworkServiceTest_SimulateNetworkChange_Name = 1386230023;
  var kNetworkServiceTest_SimulateNetworkQualityChange_Name = 841737190;
  var kNetworkServiceTest_SimulateCrash_Name = 268119823;
  var kNetworkServiceTest_MockCertVerifierSetDefaultResult_Name = 964382856;
  var kNetworkServiceTest_MockCertVerifierAddResultForCertAndHost_Name = 1297418651;
  var kNetworkServiceTest_SetRequireCT_Name = 765029750;
  var kNetworkServiceTest_SetTransportSecurityStateSource_Name = 1996981295;
  var kNetworkServiceTest_SetAllowNetworkAccessToHostResolutions_Name = 851169387;
  var kNetworkServiceTest_CrashOnResolveHost_Name = 1369604166;
  var kNetworkServiceTest_CrashOnGetCookieList_Name = 2143821513;
  var kNetworkServiceTest_GetLatestMemoryPressureLevel_Name = 2016069539;
  var kNetworkServiceTest_GetPeerToPeerConnectionsCountChange_Name = 191671671;
  var kNetworkServiceTest_GetEnvironmentVariableValue_Name = 1848968251;
  var kNetworkServiceTest_Log_Name = 694618725;
  var kNetworkServiceTest_ActivateFieldTrial_Name = 1589940406;
  var kNetworkServiceTest_GetFirstPartySetEntriesCount_Name = 535865852;
  var kNetworkServiceTest_SetSCTAuditingRetryDelay_Name = 728194240;
  var kNetworkServiceTest_GetSCTAuditingPendingReportsCount_Name = 616144640;
  var kNetworkServiceTest_SetSCTAuditingReportCompletionCallback_Name = 394649617;
  ...
  NetworkServiceTestPtr.prototype.getSCTAuditingPendingReportsCount = function() {
    return NetworkServiceTestProxy.prototype.getSCTAuditingPendingReportsCount
        .apply(this.ptr.getProxy(), arguments);
  };

  NetworkServiceTestProxy.prototype.getSCTAuditingPendingReportsCount = function() {
    var params_ = new NetworkServiceTest_GetSCTAuditingPendingReportsCount_Params();
    return new Promise(function(resolve, reject) {
      var builder = new codec.MessageV1Builder(
          kNetworkServiceTest_GetSCTAuditingPendingReportsCount_Name,
          codec.align(NetworkServiceTest_GetSCTAuditingPendingReportsCount_Params.encodedSize),
          codec.kMessageExpectsResponse, 0);
      builder.encodeStruct(NetworkServiceTest_GetSCTAuditingPendingReportsCount_Params, params_);
      var message = builder.finish();
      this.receiver_.acceptAndExpectResponse(message).then(function(message) {
        var reader = new codec.MessageReader(message);
        var responseParams =
            reader.decodeStruct(NetworkServiceTest_GetSCTAuditingPendingReportsCount_ResponseParams);
        resolve(responseParams);
      }).catch(function(result) {
        reject(Error("Connection error: " + result));
      });
  ...
  NetworkServiceTestPtr.prototype.setSCTAuditingReportCompletionCallback = function() {
    return NetworkServiceTestProxy.prototype.setSCTAuditingReportCompletionCallback
        .apply(this.ptr.getProxy(), arguments);
  };

  NetworkServiceTestProxy.prototype.setSCTAuditingReportCompletionCallback = function() {
    var params_ = new NetworkServiceTest_SetSCTAuditingReportCompletionCallback_Params();
    return new Promise(function(resolve, reject) {
      var builder = new codec.MessageV1Builder(
          kNetworkServiceTest_SetSCTAuditingReportCompletionCallback_Name,
          codec.align(NetworkServiceTest_SetSCTAuditingReportCompletionCallback_Params.encodedSize),
          codec.kMessageExpectsResponse, 0);
      builder.encodeStruct(NetworkServiceTest_SetSCTAuditingReportCompletionCallback_Params, params_);
      var message = builder.finish();
      this.receiver_.acceptAndExpectResponse(message).then(function(message) {
        var reader = new codec.MessageReader(message);
        var responseParams =
            reader.decodeStruct(NetworkServiceTest_SetSCTAuditingReportCompletionCallback_ResponseParams);
        resolve(responseParams);
      }).catch(function(result) {
        reject(Error("Connection error: " + result));
      });
  ...
  NetworkServiceTestStub.prototype.getSCTAuditingPendingReportsCount = function() {
    return this.delegate_ && this.delegate_.getSCTAuditingPendingReportsCount && this.delegate_.getSCTAuditingPendingReportsCount();
  }
  NetworkServiceTestStub.prototype.setSCTAuditingReportCompletionCallback = function() {
    return this.delegate_ && this.delegate_.setSCTAuditingReportCompletionCallback && this.delegate_.setSCTAuditingReportCompletionCallback();
  }
  ...
  NetworkServiceTestStub.prototype.acceptWithResponder =
    ...
    case kNetworkServiceTest_SetSCTAuditingRetryDelay_Name:
      ...
      return true;
    case kNetworkServiceTest_GetSCTAuditingPendingReportsCount_Name:
      var params = reader.decodeStruct(NetworkServiceTest_GetSCTAuditingPendingReportsCount_Params);
      this.getSCTAuditingPendingReportsCount().then(function(response) {
        var responseParams =
            new NetworkServiceTest_GetSCTAuditingPendingReportsCount_ResponseParams();
        responseParams.reports = response.reports;
        var builder = new codec.MessageV1Builder(
            kNetworkServiceTest_GetSCTAuditingPendingReportsCount_Name,
            codec.align(NetworkServiceTest_GetSCTAuditingPendingReportsCount_ResponseParams.encodedSize),
            codec.kMessageIsResponse, reader.requestID);
        builder.encodeStruct(NetworkServiceTest_GetSCTAuditingPendingReportsCount_ResponseParams,
                             responseParams);
        var message = builder.finish();
        responder.accept(message);
      });
      return true;
    case kNetworkServiceTest_SetSCTAuditingReportCompletionCallback_Name:
      var params = reader.decodeStruct(NetworkServiceTest_SetSCTAuditingReportCompletionCallback_Params);
      this.setSCTAuditingReportCompletionCallback().then(function(response) {
        var responseParams =
            new NetworkServiceTest_SetSCTAuditingReportCompletionCallback_ResponseParams();
        var builder = new codec.MessageV1Builder(
            kNetworkServiceTest_SetSCTAuditingReportCompletionCallback_Name,
            codec.align(NetworkServiceTest_SetSCTAuditingReportCompletionCallback_ResponseParams.encodedSize),
            codec.kMessageIsResponse, reader.requestID);
        builder.encodeStruct(NetworkServiceTest_SetSCTAuditingReportCompletionCallback_ResponseParams,
                             responseParams);
        var message = builder.finish();
        responder.accept(message);
      });
  ...
  function validateNetworkServiceTestRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kNetworkServiceTest_GetSCTAuditingPendingReportsCount_Name:
        if (message.expectsResponse())
          paramsClass = NetworkServiceTest_GetSCTAuditingPendingReportsCount_Params;
      break;
      case kNetworkServiceTest_SetSCTAuditingReportCompletionCallback_Name:
        if (message.expectsResponse())
          paramsClass = NetworkServiceTest_SetSCTAuditingReportCompletionCallback_Params;
      break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
  ...
  function validateNetworkServiceTestResponse(messageValidator) {
   ...
   switch (message.getName()) {
      ...
      case kNetworkServiceTest_GetSCTAuditingPendingReportsCount_Name:
        if (message.isResponse())
          paramsClass = NetworkServiceTest_GetSCTAuditingPendingReportsCount_ResponseParams;
        break;
      case kNetworkServiceTest_SetSCTAuditingReportCompletionCallback_Name:
        if (message.isResponse())
          paramsClass = NetworkServiceTest_SetSCTAuditingReportCompletionCallback_ResponseParams;
        break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
