...
(function() {
  ...
  EarlyHints.encodedSize = codec.kStructHeaderSize + 24;
  ...
  EarlyHints.encode = function(encoder, val) {
    ...
    encoder.skip(1);
    encoder.skip(1);
    encoder.encodeArrayPointer(codec.String, val.originTrialTokens);
  };
