...
(function() {
  ...
  CertVerifierService_Verify_Params.prototype.initDefaults_ = function() {
    this.params = null;
    this.netlogSourceType = 0;
    this.netlogSourceId = 0;
    this.netlogSourceStartTime = null;
  ...
  CertVerifierService_Verify_Params.validate = function(messageValidator, offset) {
    ...
    // validate CertVerifierService_Verify_Params.netlogSourceStartTime
  ...
  CertVerifierService_Verify_Params.encodedSize = codec.kStructHeaderSize + 32;
  ...
  CertVerifierService_Verify_Params.decode = function(decoder) {
    ...
    val.netlogSourceType =
        decoder.decodeStruct(codec.Uint32);
    val.netlogSourceId =
        decoder.decodeStruct(codec.Uint32);
    val.netlogSourceStartTime =
  ...
  CertVerifierService_Verify_Params.encode = function(encoder, val) {
    ...
    encoder.encodeStruct(codec.Uint32, val.netlogSourceType);
    encoder.encodeStruct(codec.Uint32, val.netlogSourceId);
    encoder.encodeStructPointer(time$.TimeTicks, val.netlogSourceStartTime);
  ...
  var kURLLoaderFactoryConnector_CreateURLLoaderFactory_Name = 1469459688;
  ...
  var kCertVerifierService_EnableNetworkAccess_Name = 161549455;
  var kCertVerifierService_Verify_Name = 1368097399;
  var kCertVerifierService_SetConfig_Name = 1056635664;
  ...
  CertVerifierServiceProxy.prototype.verify = function(params, netlogSourceType, netlogSourceId, netlogSourceStartTime, certVerifierRequest) {
    var params_ = new CertVerifierService_Verify_Params();
    params_.params = params;
    params_.netlogSourceType = netlogSourceType;
    params_.netlogSourceId = netlogSourceId;
    params_.netlogSourceStartTime = netlogSourceStartTime;
  ...
  CertVerifierServiceStub.prototype.verify = function(params, netlogSourceType, netlogSourceId, netlogSourceStartTime, certVerifierRequest) {
    return this.delegate_ && this.delegate_.verify && this.delegate_.verify(params, netlogSourceType, netlogSourceId, netlogSourceStartTime, certVerifierRequest);
  }
  ...
  CertVerifierServiceStub.prototype.accept = function(message) {
    ...
    case kCertVerifierService_Verify_Name:
      ...
      this.verify(params.params, params.netlogSourceType, params.netlogSourceId, params.netlogSourceStartTime, params.certVerifierRequest);
      return true;
  ...
  var kCertVerifierRequest_Complete_Name = 762926753;
