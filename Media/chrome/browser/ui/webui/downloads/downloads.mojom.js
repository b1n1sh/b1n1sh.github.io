...
(function() {
  ...
  Data.prototype.initDefaults_ = function() {
    ...
    this.shouldShowIncognitoWarning = false;
    this.otr = false;
    this.resume = false;
    this.retry = false;
    this.percent = 0;
  ...
  Data.validate = function(messageValidator, offset) {
    ...
    // validate Data.showInFolderText
  ...
  Data.encodedSize = codec.kStructHeaderSize + 128;
  ...
  Data.decode = function(decoder) {
    ...
    val.shouldShowIncognitoWarning = (packed >> 3) & 1 ? true : false;
    val.otr = (packed >> 4) & 1 ? true : false;
    val.resume = (packed >> 5) & 1 ? true : false;
    val.retry = (packed >> 6) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    val.percent =
  ...
  Data.encode = function(encoder, val) {
    ...
    packed |= (val.shouldShowIncognitoWarning & 1) << 3
    packed |= (val.otr & 1) << 4
    packed |= (val.resume & 1) << 5
    packed |= (val.retry & 1) << 6
    ...
    encoder.encodeStruct(codec.String, val.showInFolderText);
  ...
  function PageHandler_AcceptIncognitoWarning_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  PageHandler_AcceptIncognitoWarning_Params.prototype.initDefaults_ = function() {
    this.id = null;
  };
  PageHandler_AcceptIncognitoWarning_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  PageHandler_AcceptIncognitoWarning_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate PageHandler_AcceptIncognitoWarning_Params.id
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 0, false)
    if (err !== validator.validationError.NONE)
        return err;
  ...
  PageHandler_AcceptIncognitoWarning_Params.encodedSize = codec.kStructHeaderSize + 8;

  PageHandler_AcceptIncognitoWarning_Params.decode = function(decoder) {
    var packed;
    var val = new PageHandler_AcceptIncognitoWarning_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.id =
        decoder.decodeStruct(codec.String);
  ...
  PageHandler_AcceptIncognitoWarning_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(PageHandler_AcceptIncognitoWarning_Params.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.String, val.id);
  };
  ...
  var kPageHandler_GetDownloads_Name = 313087635;
  var kPageHandler_OpenFileRequiringGesture_Name = 294810868;
  var kPageHandler_Drag_Name = 1806248360;
  var kPageHandler_SaveDangerousRequiringGesture_Name = 866235534;
  var kPageHandler_AcceptIncognitoWarning_Name = 1109053887;
  var kPageHandler_DiscardDangerous_Name = 231561239;
  var kPageHandler_RetryDownload_Name = 47114426;
  var kPageHandler_Show_Name = 930390663;
  var kPageHandler_Pause_Name = 1986595236;
  var kPageHandler_Resume_Name = 184295001;
  var kPageHandler_Remove_Name = 101904137;
  var kPageHandler_Undo_Name = 1861931861;
  var kPageHandler_Cancel_Name = 158734240;
  var kPageHandler_ClearAll_Name = 1347524541;
  var kPageHandler_OpenDownloadsFolderRequiringGesture_Name = 1019436504;
  var kPageHandler_OpenDuringScanningRequiringGesture_Name = 1603177353;
  ...
  PageHandlerPtr.prototype.acceptIncognitoWarning = function() {
    return PageHandlerProxy.prototype.acceptIncognitoWarning
        .apply(this.ptr.getProxy(), arguments);
  };

  PageHandlerProxy.prototype.acceptIncognitoWarning = function(id) {
    var params_ = new PageHandler_AcceptIncognitoWarning_Params();
    params_.id = id;
    var builder = new codec.MessageV0Builder(
        kPageHandler_AcceptIncognitoWarning_Name,
        codec.align(PageHandler_AcceptIncognitoWarning_Params.encodedSize));
    builder.encodeStruct(PageHandler_AcceptIncognitoWarning_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };
  ...
  PageHandlerStub.prototype.acceptIncognitoWarning = function(id) {
    return this.delegate_ && this.delegate_.acceptIncognitoWarning && this.delegate_.acceptIncognitoWarning(id);
  }
  ...
  PageHandlerStub.prototype.accept = function(message) {
    ...
    case kPageHandler_SaveDangerousRequiringGesture_Name:
      ...
      return true;
    case kPageHandler_AcceptIncognitoWarning_Name:
      var params = reader.decodeStruct(PageHandler_AcceptIncognitoWarning_Params);
      this.acceptIncognitoWarning(params.id);
      return true;
  ...
  function validatePageHandlerRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kPageHandler_AcceptIncognitoWarning_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = PageHandler_AcceptIncognitoWarning_Params;
      break;
      case kPageHandler_DiscardDangerous_Name:
        if (!message.expectsResponse() && !message.isResponse())
  ...
  var kPage_RemoveItem_Name = 291668681;
  var kPage_UpdateItem_Name = 1391532836;
  var kPage_InsertItems_Name = 1205870653;
  var kPage_ClearAll_Name = 1529829795;
