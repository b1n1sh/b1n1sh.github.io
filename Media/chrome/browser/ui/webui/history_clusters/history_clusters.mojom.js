...
(function() {
  ...
  URLVisit.encodedSize = codec.kStructHeaderSize + 88;
  ...
  Cluster.validate = function(messageValidator, offset) {
    ...
    // validate Cluster.visit
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 8, URLVisit, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  Cluster.encodedSize = codec.kStructHeaderSize + 16;
  ...
  Cluster.decode = function(decoder) {
    ...
    val.visit =
        decoder.decodeStructPointer(URLVisit);
    return val;
  };
  ...
  Cluster.encode = function(encoder, val) {
    ...
    encoder.encodeStructPointer(URLVisit, val.visit);
  };
  ...
  function PageHandler_ToggleVisibility_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  PageHandler_ToggleVisibility_Params.prototype.initDefaults_ = function() {
    this.visible = false;
  };
  PageHandler_ToggleVisibility_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  PageHandler_ToggleVisibility_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  PageHandler_ToggleVisibility_Params.encodedSize = codec.kStructHeaderSize + 8;

  PageHandler_ToggleVisibility_Params.decode = function(decoder) {
    var packed;
    var val = new PageHandler_ToggleVisibility_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    packed = decoder.readUint8();
  ...
  PageHandler_ToggleVisibility_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(PageHandler_ToggleVisibility_Params.encodedSize);
    encoder.writeUint32(0);
    packed = 0;
  ...
  function PageHandler_ToggleVisibility_ResponseParams(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  PageHandler_ToggleVisibility_ResponseParams.prototype.initDefaults_ = function() {
    this.visible = false;
  };
  PageHandler_ToggleVisibility_ResponseParams.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  PageHandler_ToggleVisibility_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  PageHandler_ToggleVisibility_ResponseParams.encodedSize = codec.kStructHeaderSize + 8;

  PageHandler_ToggleVisibility_ResponseParams.decode = function(decoder) {
    var packed;
    var val = new PageHandler_ToggleVisibility_ResponseParams();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    packed = decoder.readUint8();
    val.visible = (packed >> 0) & 1 ? true : false;
  ...
  PageHandler_ToggleVisibility_ResponseParams.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(PageHandler_ToggleVisibility_ResponseParams.encodedSize);
    encoder.writeUint32(0);
    packed = 0;
    packed |= (val.visible & 1) << 0
    encoder.writeUint8(packed);
  ...
  var kPageHandler_ToggleVisibility_Name = 294810868;
  var kPageHandler_QueryClusters_Name = 1806248360;
  var kPageHandler_RemoveVisits_Name = 866235534;
  ...
  PageHandlerPtr.prototype.toggleVisibility = function() {
    return PageHandlerProxy.prototype.toggleVisibility
        .apply(this.ptr.getProxy(), arguments);
  };

  PageHandlerProxy.prototype.toggleVisibility = function(visible) {
    var params_ = new PageHandler_ToggleVisibility_Params();
    params_.visible = visible;
    return new Promise(function(resolve, reject) {
      var builder = new codec.MessageV1Builder(
          kPageHandler_ToggleVisibility_Name,
          codec.align(PageHandler_ToggleVisibility_Params.encodedSize),
          codec.kMessageExpectsResponse, 0);
      builder.encodeStruct(PageHandler_ToggleVisibility_Params, params_);
      var message = builder.finish();
      this.receiver_.acceptAndExpectResponse(message).then(function(message) {
        var reader = new codec.MessageReader(message);
        var responseParams =
            reader.decodeStruct(PageHandler_ToggleVisibility_ResponseParams);
  ...
  PageHandlerStub.prototype.toggleVisibility = function(visible) {
    return this.delegate_ && this.delegate_.toggleVisibility && this.delegate_.toggleVisibility(visible);
  }
  ...
  PageHandlerStub.prototype.acceptWithResponder =
    ...
    var reader = new codec.MessageReader(message);
    switch (reader.messageName) {
    case kPageHandler_ToggleVisibility_Name:
      var params = reader.decodeStruct(PageHandler_ToggleVisibility_Params);
      this.toggleVisibility(params.visible).then(function(response) {
        var responseParams =
            new PageHandler_ToggleVisibility_ResponseParams();
        responseParams.visible = response.visible;
        var builder = new codec.MessageV1Builder(
            kPageHandler_ToggleVisibility_Name,
            codec.align(PageHandler_ToggleVisibility_ResponseParams.encodedSize),
            codec.kMessageIsResponse, reader.requestID);
        builder.encodeStruct(PageHandler_ToggleVisibility_ResponseParams,
                             responseParams);
        var message = builder.finish();
    ...
    switch (message.getName()) {
      ...
      case kPageHandler_ToggleVisibility_Name:
        if (message.expectsResponse())
          paramsClass = PageHandler_ToggleVisibility_Params;
      break;
      case kPageHandler_QueryClusters_Name:
        if (!message.expectsResponse() && !message.isResponse())
   ...
   switch (message.getName()) {
      case kPageHandler_ToggleVisibility_Name:
        if (message.isResponse())
          paramsClass = PageHandler_ToggleVisibility_ResponseParams;
        break;
      case kPageHandler_RemoveVisits_Name:
        if (message.isResponse())
  ...
  var kPage_OnClustersQueryResult_Name = 291668681;
  var kPage_OnVisitsRemoved_Name = 1391532836;
