...
(function() {
  ...
  Action.prototype.initDefaults_ = function() {
    ...
    this.accessibilitySuffix = null;
    this.hint = null;
    this.suggestionContents = null;
    this.iconUrl = null;
  };
  ...
  Action.validate = function(messageValidator, offset) {
    ...
    // validate Action.accessibilityHint
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, string16$.String16, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate Action.accessibilitySuffix
  ...
  Action.encodedSize = codec.kStructHeaderSize + 40;
  ...
  Action.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.accessibilityHint =
        decoder.decodeStructPointer(string16$.String16);
    val.accessibilitySuffix =
        decoder.decodeStructPointer(string16$.String16);
    val.hint =
        decoder.decodeStructPointer(string16$.String16);
    val.suggestionContents =
        decoder.decodeStructPointer(string16$.String16);
    val.iconUrl =
  ...
  Action.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    encoder.encodeStructPointer(string16$.String16, val.accessibilityHint);
    encoder.encodeStructPointer(string16$.String16, val.accessibilitySuffix);
    encoder.encodeStructPointer(string16$.String16, val.hint);
    encoder.encodeStructPointer(string16$.String16, val.suggestionContents);
    encoder.encodeStruct(codec.String, val.iconUrl);
  };
  function SuggestionAnswer(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  SuggestionAnswer.prototype.initDefaults_ = function() {
    this.firstLine = null;
    this.secondLine = null;
  };
  SuggestionAnswer.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  SuggestionAnswer.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate SuggestionAnswer.firstLine
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, string16$.String16, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate SuggestionAnswer.secondLine
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 8, string16$.String16, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  SuggestionAnswer.encodedSize = codec.kStructHeaderSize + 16;

  SuggestionAnswer.decode = function(decoder) {
    var packed;
    var val = new SuggestionAnswer();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.firstLine =
        decoder.decodeStructPointer(string16$.String16);
  ...
  SuggestionAnswer.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(SuggestionAnswer.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStructPointer(string16$.String16, val.firstLine);
    encoder.encodeStructPointer(string16$.String16, val.secondLine);
  };
  ...
  AutocompleteMatch.validate = function(messageValidator, offset) {
    ...
    // validate AutocompleteMatch.action
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 8, Action, true);
    if (err !== validator.validationError.NONE)
        return err;


    // validate AutocompleteMatch.answer
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 16, SuggestionAnswer, true);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 48, 8, new codec.PointerTo(ACMatchClassification), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  AutocompleteMatch.encodedSize = codec.kStructHeaderSize + 112;
  ...
  AutocompleteMatch.decode = function(decoder) {
    ...
    val.isRichSuggestion = (packed >> 1) & 1 ? true : false;
    val.isSearchType = (packed >> 2) & 1 ? true : false;
    val.swapContentsAndDescription = (packed >> 3) & 1 ? true : false;
    val.supportsDeletion = (packed >> 4) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    ...
    val.answer =
        decoder.decodeStructPointer(SuggestionAnswer);
    val.contents =
        decoder.decodeStructPointer(string16$.String16);
    val.contentsClass =
  ...
  AutocompleteMatch.encode = function(encoder, val) {
    ...
    packed |= (val.isRichSuggestion & 1) << 1
    packed |= (val.isSearchType & 1) << 2
    packed |= (val.swapContentsAndDescription & 1) << 3
    packed |= (val.supportsDeletion & 1) << 4
    ...
    encoder.encodeStructPointer(SuggestionAnswer, val.answer);
  ...
  function PageHandler_ExecuteAction_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  PageHandler_ExecuteAction_Params.prototype.initDefaults_ = function() {
    this.line = 0;
    this.mouseButton = 0;
    this.altKey = false;
    this.ctrlKey = false;
    this.metaKey = false;
    this.shiftKey = false;
    this.matchSelectionTimestamp = null;
  };
  PageHandler_ExecuteAction_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  PageHandler_ExecuteAction_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate PageHandler_ExecuteAction_Params.matchSelectionTimestamp
  ...
  PageHandler_ExecuteAction_Params.encodedSize = codec.kStructHeaderSize + 16;

  PageHandler_ExecuteAction_Params.decode = function(decoder) {
    var packed;
    var val = new PageHandler_ExecuteAction_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.line =
        decoder.decodeStruct(codec.Uint8);
    ...
    decoder.skip(1);
    decoder.skip(1);
    val.matchSelectionTimestamp =
        decoder.decodeStructPointer(time$.TimeTicks);
    return val;
  };

  PageHandler_ExecuteAction_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(PageHandler_ExecuteAction_Params.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.Uint8, val.line);
    encoder.encodeStruct(codec.Uint8, val.mouseButton);
    packed = 0;
    ...
    encoder.skip(1);
    encoder.skip(1);
    encoder.encodeStructPointer(time$.TimeTicks, val.matchSelectionTimestamp);
  };
  ...
  Page_AutocompleteResultChanged_Params.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.result =
        decoder.decodeStructPointer(AutocompleteResult);
    return val;
  };
  ...
  var kPageHandler_SetPage_Name = 313087635;
  var kPageHandler_QueryAutocomplete_Name = 294810868;
  var kPageHandler_StopAutocomplete_Name = 1806248360;
  var kPageHandler_OpenAutocompleteMatch_Name = 866235534;
  var kPageHandler_DeleteAutocompleteMatch_Name = 1109053887;
  var kPageHandler_ToggleSuggestionGroupIdVisibility_Name = 231561239;
  var kPageHandler_LogCharTypedToRepaintLatency_Name = 47114426;
  var kPageHandler_ExecuteAction_Name = 930390663;
  ...
  PageHandlerPtr.prototype.executeAction = function() {
    return PageHandlerProxy.prototype.executeAction
        .apply(this.ptr.getProxy(), arguments);
  };

  PageHandlerProxy.prototype.executeAction = function(line, matchSelectionTimestamp, mouseButton, altKey, ctrlKey, metaKey, shiftKey) {
    var params_ = new PageHandler_ExecuteAction_Params();
    params_.line = line;
    params_.matchSelectionTimestamp = matchSelectionTimestamp;
    params_.mouseButton = mouseButton;
    params_.altKey = altKey;
    params_.ctrlKey = ctrlKey;
    params_.metaKey = metaKey;
    params_.shiftKey = shiftKey;
    var builder = new codec.MessageV0Builder(
        kPageHandler_ExecuteAction_Name,
        codec.align(PageHandler_ExecuteAction_Params.encodedSize));
    builder.encodeStruct(PageHandler_ExecuteAction_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };
  ...
  PageHandlerStub.prototype.executeAction = function(line, matchSelectionTimestamp, mouseButton, altKey, ctrlKey, metaKey, shiftKey) {
    return this.delegate_ && this.delegate_.executeAction && this.delegate_.executeAction(line, matchSelectionTimestamp, mouseButton, altKey, ctrlKey, metaKey, shiftKey);
  }
  ...
  PageHandlerStub.prototype.accept = function(message) {
    ...
    case kPageHandler_LogCharTypedToRepaintLatency_Name:
      ...
      return true;
    case kPageHandler_ExecuteAction_Name:
      var params = reader.decodeStruct(PageHandler_ExecuteAction_Params);
      this.executeAction(params.line, params.matchSelectionTimestamp, params.mouseButton, params.altKey, params.ctrlKey, params.metaKey, params.shiftKey);
      return true;
    default:
      return false;
    }
  ...
  function validatePageHandlerRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kPageHandler_ExecuteAction_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = PageHandler_ExecuteAction_Params;
      break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
  ...
  var kPage_AutocompleteResultChanged_Name = 291668681;
  var kPage_AutocompleteMatchImageAvailable_Name = 1391532836;
  ...
  exports.SuggestionAnswer = SuggestionAnswer;
