...
(function() {
  ...
  function PreferredAppInfo(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  PreferredAppInfo.prototype.initDefaults_ = function() {
    this.id = null;
    this.name = null;
    this.preferredFilters = null;
  };
  PreferredAppInfo.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  PreferredAppInfo.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate PreferredAppInfo.id
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 0, false)
    if (err !== validator.validationError.NONE)
        return err;


    // validate PreferredAppInfo.name
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 8, false)
    if (err !== validator.validationError.NONE)
        return err;


    // validate PreferredAppInfo.preferredFilters
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 16, false)
    if (err !== validator.validationError.NONE)
        return err;
  ...
  PreferredAppInfo.encodedSize = codec.kStructHeaderSize + 24;

  PreferredAppInfo.decode = function(decoder) {
    var packed;
    var val = new PreferredAppInfo();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.id =
        decoder.decodeStruct(codec.String);
    val.name =
        decoder.decodeStruct(codec.String);
    val.preferredFilters =
        decoder.decodeStruct(codec.String);
    return val;
  };

  PreferredAppInfo.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(PreferredAppInfo.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.String, val.id);
    encoder.encodeStruct(codec.String, val.name);
    encoder.encodeStruct(codec.String, val.preferredFilters);
  };
  ...
  function AppServiceInternalsPageHandler_GetPreferredApps_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  AppServiceInternalsPageHandler_GetPreferredApps_Params.prototype.initDefaults_ = function() {
  };
  AppServiceInternalsPageHandler_GetPreferredApps_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  AppServiceInternalsPageHandler_GetPreferredApps_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  AppServiceInternalsPageHandler_GetPreferredApps_Params.encodedSize = codec.kStructHeaderSize + 0;

  AppServiceInternalsPageHandler_GetPreferredApps_Params.decode = function(decoder) {
    var packed;
    var val = new AppServiceInternalsPageHandler_GetPreferredApps_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    return val;
  };

  AppServiceInternalsPageHandler_GetPreferredApps_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(AppServiceInternalsPageHandler_GetPreferredApps_Params.encodedSize);
    encoder.writeUint32(0);
  };
  function AppServiceInternalsPageHandler_GetPreferredApps_ResponseParams(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  AppServiceInternalsPageHandler_GetPreferredApps_ResponseParams.prototype.initDefaults_ = function() {
    this.preferredAppList = null;
  };
  AppServiceInternalsPageHandler_GetPreferredApps_ResponseParams.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  AppServiceInternalsPageHandler_GetPreferredApps_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate AppServiceInternalsPageHandler_GetPreferredApps_ResponseParams.preferredAppList
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 0, 8, new codec.PointerTo(PreferredAppInfo), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  AppServiceInternalsPageHandler_GetPreferredApps_ResponseParams.encodedSize = codec.kStructHeaderSize + 8;

  AppServiceInternalsPageHandler_GetPreferredApps_ResponseParams.decode = function(decoder) {
    var packed;
    var val = new AppServiceInternalsPageHandler_GetPreferredApps_ResponseParams();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.preferredAppList =
        decoder.decodeArrayPointer(new codec.PointerTo(PreferredAppInfo));
    return val;
  };

  AppServiceInternalsPageHandler_GetPreferredApps_ResponseParams.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(AppServiceInternalsPageHandler_GetPreferredApps_ResponseParams.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeArrayPointer(new codec.PointerTo(PreferredAppInfo), val.preferredAppList);
  };
  var kAppServiceInternalsPageHandler_GetApps_Name = 63848327;
  var kAppServiceInternalsPageHandler_GetPreferredApps_Name = 522109193;
  ...
  AppServiceInternalsPageHandlerPtr.prototype.getPreferredApps = function() {
    return AppServiceInternalsPageHandlerProxy.prototype.getPreferredApps
        .apply(this.ptr.getProxy(), arguments);
  };

  AppServiceInternalsPageHandlerProxy.prototype.getPreferredApps = function() {
    var params_ = new AppServiceInternalsPageHandler_GetPreferredApps_Params();
    return new Promise(function(resolve, reject) {
      var builder = new codec.MessageV1Builder(
          kAppServiceInternalsPageHandler_GetPreferredApps_Name,
          codec.align(AppServiceInternalsPageHandler_GetPreferredApps_Params.encodedSize),
          codec.kMessageExpectsResponse, 0);
      builder.encodeStruct(AppServiceInternalsPageHandler_GetPreferredApps_Params, params_);
      var message = builder.finish();
      this.receiver_.acceptAndExpectResponse(message).then(function(message) {
        var reader = new codec.MessageReader(message);
        var responseParams =
            reader.decodeStruct(AppServiceInternalsPageHandler_GetPreferredApps_ResponseParams);
        resolve(responseParams);
      }).catch(function(result) {
        reject(Error("Connection error: " + result));
      });
  ...
  AppServiceInternalsPageHandlerStub.prototype.getPreferredApps = function() {
    return this.delegate_ && this.delegate_.getPreferredApps && this.delegate_.getPreferredApps();
  }
  ...
  AppServiceInternalsPageHandlerStub.prototype.acceptWithResponder =
    ...
    case kAppServiceInternalsPageHandler_GetApps_Name:
      ...
      return true;
    case kAppServiceInternalsPageHandler_GetPreferredApps_Name:
      var params = reader.decodeStruct(AppServiceInternalsPageHandler_GetPreferredApps_Params);
      this.getPreferredApps().then(function(response) {
        var responseParams =
            new AppServiceInternalsPageHandler_GetPreferredApps_ResponseParams();
        responseParams.preferredAppList = response.preferredAppList;
        var builder = new codec.MessageV1Builder(
            kAppServiceInternalsPageHandler_GetPreferredApps_Name,
            codec.align(AppServiceInternalsPageHandler_GetPreferredApps_ResponseParams.encodedSize),
            codec.kMessageIsResponse, reader.requestID);
        builder.encodeStruct(AppServiceInternalsPageHandler_GetPreferredApps_ResponseParams,
                             responseParams);
        var message = builder.finish();
        responder.accept(message);
      });
  ...
  function validateAppServiceInternalsPageHandlerRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kAppServiceInternalsPageHandler_GetPreferredApps_Name:
        if (message.expectsResponse())
          paramsClass = AppServiceInternalsPageHandler_GetPreferredApps_Params;
      break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
  ...
  function validateAppServiceInternalsPageHandlerResponse(messageValidator) {
   ...
   switch (message.getName()) {
      ...
      case kAppServiceInternalsPageHandler_GetPreferredApps_Name:
        if (message.isResponse())
          paramsClass = AppServiceInternalsPageHandler_GetPreferredApps_ResponseParams;
        break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
  ...
  exports.PreferredAppInfo = PreferredAppInfo;
