...
(function() {
  ...
  LifecycleUnitVisibility.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  TabDiscardsInfo.decode = function(decoder) {
    ...
    val.title =
        decoder.decodeStruct(codec.String);
    val.visibility =
        decoder.decodeStruct(new codec.Enum(LifecycleUnitVisibility));
    val.loadingState =
        decoder.decodeStruct(new codec.Enum(lifecycle_unit_state$.LifecycleUnitLoadingState));
    val.state =
        decoder.decodeStruct(new codec.Enum(lifecycle_unit_state$.LifecycleUnitState));
    ...
    val.discardReason =
        decoder.decodeStruct(new codec.Enum(lifecycle_unit_state$.LifecycleUnitDiscardReason));
    val.utilityRank =
        decoder.decodeStruct(codec.Int32);
  ...
  PageInfo.encodedSize = codec.kStructHeaderSize + 40;
  ...
  PageInfo.encode = function(encoder, val) {
    ...
    encoder.encodeStruct(codec.Int64, val.embedderFrameId);
  ...
  var kDetailsProvider_GetTabDiscardsInfo_Name = 1979752908;
  var kDetailsProvider_SetAutoDiscardable_Name = 464325805;
  var kDetailsProvider_DiscardById_Name = 871527510;
  var kDetailsProvider_LoadById_Name = 733080537;
  var kDetailsProvider_Discard_Name = 1699974442;
  ...
  var kGraphChangeStream_FrameCreated_Name = 1432377930;
  var kGraphChangeStream_PageCreated_Name = 2124878504;
  var kGraphChangeStream_ProcessCreated_Name = 572906143;
  var kGraphChangeStream_WorkerCreated_Name = 1096906826;
  var kGraphChangeStream_FrameChanged_Name = 470848731;
  var kGraphChangeStream_PageChanged_Name = 1962564145;
  var kGraphChangeStream_ProcessChanged_Name = 882907770;
  var kGraphChangeStream_WorkerChanged_Name = 2115533221;
  var kGraphChangeStream_FavIconDataAvailable_Name = 1619903026;
  var kGraphChangeStream_NodeDeleted_Name = 1725397938;
  ...
  var kGraphDump_SubscribeToChanges_Name = 743011481;
  var kGraphDump_RequestNodeDescriptions_Name = 2007911399;
