...
(function() {
  ...
  Property.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  GattResult.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  DeviceInfo.validate = function(messageValidator, offset) {
    ...
    // validate DeviceInfo.serviceUuids
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 40, 8, new codec.PointerTo(uuid$.UUID), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;


    // validate DeviceInfo.manufacturerDataMap
    err = messageValidator.validateMapPointer(offset + codec.kStructHeaderSize + 48, false, codec.Uint16, new codec.ArrayOf(codec.Uint8), false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate DeviceInfo.serviceDataMap
    err = messageValidator.validateMapPointer(offset + codec.kStructHeaderSize + 56, false, new codec.PointerTo(uuid$.UUID), new codec.ArrayOf(codec.Uint8), false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  DeviceInfo.encode = function(encoder, val) {
    ...
    encoder.encodeArrayPointer(new codec.PointerTo(uuid$.UUID), val.serviceUuids);
    encoder.encodeMapPointer(codec.Uint16, new codec.ArrayOf(codec.Uint8), val.manufacturerDataMap);
  ...
  Device_ReadValueForCharacteristic_ResponseParams.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.result =
        decoder.decodeStruct(new codec.Enum(GattResult));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  var kDevice_Disconnect_Name = 682277063;
  var kDevice_GetInfo_Name = 414598564;
  var kDevice_GetServices_Name = 929920595;
  var kDevice_GetCharacteristics_Name = 601775099;
  var kDevice_ReadValueForCharacteristic_Name = 1359667840;
  var kDevice_WriteValueForCharacteristic_Name = 1710352124;
  var kDevice_GetDescriptors_Name = 1022479072;
  var kDevice_ReadValueForDescriptor_Name = 600218293;
  var kDevice_WriteValueForDescriptor_Name = 1997771536;
