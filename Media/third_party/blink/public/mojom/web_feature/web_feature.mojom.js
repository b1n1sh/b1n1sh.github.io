...
(function() {
  ...
  WebFeature.kOBSOLETE_HTMLImports = 455;
  WebFeature.kOBSOLETE_ElementCreateShadowRoot = 456;
  WebFeature.kOBSOLETE_DocumentRegisterElement = 457;
  ...
  WebFeature.kOBSOLETE_HTMLImportsAsyncAttribute = 463;
  ...
  WebFeature.kClientHintsDPR_DEPRECATED = 835;
  WebFeature.kClientHintsResourceWidth_DEPRECATED = 836;
  WebFeature.kClientHintsViewportWidth_DEPRECATED = 837;
  ...
  WebFeature.kOBSOLETE_HTMLTableElementPresentationAttributeBackground = 1869;
  ...
  WebFeature.kClientHintsDeviceMemory_DEPRECATED = 2017;
  ...
  WebFeature.kClientHintsRtt_DEPRECATED = 2404;
  WebFeature.kClientHintsDownlink_DEPRECATED = 2405;
  WebFeature.kClientHintsEct_DEPRECATED = 2406;
  ...
  WebFeature.kOBSOLETE_ClientHintsLang = 2777;
  ...
  WebFeature.kOBSOLETE_FragmentHasTildeAmpersandTilde = 3039;
  WebFeature.kOBSOLETE_FragmentHasColonTildeColon = 3040;
  WebFeature.kOBSOLETE_FragmentHasTildeAtTilde = 3041;
  WebFeature.kOBSOLETE_FragmentHasAmpersandDelimiterQuestion = 3042;
  ...
  WebFeature.kOBSOLETE_FeaturePolicyProposalWouldChangeBehaviour = 3158;
  ...
  WebFeature.kOBSOLETEV8RTCRtpSender_CreateEncodedAudioStreams_Method = 3180;
  WebFeature.kOBSOLETEV8RTCRtpSender_CreateEncodedVideoStreams_Method = 3181;
  WebFeature.kOBSOLETEV8RTCRtpReceiver_CreateEncodedAudioStreams_Method = 3182;
  WebFeature.kOBSOLETEV8RTCRtpReceiver_CreateEncodedVideoStreams_Method = 3183;
  ...
  WebFeature.kOBSOLETEForceEncodedAudioInsertableStreams = 3294;
  WebFeature.kOBSOLETEForceEncodedVideoInsertableStreams = 3295;
  ...
  WebFeature.kOBSOLETE_CSSInvalidVariableUnset = 3377;
  WebFeature.kElementInternalsShadowRoot = 3378;
  WebFeature.kUserDataFieldFilled_PredictedTypeMatch = 3379;
  WebFeature.kEmailFieldFilled_PredictedTypeMatch = 3380;
  WebFeature.kPhoneFieldFilled_PredictedTypeMatch = 3381;
  WebFeature.kEmailFieldFilled_PatternMatch = 3382;
  ...
  WebFeature.kOBSOLETE_V8Window_IsMultiScreen_Method = 3389;
  WebFeature.kOBSOLETE_V8Window_Onscreenschange_AttributeGetter = 3390;
  WebFeature.kOBSOLETE_V8Window_Onscreenschange_AttributeSetter = 3391;
  ...
  WebFeature.kOBSOLETE_WindowScreenInternal = 3406;
  WebFeature.kOBSOLETE_WindowScreenPrimary = 3407;
  ...
  WebFeature.kOBSOLETE_WindowScreenTouchSupport = 3504;
  ...
  WebFeature.kOBSOLETE_WindowScreenId = 3567;
  ...
  WebFeature.kIdentifiabilityMediaDevicesEnumerateDevices = 3582;
  ...
  WebFeature.kOBSOLETE_LocalStorageFirstUsedBeforeFcp = 3714;
  WebFeature.kOBSOLETE_LocalStorageFirstUsedAfterFcp = 3715;
  WebFeature.kOBSOLETE_CSSPseudoHostCompoundList = 3716;
  WebFeature.kOBSOLETE_CSSPseudoHostContextCompoundList = 3717;
  WebFeature.kOBSOLETE_CSSPseudoHostDynamicSpecificity = 3718;
  WebFeature.kOBSOLETE_GetCurrentBrowsingContextMedia = 3719;
  ...
  WebFeature.kOBSOLETE_WindowOpenWithAdditionalBoolParameter = 3784;
  ...
  WebFeature.kOBSOLETE_SessionStorageFirstUsedBeforeFcp = 3793;
  WebFeature.kOBSOLETE_SessionStorageFirstUsedAfterFcp = 3794;
  WebFeature.kGravitySensorConstructor = 3795;
  WebFeature.kElementInternalsStates = 3796;
  WebFeature.kWebPImage = 3797;
  WebFeature.kAVIFImage = 3798;
  WebFeature.kSVGTextEdited = 3799;
  WebFeature.kV8WasmExceptionHandling = 3800;
  WebFeature.kWasmModuleSharing = 3801;
  WebFeature.kCrossOriginWasmModuleSharing = 3802;
  WebFeature.kOverflowClipAlongEitherAxis = 3803;
  WebFeature.kCreateJSONModuleScript = 3804;
  WebFeature.kCreateCSSModuleScript = 3805;
  WebFeature.kInsertHTMLCommandOnInput = 3806;
  WebFeature.kInsertHTMLCommandOnTextarea = 3807;
  WebFeature.kInsertHTMLCommandOnReadWritePlainText = 3808;
  WebFeature.kCSSAtRuleCounterStyle = 3809;
  WebFeature.kCanvasUseColorSpace = 3810;
  WebFeature.kSelectMenuElement = 3811;
  WebFeature.kRTCPeerConnectionSdpSemanticsPlanBWithReverseOriginTrial = 3812;
  WebFeature.kWebAppManifestCaptureLinks = 3813;
  WebFeature.kSanitizerAPICreated = 3814;
  WebFeature.kSanitizerAPIDefaultConfiguration = 3815;
  WebFeature.kOBSOLETE_SanitizerAPIToString = 3816;
  WebFeature.kSanitizerAPIToFragment = 3817;
  WebFeature.kSanitizerAPIActionTaken = 3818;
  WebFeature.kSanitizerAPIFromString = 3819;
  WebFeature.kSanitizerAPIFromDocument = 3820;
  WebFeature.kSanitizerAPIFromFragment = 3821;
  WebFeature.kStorageFoundationOpen = 3822;
  WebFeature.kStorageFoundationRead = 3823;
  WebFeature.kStorageFoundationReadSync = 3824;
  WebFeature.kStorageFoundationWrite = 3825;
  WebFeature.kStorageFoundationWriteSync = 3826;
  WebFeature.kStorageFoundationFlush = 3827;
  WebFeature.kStorageFoundationFlushSync = 3828;
  WebFeature.kUnrestrictedSharedArrayBuffer = 3829;
  WebFeature.kFeaturePolicyJSAPIAllowsFeatureIFrame = 3830;
  WebFeature.kFeaturePolicyJSAPIAllowsFeatureDocument = 3831;
  WebFeature.kFeaturePolicyJSAPIAllowsFeatureOriginIFrame = 3832;
  WebFeature.kFeaturePolicyJSAPIAllowsFeatureOriginDocument = 3833;
  WebFeature.kFeaturePolicyJSAPIAllowedFeaturesIFrame = 3834;
  WebFeature.kFeaturePolicyJSAPIAllowedFeaturesDocument = 3835;
  WebFeature.kFeaturePolicyJSAPIFeaturesIFrame = 3836;
  WebFeature.kFeaturePolicyJSAPIFeaturesDocument = 3837;
  WebFeature.kFeaturePolicyJSAPIGetAllowlistIFrame = 3838;
  WebFeature.kFeaturePolicyJSAPIGetAllowlistDocument = 3839;
  WebFeature.kV8Screens_Onchange_AttributeGetter = 3840;
  WebFeature.kV8Screens_Onchange_AttributeSetter = 3841;
  WebFeature.kV8ScreenAdvanced_Left_AttributeGetter = 3842;
  WebFeature.kV8ScreenAdvanced_Top_AttributeGetter = 3843;
  WebFeature.kV8ScreenAdvanced_IsPrimary_AttributeGetter = 3844;
  WebFeature.kV8ScreenAdvanced_IsInternal_AttributeGetter = 3845;
  WebFeature.kV8ScreenAdvanced_DevicePixelRatio_AttributeGetter = 3846;
  WebFeature.kV8ScreenAdvanced_Id_AttributeGetter = 3847;
  WebFeature.kV8ScreenAdvanced_PointerTypes_AttributeGetter = 3848;
  WebFeature.kV8ScreenAdvanced_Label_AttributeGetter = 3849;
  WebFeature.kPermissionsPolicyHeader = 3850;
  WebFeature.kWebAppManifestUrlHandlers = 3851;
  WebFeature.kLaxAllowingUnsafeCookies = 3852;
  WebFeature.kV8MediaSession_SetMicrophoneActive_Method = 3853;
  WebFeature.kV8MediaSession_SetCameraActive_Method = 3854;
  WebFeature.kV8Navigator_JoinAdInterestGroup_Method = 3855;
  WebFeature.kV8Navigator_LeaveAdInterestGroup_Method = 3856;
  WebFeature.kV8Navigator_RunAdAuction_Method = 3857;
  WebFeature.kXHRJSONEncodingDetection = 3858;
  WebFeature.kWorkerControlledByServiceWorkerOutOfScope = 3859;
  WebFeature.kXRPlaneDetection = 3860;
  WebFeature.kXRFrameDetectedPlanes = 3861;
  WebFeature.kXRImageTracking = 3862;
  WebFeature.kXRSessionGetTrackedImageScores = 3863;
  WebFeature.kXRFrameGetImageTrackingResults = 3864;
  WebFeature.kOpenWebDatabaseThirdPartyContext = 3865;
  WebFeature.kPointerId = 3866;
  WebFeature.kTransform3dScene = 3867;
  WebFeature.kPrefersColorSchemeMediaFeature = 3868;
  WebFeature.kPrefersContrastMediaFeature = 3869;
  WebFeature.kForcedColorsMediaFeature = 3870;
  WebFeature.kPaymentRequestCSPViolation = 3871;
  WebFeature.kWorkerControlledByServiceWorkerWithFetchEventHandlerOutOfScope = 3872;
  WebFeature.kAuthorizationCoveredByWildcard = 3873;
  WebFeature.kElementGetInnerHTML = 3874;
  WebFeature.kFileHandlingLaunch = 3875;
  WebFeature.kSameOriginDocumentsWithDifferentCOOPStatus = 3876;
  WebFeature.kHTMLMediaElementSetSinkId = 3877;
  WebFeature.kPrefixedStorageQuotaThirdPartyContext = 3878;
  WebFeature.kRequestedFileSystemPersistentThirdPartyContext = 3879;
  WebFeature.kPrefixedStorageInfoThirdPartyContext = 3880;
  WebFeature.kCrossOriginEmbedderPolicyCredentialless = 3881;
  WebFeature.kPostMessageFromSecureToSecure = 3882;
  WebFeature.kPostMessageFromInsecureToInsecure = 3883;
  WebFeature.kWebAppManifestProtocolHandlers = 3884;
  WebFeature.kRTCPeerConnectionOfferAllowExtmapMixedFalse = 3885;
  WebFeature.kNewCanvas2DAPI = 3886;
  WebFeature.kServiceWorkerSubresourceFilterBypassedRequest = 3887;
  WebFeature.kWebGPU = 3888;
  WebFeature.kCSSFilterColorMatrix = 3889;
  WebFeature.kHTMLFencedFrameElement = 3890;
  WebFeature.kCSSFilterLuminanceToAlpha = 3891;
  WebFeature.kHandwritingRecognitionCreateRecognizer = 3892;
  WebFeature.kHandwritingRecognitionQuerySupport = 3893;
  WebFeature.kHandwritingRecognitionStartDrawing = 3894;
  WebFeature.kHandwritingRecognitionGetPrediction = 3895;
  WebFeature.kWebBluetoothManufacturerDataFilter = 3896;
  WebFeature.kSanitizerAPIGetConfig = 3897;
  WebFeature.kSanitizerAPIGetDefaultConfig = 3898;
  WebFeature.kComputePressureObserver_Constructor = 3899;
  WebFeature.kComputePressureObserver_Observe = 3900;
  WebFeature.kComputePressureObserver_Stop = 3901;
  WebFeature.kWebAppWindowControlsOverlay = 3902;
  WebFeature.kPaymentRequestShowWithoutGestureOrToken = 3903;
  WebFeature.kV8Navigator_UpdateAdInterestGroups_Method = 3904;
  WebFeature.kV8Screens_Onscreenschange_AttributeGetter = 3905;
  WebFeature.kV8Screens_Onscreenschange_AttributeSetter = 3906;
  WebFeature.kV8Screens_Oncurrentscreenchange_AttributeGetter = 3907;
  WebFeature.kV8Screens_Oncurrentscreenchange_AttributeSetter = 3908;
  WebFeature.kRTCOfferAnswerOptionsVoiceActivityDetection = 3909;
  WebFeature.kMultiColAndListItem = 3910;
  WebFeature.kCaptureHandle = 3911;
  WebFeature.kSVGText = 3912;
  WebFeature.kGetBBoxForText = 3913;
  WebFeature.kSVGTextHangingFromPath = 3914;
  WebFeature.kClientHintsPrefersColorScheme = 3915;
  WebFeature.kOverscrollBehaviorWillBeFixed = 3916;
  WebFeature.kControlledWorkerWillBeUncontrolled = 3917;
  WebFeature.kARIATouchpassthroughAttribute = 3918;
  WebFeature.kARIAVirtualcontentAttribute = 3919;
  WebFeature.kAccessibilityTouchPassthroughSet = 3920;
  WebFeature.kTextFragmentBlockedByForceLoadAtTop = 3921;
  WebFeature.kUrnDocumentAccessedCookies = 3922;
  WebFeature.kFontFaceAscentOverride = 3923;
  WebFeature.kFontFaceDescentOverride = 3924;
  WebFeature.kFontFaceLineGapOverride = 3925;
  WebFeature.kFontFaceSizeAdjust = 3926;
  WebFeature.kHiddenBackfaceWith3D = 3927;
  WebFeature.kMainFrameNonSecurePrivateAddressSpace = 3928;
  WebFeature.kHTMLMediaElementControlsListNoPlaybackRate = 3930;
  WebFeature.kDocumentTransition = 3931;
  WebFeature.kSpeculationRules = 3932;
  WebFeature.kV8AbortSignal_Abort_Method = 3933;
  WebFeature.kSelectionBackgroundColorInversion = 3934;
  WebFeature.kRTCPeerConnectionPlanBThrewAnException = 3935;
  WebFeature.kHTMLRootContained = 3936;
  WebFeature.kHTMLBodyContained = 3937;
  WebFeature.kXRFrameGetJointPose = 3938;
  WebFeature.kXRFrameFillJointRadii = 3939;
  WebFeature.kXRFrameFillPoses = 3940;
  WebFeature.kWindowOpenNewPopupBehaviorMismatch = 3941;
  WebFeature.kExplicitPointerCaptureClickTargetDiff = 3942;
  WebFeature.kControlledNonBlobURLWorkerWillBeUncontrolled = 3943;
  WebFeature.kMediaMetaThemeColor = 3944;
  WebFeature.kClientHintsUABitness = 3945;
  WebFeature.kDifferentPerspectiveCBOrParent = 3946;
  WebFeature.kWebkitImageSet = 3947;
  WebFeature.kRTCPeerConnectionWithBlockingCsp = 3948;
  WebFeature.kSanitizerAPISanitizeFor = 3949;
  WebFeature.kSanitizerAPIElementSetSanitized = 3950;
  WebFeature.kTextShadowInHighlightPseudo = 3951;
  WebFeature.kTextShadowNotNoneInHighlightPseudo = 3952;
  WebFeature.kSameSiteNoneRequired = 3953;
  WebFeature.kSameSiteNoneIncludedBySamePartyTopResource = 3954;
  WebFeature.kSameSiteNoneIncludedBySamePartyAncestors = 3955;
  WebFeature.kSameSiteNoneIncludedBySameSiteLax = 3956;
  WebFeature.kSameSiteNoneIncludedBySameSiteStrict = 3957;
  WebFeature.kPrivateNetworkAccessNonSecureContextsAllowedDeprecationTrial = 3958;
  WebFeature.kV8URLPattern_Constructor = 3959;
  WebFeature.kV8URLPattern_Test_Method = 3960;
  WebFeature.kV8URLPattern_Exec_Method = 3961;
  WebFeature.kSameSiteCookieInclusionChangedByCrossSiteRedirect = 3962;
  WebFeature.kBlobStoreAccessAcrossAgentClustersInResolveAsURLLoaderFactory = 3963;
  WebFeature.kBlobStoreAccessAcrossAgentClustersInResolveForNavigation = 3964;
  WebFeature.kTapDelayEnabled = 3965;
  WebFeature.kV8URLPattern_CompareComponent_Method = 3966;
  WebFeature.kEarlyHintsPreload = 3967;
  WebFeature.kClientHintsUAReduced = 3968;
  WebFeature.kSpeculationRulesPrerender = 3969;
  WebFeature.kExecCommandWithTrustedTypes = 3970;
  ...
  WebFeature.kClientHintsViewportHeight = 3976;
  WebFeature.kV8NavigatorManagedData_GetDirectoryId_Method = 3977;
  WebFeature.kV8NavigatorManagedData_GetHostname_Method = 3978;
  WebFeature.kV8NavigatorManagedData_GetSerialNumber_Method = 3979;
  WebFeature.kV8NavigatorManagedData_GetAnnotatedAssetId_Method = 3980;
  WebFeature.kV8NavigatorManagedData_GetAnnotatedLocation_Method = 3981;
  WebFeature.kUserDataFieldFilledPreviously = 3982;
  WebFeature.kTableCollapsedBorderDifferentToVisual = 3983;
  WebFeature.kHighlightAPIRegisterHighlight = 3984;
  WebFeature.kReadOrWriteWebDatabaseThirdPartyContext = 3985;
  WebFeature.kFontSelectorCSSFontFamilyWebKitPrefixPictograph = 3986;
  WebFeature.kFontSelectorCSSFontFamilyWebKitPrefixStandard = 3987;
  WebFeature.kFontSelectorCSSFontFamilyWebKitPrefixBody = 3988;
  WebFeature.kFontBuilderCSSFontFamilyWebKitPrefixBody = 3989;
  WebFeature.kCapabilityDelegationOfPaymentRequest = 3990;
  WebFeature.kCredentialManagerGetFederatedCredential = 3992;
  WebFeature.kCredentialManagerGetPasswordCredential = 3993;
  WebFeature.kCredentialManagerStoreFederatedCredential = 3994;
  WebFeature.kCredentialManagerStorePasswordCredential = 3995;
  WebFeature.kCredentialManagerCreateFederatedCredential = 3996;
  WebFeature.kCredentialManagerCreatePasswordCredential = 3997;
  WebFeature.kCanvasRenderingContext2DRoundRect = 3998;
  WebFeature.kNewLayoutOverflowDifferentBlockWithNonEmptyInflowBounds = 3999;
  WebFeature.kCanvasRenderingContext2DReset = 4000;
  WebFeature.kCanvasRenderingContext2DLetterSpacing = 4001;
  WebFeature.kCanvasRenderingContext2DWordSpacing = 4002;
  WebFeature.kCanvasRenderingContext2DFontVariantCaps = 4003;
  WebFeature.kCanvasRenderingContext2DFontKerning = 4004;
  WebFeature.kCanvasRenderingContext2DFontStretch = 4005;
  WebFeature.kCanvasRenderingContext2DTextRendering = 4006;
  WebFeature.kCSSCascadeLayers = 4007;
  WebFeature.kCanvasRenderingContext2DConicGradient = 4008;
  WebFeature.kCanvasRenderingContext2DCanvasFilter = 4009;
  WebFeature.kHTMLParamElementURLParameter = 4010;
  WebFeature.kV8HTMLScriptElement_Supports_Method = 4011;
  WebFeature.kHandwritingRecognitionQueryRecognizer = 4012;
  WebFeature.kV8FileSystemFileHandle_CreateSyncAccessHandle_Method = 4013;
  WebFeature.kV8FileSystemSyncAccessHandle_Read_Method = 4014;
  WebFeature.kV8FileSystemSyncAccessHandle_Write_Method = 4015;
  WebFeature.kV8FileSystemSyncAccessHandle_Close_Method = 4016;
  WebFeature.kV8FileSystemSyncAccessHandle_Flush_Method = 4017;
  WebFeature.kV8FileSystemSyncAccessHandle_GetSize_Method = 4018;
  WebFeature.kV8FileSystemSyncAccessHandle_Truncate_Method = 4019;
  WebFeature.kV8SharedArrayBufferConstructedInExtensionWithoutIsolation = 4020;
  WebFeature.kMediaSourceExtensionsForWebCodecs = 4021;
  WebFeature.kPaymentRequestResponse = 4023;
  WebFeature.kPaymentRequestComplete = 4024;
  WebFeature.kHTMLCanvasElement_2D = 4025;
  WebFeature.kHTMLCanvasElement_WebGL = 4026;
  WebFeature.kHTMLCanvasElement_WebGL2 = 4027;
  WebFeature.kHTMLCanvasElement_BitmapRenderer = 4028;
  WebFeature.kHTMLCanvasElement_WebGPU = 4029;
  WebFeature.kOffscreenCanvas_2D = 4030;
  WebFeature.kOffscreenCanvas_WebGL = 4031;
  WebFeature.kOffscreenCanvas_WebGL2 = 4032;
  WebFeature.kOffscreenCanvas_BitmapRenderer = 4033;
  WebFeature.kOffscreenCanvas_WebGPU = 4034;
  WebFeature.kCanvasRenderingContext2DHasOverdraw = 4035;
  WebFeature.kDigitalGoodsConsume = 4036;
  WebFeature.kDigitalGoodsListPurchaseHistory = 4037;
  WebFeature.kWebShareContainingFiles = 4038;
  WebFeature.kWebShareContainingTitle = 4039;
  WebFeature.kWebShareContainingText = 4040;
  WebFeature.kWebShareContainingUrl = 4041;
  WebFeature.kCoepNoneSharedWorker = 4042;
  WebFeature.kCoepRequireCorpSharedWorker = 4043;
  WebFeature.kCoepCredentiallessSharedWorker = 4044;
  WebFeature.kPaymentRequestBasicCard = 4045;
  WebFeature.kClientHintsDeviceMemory = 4046;
  WebFeature.kClientHintsDPR = 4047;
  WebFeature.kClientHintsResourceWidth = 4048;
  WebFeature.kClientHintsViewportWidth = 4049;
  WebFeature.kInlineBoxIgnoringContinuation = 4050;
  WebFeature.kOffsetWidthOrHeightIgnoringContinuation = 4051;
  WebFeature.kConditionalFocus = 4052;
  WebFeature.kV8Navigator_CreateAdRequest_Method = 4053;
  WebFeature.kV8Navigator_FinalizeAd_Method = 4054;
  WebFeature.kRegionCapture = 4055;
  WebFeature.kAppHistory = 4056;
  WebFeature.kFlexboxAlignSingleLineDifference = 4057;
  WebFeature.kExternalProtocolBlockedBySandbox = 4058;
  WebFeature.kWebAssemblyDynamicTiering = 4059;
  WebFeature.kDeferredShapingTallerIfc = 4060;
  WebFeature.kReadOrWriteWebDatabase = 4061;
  WebFeature.kNumberOfFeatures = 4062;
  WebFeature.MIN_VALUE = 0;
  WebFeature.MAX_VALUE = 4062;
  ...
  WebFeature.toKnownEnumValue = function(value) {
    return value;
  };
