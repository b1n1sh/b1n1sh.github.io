...
(function() {
  ...
  RequestIdTokenStatus.kErrorInvalidAccountsResponse = 8;
  RequestIdTokenStatus.kErrorInvalidTokenResponse = 9;
  RequestIdTokenStatus.kError = 10;
  RequestIdTokenStatus.MIN_VALUE = 0;
  RequestIdTokenStatus.MAX_VALUE = 10;
  ...
  RequestIdTokenStatus.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  var LogoutStatus = {};
  LogoutStatus.kSuccess = 0;
  LogoutStatus.kErrorTooManyRequests = 1;
  LogoutStatus.kError = 2;
  LogoutStatus.MIN_VALUE = 0;
  LogoutStatus.MAX_VALUE = 2;

  LogoutStatus.isKnownEnumValue = function(value) {
    switch (value) {
    case 0:
    case 1:
    case 2:
  ...
  LogoutStatus.toKnownEnumValue = function(value) {
    return value;
  };

  LogoutStatus.validate = function(enumValue) {
    const isExtensible = false;
    if (isExtensible || this.isKnownEnumValue(enumValue))
      return validator.validationError.NONE;
  ...
  var RequestMode = {};
  RequestMode.kMediated = 0;
  RequestMode.kPermission = 1;
  RequestMode.MIN_VALUE = 0;
  RequestMode.MAX_VALUE = 1;
  ...
  RequestMode.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  function LogoutRequest(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  LogoutRequest.prototype.initDefaults_ = function() {
    this.endpoint = null;
    this.accountId = null;
  };
  LogoutRequest.prototype.initFields_ = function(fields) {
  ...
  LogoutRequest.validate = function(messageValidator, offset) {
    var err;
    ...
    // validate LogoutRequest.endpoint
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, url$.Url, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate LogoutRequest.accountId
  ...
  LogoutRequest.encodedSize = codec.kStructHeaderSize + 16;

  LogoutRequest.decode = function(decoder) {
    var packed;
    var val = new LogoutRequest();
  ...
  LogoutRequest.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(LogoutRequest.encodedSize);
  ...
  FederatedAuthRequest_RequestIdToken_Params.validate = function(messageValidator, offset) {
    ...
    // validate FederatedAuthRequest_RequestIdToken_Params.clientId
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 8, false)
    if (err !== validator.validationError.NONE)
        return err;


    // validate FederatedAuthRequest_RequestIdToken_Params.nonce
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 16, false)
    if (err !== validator.validationError.NONE)
        return err;


    // validate FederatedAuthRequest_RequestIdToken_Params.mode
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 24, RequestMode);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  FederatedAuthRequest_RequestIdToken_Params.encodedSize = codec.kStructHeaderSize + 32;
  ...
  FederatedAuthRequest_RequestIdToken_Params.decode = function(decoder) {
    ...
    val.nonce =
        decoder.decodeStruct(codec.String);
    val.mode =
        decoder.decodeStruct(new codec.Enum(RequestMode));
  ...
  FederatedAuthRequest_RequestIdToken_ResponseParams.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.status =
        decoder.decodeStruct(new codec.Enum(RequestIdTokenStatus));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  function FederatedAuthRequest_Logout_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  FederatedAuthRequest_Logout_Params.prototype.initDefaults_ = function() {
    this.rpLogoutRequests = null;
  };
  FederatedAuthRequest_Logout_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  FederatedAuthRequest_Logout_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate FederatedAuthRequest_Logout_Params.rpLogoutRequests
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 0, 8, new codec.PointerTo(LogoutRequest), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  FederatedAuthRequest_Logout_Params.encodedSize = codec.kStructHeaderSize + 8;

  FederatedAuthRequest_Logout_Params.decode = function(decoder) {
    var packed;
    var val = new FederatedAuthRequest_Logout_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.rpLogoutRequests =
        decoder.decodeArrayPointer(new codec.PointerTo(LogoutRequest));
    return val;
  };

  FederatedAuthRequest_Logout_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(FederatedAuthRequest_Logout_Params.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeArrayPointer(new codec.PointerTo(LogoutRequest), val.rpLogoutRequests);
  };
  function FederatedAuthRequest_Logout_ResponseParams(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  FederatedAuthRequest_Logout_ResponseParams.prototype.initDefaults_ = function() {
    this.status = 0;
  };
  FederatedAuthRequest_Logout_ResponseParams.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  FederatedAuthRequest_Logout_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate FederatedAuthRequest_Logout_ResponseParams.status
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 0, LogoutStatus);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  FederatedAuthRequest_Logout_ResponseParams.encodedSize = codec.kStructHeaderSize + 8;

  FederatedAuthRequest_Logout_ResponseParams.decode = function(decoder) {
    var packed;
    var val = new FederatedAuthRequest_Logout_ResponseParams();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.status =
        decoder.decodeStruct(new codec.Enum(LogoutStatus));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  FederatedAuthRequest_Logout_ResponseParams.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(FederatedAuthRequest_Logout_ResponseParams.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.Int32, val.status);
    encoder.skip(1);
    encoder.skip(1);
  ...
  var kFederatedAuthRequest_Logout_Name = 1;
  ...
  FederatedAuthRequestProxy.prototype.requestIdToken = function(provider, clientId, nonce, mode, preferAutoSignIn) {
  ...
  FederatedAuthRequestPtr.prototype.logout = function() {
    return FederatedAuthRequestProxy.prototype.logout
        .apply(this.ptr.getProxy(), arguments);
  };

  FederatedAuthRequestProxy.prototype.logout = function(rpLogoutRequests) {
    var params_ = new FederatedAuthRequest_Logout_Params();
    params_.rpLogoutRequests = rpLogoutRequests;
    return new Promise(function(resolve, reject) {
      var builder = new codec.MessageV1Builder(
          kFederatedAuthRequest_Logout_Name,
          codec.align(FederatedAuthRequest_Logout_Params.encodedSize),
          codec.kMessageExpectsResponse, 0);
      builder.encodeStruct(FederatedAuthRequest_Logout_Params, params_);
      var message = builder.finish();
      this.receiver_.acceptAndExpectResponse(message).then(function(message) {
        var reader = new codec.MessageReader(message);
        var responseParams =
            reader.decodeStruct(FederatedAuthRequest_Logout_ResponseParams);
        resolve(responseParams);
      }).catch(function(result) {
        reject(Error("Connection error: " + result));
      });
  ...
  FederatedAuthRequestStub.prototype.requestIdToken = function(provider, clientId, nonce, mode, preferAutoSignIn) {
    return this.delegate_ && this.delegate_.requestIdToken && this.delegate_.requestIdToken(provider, clientId, nonce, mode, preferAutoSignIn);
  }
  FederatedAuthRequestStub.prototype.logout = function(rpLogoutRequests) {
    return this.delegate_ && this.delegate_.logout && this.delegate_.logout(rpLogoutRequests);
  }
  ...
  FederatedAuthRequestStub.prototype.acceptWithResponder =
    ...
    case kFederatedAuthRequest_RequestIdToken_Name:
      ...
      this.requestIdToken(params.provider, params.clientId, params.nonce, params.mode, params.preferAutoSignIn).then(function(response) {
        var responseParams =
      ...
      return true;
    case kFederatedAuthRequest_Logout_Name:
      var params = reader.decodeStruct(FederatedAuthRequest_Logout_Params);
      this.logout(params.rpLogoutRequests).then(function(response) {
        var responseParams =
            new FederatedAuthRequest_Logout_ResponseParams();
        responseParams.status = response.status;
        var builder = new codec.MessageV1Builder(
            kFederatedAuthRequest_Logout_Name,
            codec.align(FederatedAuthRequest_Logout_ResponseParams.encodedSize),
            codec.kMessageIsResponse, reader.requestID);
        builder.encodeStruct(FederatedAuthRequest_Logout_ResponseParams,
                             responseParams);
        var message = builder.finish();
        responder.accept(message);
      });
  ...
  function validateFederatedAuthRequestRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kFederatedAuthRequest_Logout_Name:
        if (message.expectsResponse())
          paramsClass = FederatedAuthRequest_Logout_Params;
      break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
  ...
  function validateFederatedAuthRequestResponse(messageValidator) {
   ...
   switch (message.getName()) {
      ...
      case kFederatedAuthRequest_Logout_Name:
        if (message.isResponse())
          paramsClass = FederatedAuthRequest_Logout_ResponseParams;
        break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
