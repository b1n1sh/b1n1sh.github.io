...
(function() {
  ...
  AuthenticatorStatus.NOT_IMPLEMENTED = 6;
  AuthenticatorStatus.NOT_FOCUSED = 7;
  AuthenticatorStatus.RESIDENT_CREDENTIALS_UNSUPPORTED = 8;
  AuthenticatorStatus.USER_VERIFICATION_UNSUPPORTED = 9;
  AuthenticatorStatus.ALGORITHM_UNSUPPORTED = 10;
  AuthenticatorStatus.EMPTY_ALLOW_CREDENTIALS = 11;
  AuthenticatorStatus.ANDROID_NOT_SUPPORTED_ERROR = 12;
  AuthenticatorStatus.PROTECTION_POLICY_INCONSISTENT = 13;
  AuthenticatorStatus.ABORT_ERROR = 14;
  AuthenticatorStatus.OPAQUE_DOMAIN = 15;
  AuthenticatorStatus.INVALID_PROTOCOL = 16;
  AuthenticatorStatus.BAD_RELYING_PARTY_ID = 17;
  AuthenticatorStatus.CANNOT_READ_AND_WRITE_LARGE_BLOB = 18;
  AuthenticatorStatus.INVALID_ALLOW_CREDENTIALS_FOR_LARGE_BLOB = 19;
  AuthenticatorStatus.FAILED_TO_SAVE_CREDENTIAL_ID_FOR_PAYMENT_EXTENSION = 20;
  ...
  MakeCredentialAuthenticatorResponse.validate = function(messageValidator, offset) {
    ...
    // validate MakeCredentialAuthenticatorResponse.transport
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 12, AuthenticatorTransport);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  MakeCredentialAuthenticatorResponse.encodedSize = codec.kStructHeaderSize + 48;
  ...
  MakeCredentialAuthenticatorResponse.decode = function(decoder) {
    ...
    val.echoHmacCreateSecret = (packed >> 1) & 1 ? true : false;
    val.hmacCreateSecret = (packed >> 2) & 1 ? true : false;
    val.echoPrf = (packed >> 3) & 1 ? true : false;
    val.prf = (packed >> 4) & 1 ? true : false;
    val.echoCredBlob = (packed >> 5) & 1 ? true : false;
    val.credBlob = (packed >> 6) & 1 ? true : false;
    val.echoCredProps = (packed >> 7) & 1 ? true : false;
    packed = decoder.readUint8();
    val.hasCredPropsRk = (packed >> 0) & 1 ? true : false;
    val.credPropsRk = (packed >> 1) & 1 ? true : false;
    val.echoLargeBlob = (packed >> 2) & 1 ? true : false;
    val.supportsLargeBlob = (packed >> 3) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    val.transport =
        decoder.decodeStruct(new codec.Enum(AuthenticatorTransport));
  ...
  MakeCredentialAuthenticatorResponse.encode = function(encoder, val) {
    ...
    packed |= (val.echoHmacCreateSecret & 1) << 1
    packed |= (val.hmacCreateSecret & 1) << 2
    packed |= (val.echoPrf & 1) << 3
    packed |= (val.prf & 1) << 4
    packed |= (val.echoCredBlob & 1) << 5
    packed |= (val.credBlob & 1) << 6
    packed |= (val.echoCredProps & 1) << 7
    encoder.writeUint8(packed);
    packed = 0;
    packed |= (val.hasCredPropsRk & 1) << 0
    packed |= (val.credPropsRk & 1) << 1
    packed |= (val.echoLargeBlob & 1) << 2
    packed |= (val.supportsLargeBlob & 1) << 3
    encoder.writeUint8(packed);
    encoder.skip(1);
    encoder.skip(1);
  ...
  GetAssertionAuthenticatorResponse.validate = function(messageValidator, offset) {
    ...
    // validate GetAssertionAuthenticatorResponse.transport
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 12, AuthenticatorTransport);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate GetAssertionAuthenticatorResponse.getCredBlob
  ...
  GetAssertionAuthenticatorResponse.encodedSize = codec.kStructHeaderSize + 56;
  ...
  GetAssertionAuthenticatorResponse.decode = function(decoder) {
    ...
    packed = decoder.readUint8();
    val.hasTransport = (packed >> 0) & 1 ? true : false;
    val.echoAppidExtension = (packed >> 1) & 1 ? true : false;
    val.appidExtension = (packed >> 2) & 1 ? true : false;
    val.echoPrf = (packed >> 3) & 1 ? true : false;
    val.prfNotEvaluated = (packed >> 4) & 1 ? true : false;
    val.echoLargeBlob = (packed >> 5) & 1 ? true : false;
    val.echoLargeBlobWritten = (packed >> 6) & 1 ? true : false;
    val.largeBlobWritten = (packed >> 7) & 1 ? true : false;
    packed = decoder.readUint8();
    val.echoGetCredBlob = (packed >> 0) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    val.transport =
        decoder.decodeStruct(new codec.Enum(AuthenticatorTransport));
  ...
  GetAssertionAuthenticatorResponse.encode = function(encoder, val) {
    ...
    packed = 0;
    packed |= (val.hasTransport & 1) << 0
    packed |= (val.echoAppidExtension & 1) << 1
    packed |= (val.appidExtension & 1) << 2
    packed |= (val.echoPrf & 1) << 3
    packed |= (val.prfNotEvaluated & 1) << 4
    packed |= (val.echoLargeBlob & 1) << 5
    packed |= (val.echoLargeBlobWritten & 1) << 6
    packed |= (val.largeBlobWritten & 1) << 7
    encoder.writeUint8(packed);
    packed = 0;
    packed |= (val.echoGetCredBlob & 1) << 0
    encoder.writeUint8(packed);
    encoder.skip(1);
    encoder.skip(1);
    encoder.encodeStruct(codec.Int32, val.transport);
  ...
  PaymentOptions.encodedSize = codec.kStructHeaderSize + 24;
  ...
  PublicKeyCredentialCreationOptions.encodedSize = codec.kStructHeaderSize + 96;
  ...
  PublicKeyCredentialCreationOptions.decode = function(decoder) {
    ...
    val.googleLegacyAppIdSupport = (packed >> 5) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  PublicKeyCredentialCreationOptions.encode = function(encoder, val) {
    ...
    packed |= (val.googleLegacyAppIdSupport & 1) << 5
    encoder.writeUint8(packed);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
