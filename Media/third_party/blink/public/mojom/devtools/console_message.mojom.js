...
(function() {
  ...
  ConsoleMessageLevel.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  ConsoleMessageSource.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  var ConsoleMessageCategory = {};
  ConsoleMessageCategory.Cors = 0;
  ConsoleMessageCategory.MIN_VALUE = 0;
  ConsoleMessageCategory.MAX_VALUE = 0;

  ConsoleMessageCategory.isKnownEnumValue = function(value) {
    switch (value) {
    case 0:
      return true;
    }
  ...
  ConsoleMessageCategory.toKnownEnumValue = function(value) {
    return value;
  };

  ConsoleMessageCategory.validate = function(enumValue) {
    const isExtensible = false;
    if (isExtensible || this.isKnownEnumValue(enumValue))
      return validator.validationError.NONE;
  ...
  exports.ConsoleMessageCategory = ConsoleMessageCategory;
})();