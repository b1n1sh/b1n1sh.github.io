...
(function() {
  ...
  InspectorIssueCode.kGenericIssue = 8;
  InspectorIssueCode.MIN_VALUE = 0;
  InspectorIssueCode.MAX_VALUE = 8;
  ...
  SameSiteCookieOperation.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  SameSiteCookieExclusionReason.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  SameSiteCookieWarningReason.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  TwaQualityEnforcementViolationType.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  GenericIssueErrorType.MAX_VALUE = 0;
  ...
  SameSiteCookieIssueDetails.decode = function(decoder) {
    ...
    val.operation =
        decoder.decodeStruct(new codec.Enum(SameSiteCookieOperation));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  TrustedWebActivityIssueDetails.decode = function(decoder) {
    ...
    val.url =
        decoder.decodeStructPointer(url$.Url);
    val.violationType =
        decoder.decodeStruct(new codec.Enum(TwaQualityEnforcementViolationType));
    val.httpErrorCode =
        decoder.decodeStruct(codec.Int32);
    val.packageName =
        decoder.decodeStruct(codec.NullableString);
  ...
  GenericIssueDetails.encodedSize = codec.kStructHeaderSize + 16;
  ...
  InspectorIssueDetails.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 64, GenericIssueDetails, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  InspectorIssueDetails.encodedSize = codec.kStructHeaderSize + 80;
