...
(function() {
  ...
  PaymentCredential_StorePaymentCredential_Params.encodedSize = codec.kStructHeaderSize + 16;
  ...
  PaymentCredentialProxy.prototype.storePaymentCredential = function(credentialId, rpId) {
  ...
  PaymentCredentialStub.prototype.storePaymentCredential = function(credentialId, rpId) {
    return this.delegate_ && this.delegate_.storePaymentCredential && this.delegate_.storePaymentCredential(credentialId, rpId);
  }
  ...
  PaymentCredentialStub.prototype.acceptWithResponder =
    ...
    case kPaymentCredential_StorePaymentCredential_Name:
      ...
      this.storePaymentCredential(params.credentialId, params.rpId).then(function(response) {
        var responseParams =
