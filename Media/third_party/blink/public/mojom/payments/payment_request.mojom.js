...
(function() {
  ...
  if (mojo.config.autoLoadMojomDeps) {
    mojo.internal.loadMojomIfNecessary(
        'third_party/blink/public/mojom/payments/payment_credential.mojom', 'payment_credential.mojom.js');
  }
  var origin$ =
  ...
  PaymentErrorReason.NOT_ALLOWED_ERROR = 6;
  PaymentErrorReason.MIN_VALUE = 0;
  PaymentErrorReason.MAX_VALUE = 6;
  ...
  PaymentErrorReason.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  CanMakePaymentQueryResult.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  HasEnrolledInstrumentQueryResult.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  AndroidPayEnvironment.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  BasicCardNetwork.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  PaymentShippingType.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  PaymentComplete.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  PaymentResponse.validate = function(messageValidator, offset) {
    ...
    // validate PaymentResponse.securePaymentConfirmation
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 40, SecurePaymentConfirmationResponse, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  PaymentResponse.decode = function(decoder) {
    ...
    val.securePaymentConfirmation =
        decoder.decodeStructPointer(SecurePaymentConfirmationResponse);
    return val;
  };
  ...
  PaymentResponse.encode = function(encoder, val) {
    ...
    encoder.encodeStructPointer(SecurePaymentConfirmationResponse, val.securePaymentConfirmation);
  };
  function SecurePaymentConfirmationResponse(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  SecurePaymentConfirmationResponse.prototype.initDefaults_ = function() {
  ...
  SecurePaymentConfirmationResponse.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  SecurePaymentConfirmationResponse.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate SecurePaymentConfirmationResponse.credentialInfo
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, authenticator$.CommonCredentialInfo, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate SecurePaymentConfirmationResponse.signature
    ...
    // validate SecurePaymentConfirmationResponse.transport
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 20, authenticator$.AuthenticatorTransport);
    if (err !== validator.validationError.NONE)
        return err;


    // validate SecurePaymentConfirmationResponse.userHandle
  ...
  SecurePaymentConfirmationResponse.encodedSize = codec.kStructHeaderSize + 32;

  SecurePaymentConfirmationResponse.decode = function(decoder) {
    var packed;
    var val = new SecurePaymentConfirmationResponse();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.credentialInfo =
        decoder.decodeStructPointer(authenticator$.CommonCredentialInfo);
    val.signature =
        decoder.decodeArrayPointer(codec.Uint8);
    packed = decoder.readUint8();
    val.hasTransport = (packed >> 0) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    val.transport =
        decoder.decodeStruct(new codec.Enum(authenticator$.AuthenticatorTransport));
    val.userHandle =
        decoder.decodeArrayPointer(codec.Uint8);
    return val;
  };

  SecurePaymentConfirmationResponse.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(SecurePaymentConfirmationResponse.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStructPointer(authenticator$.CommonCredentialInfo, val.credentialInfo);
    encoder.encodeArrayPointer(codec.Uint8, val.signature);
    packed = 0;
    packed |= (val.hasTransport & 1) << 0
  ...
  SecurePaymentConfirmationRequest.validate = function(messageValidator, offset) {
    ...
    // validate SecurePaymentConfirmationRequest.challenge
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 8, 1, codec.Uint8, false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;


    // validate SecurePaymentConfirmationRequest.instrument
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 16, authenticator$.PaymentCredentialInstrument, false);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate SecurePaymentConfirmationRequest.payeeOrigin
  ...
  SecurePaymentConfirmationRequest.encodedSize = codec.kStructHeaderSize + 40;
  ...
  SecurePaymentConfirmationRequest.decode = function(decoder) {
    ...
    val.challenge =
        decoder.decodeArrayPointer(codec.Uint8);
    val.instrument =
        decoder.decodeStructPointer(authenticator$.PaymentCredentialInstrument);
    val.timeout =
  ...
  SecurePaymentConfirmationRequest.encode = function(encoder, val) {
    ...
    encoder.encodeStructPointer(authenticator$.PaymentCredentialInstrument, val.instrument);
  ...
  PaymentMethodData.decode = function(decoder) {
    ...
    val.stringifiedData =
        decoder.decodeStruct(codec.String);
    val.environment =
        decoder.decodeStruct(new codec.Enum(AndroidPayEnvironment));
  ...
  PaymentOptions.decode = function(decoder) {
    ...
    decoder.skip(1);
    val.shippingType =
        decoder.decodeStruct(new codec.Enum(PaymentShippingType));
    return val;
  };
  ...
  PaymentRequestClient_OnError_Params.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.error =
        decoder.decodeStruct(new codec.Enum(PaymentErrorReason));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  PaymentRequestClient_OnCanMakePayment_Params.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.result =
        decoder.decodeStruct(new codec.Enum(CanMakePaymentQueryResult));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  PaymentRequestClient_OnHasEnrolledInstrument_Params.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.result =
        decoder.decodeStruct(new codec.Enum(HasEnrolledInstrumentQueryResult));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  PaymentRequest_Complete_Params.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.result =
        decoder.decodeStruct(new codec.Enum(PaymentComplete));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  exports.SecurePaymentConfirmationResponse = SecurePaymentConfirmationResponse;
