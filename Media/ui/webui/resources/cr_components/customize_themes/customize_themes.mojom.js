...
(function() {
  ...
  ThemeType.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  Theme.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.type =
        decoder.decodeStruct(new codec.Enum(ThemeType));
    packed = decoder.readUint8();
    val.isForced = (packed >> 0) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    val.info =
  ...
  var kCustomizeThemesHandlerFactory_CreateCustomizeThemesHandler_Name = 1476437455;
  ...
  var kCustomizeThemesHandler_ApplyAutogeneratedTheme_Name = 917228994;
  var kCustomizeThemesHandler_ApplyChromeTheme_Name = 1916720060;
  var kCustomizeThemesHandler_ApplyDefaultTheme_Name = 544100220;
  var kCustomizeThemesHandler_InitializeTheme_Name = 1356174293;
  var kCustomizeThemesHandler_GetChromeThemes_Name = 406260172;
  var kCustomizeThemesHandler_ConfirmThemeChanges_Name = 2084119801;
  var kCustomizeThemesHandler_RevertThemeChanges_Name = 1753533751;
  ...
  var kCustomizeThemesClient_SetTheme_Name = 1654064798;
