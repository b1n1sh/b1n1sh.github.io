...
(function() {
  ...
  MediaStatus.PlayState.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  MediaStatus.decode = function(decoder) {
    ...
    decoder.skip(1);
    val.playState =
        decoder.decodeStruct(new codec.Enum(MediaStatus.PlayState));
    val.volume =
  ...
  var kMediaStatusObserver_OnMediaStatusUpdated_Name = 1936882403;
