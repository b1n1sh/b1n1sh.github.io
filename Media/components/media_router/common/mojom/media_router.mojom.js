...
(function() {
  ...
  var media_route_provider_id$ =
      mojo.internal.exposeNamespace('mediaRouter.mojom');
  if (mojo.config.autoLoadMojomDeps) {
    mojo.internal.loadMojomIfNecessary(
        'components/media_router/common/mojom/media_route_provider_id.mojom', 'media_route_provider_id.mojom.js');
  }
  var media_status$ =
      mojo.internal.exposeNamespace('mediaRouter.mojom');
  if (mojo.config.autoLoadMojomDeps) {
  ...
  SinkIconType.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  RouteControllerType.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  MediaSink.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 36, media_route_provider_id$.MediaRouteProviderId);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  MediaSink.decode = function(decoder) {
    ...
    val.domain =
        decoder.decodeStruct(codec.NullableString);
    val.iconType =
        decoder.decodeStruct(new codec.Enum(SinkIconType));
    val.providerId =
        decoder.decodeStruct(new codec.Enum(media_route_provider_id$.MediaRouteProviderId));
    val.extraData =
  ...
  MediaRoute.decode = function(decoder) {
    ...
    val.isConnecting = (packed >> 4) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    val.controllerType =
        decoder.decodeStruct(new codec.Enum(RouteControllerType));
    return val;
  };
  ...
  Issue.Severity.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  Issue.ActionType.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  Issue.decode = function(decoder) {
    ...
    val.sinkId =
        decoder.decodeStruct(codec.String);
    val.severity =
        decoder.decodeStruct(new codec.Enum(Issue.Severity));
    packed = decoder.readUint8();
    ...
    val.message =
        decoder.decodeStruct(codec.NullableString);
    val.defaultAction =
        decoder.decodeStruct(new codec.Enum(Issue.ActionType));
    val.helpPageId =
        decoder.decodeStruct(codec.Int32);
  ...
  RouteMessage.Type.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  RouteMessage.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.type =
        decoder.decodeStruct(new codec.Enum(RouteMessage.Type));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  MediaRouteProvider_CreateRoute_ResponseParams.decode = function(decoder) {
    ...
    val.errorText =
        decoder.decodeStruct(codec.NullableString);
    val.resultCode =
        decoder.decodeStruct(new codec.Enum(RouteRequestResultCode));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  MediaRouter_RegisterMediaRouteProvider_Params.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 0, media_route_provider_id$.MediaRouteProviderId);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  MediaRouter_OnSinkAvailabilityUpdated_Params.decode = function(decoder) {
    ...
    val.providerId =
        decoder.decodeStruct(new codec.Enum(media_route_provider_id$.MediaRouteProviderId));
    val.availability =
        decoder.decodeStruct(new codec.Enum(MediaRouter.SinkAvailability));
    return val;
  };
  ...
  MediaRouter_OnPresentationConnectionStateChanged_Params.decode = function(decoder) {
    ...
    val.routeId =
        decoder.decodeStruct(codec.String);
    val.state =
        decoder.decodeStruct(new codec.Enum(presentation$.PresentationConnectionState));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  MediaRouter_OnPresentationConnectionClosed_Params.decode = function(decoder) {
    ...
    val.routeId =
        decoder.decodeStruct(codec.String);
    val.reason =
        decoder.decodeStruct(new codec.Enum(presentation$.PresentationConnectionCloseReason));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  var kMediaRouteProvider_CreateRoute_Name = 41358908;
  var kMediaRouteProvider_JoinRoute_Name = 1958650506;
  var kMediaRouteProvider_ConnectRouteByRouteId_Name = 1655713521;
  var kMediaRouteProvider_TerminateRoute_Name = 1772235410;
  var kMediaRouteProvider_SendRouteMessage_Name = 2118897904;
  var kMediaRouteProvider_SendRouteBinaryMessage_Name = 350848716;
  var kMediaRouteProvider_StartObservingMediaSinks_Name = 1945771699;
  var kMediaRouteProvider_StopObservingMediaSinks_Name = 917568895;
  var kMediaRouteProvider_StartObservingMediaRoutes_Name = 1420263642;
  var kMediaRouteProvider_StopObservingMediaRoutes_Name = 1357583439;
  var kMediaRouteProvider_StartListeningForRouteMessages_Name = 1329232610;
  var kMediaRouteProvider_StopListeningForRouteMessages_Name = 759920785;
  var kMediaRouteProvider_DetachRoute_Name = 1436515269;
  var kMediaRouteProvider_EnableMdnsDiscovery_Name = 2087709404;
  var kMediaRouteProvider_UpdateMediaSinks_Name = 1408518717;
  var kMediaRouteProvider_CreateMediaRouteController_Name = 1370753578;
  var kMediaRouteProvider_GetState_Name = 56376305;
  ...
  var kMediaRouter_RegisterMediaRouteProvider_Name = 272650787;
  var kMediaRouter_OnSinksReceived_Name = 1909373982;
  var kMediaRouter_OnIssue_Name = 1744111616;
  var kMediaRouter_OnRoutesUpdated_Name = 1863644574;
  var kMediaRouter_OnSinkAvailabilityUpdated_Name = 1363524492;
  var kMediaRouter_OnPresentationConnectionStateChanged_Name = 831674382;
  var kMediaRouter_OnPresentationConnectionClosed_Name = 1372980744;
  var kMediaRouter_OnRouteMessagesReceived_Name = 619786372;
  var kMediaRouter_GetMediaSinkServiceStatus_Name = 1776746810;
  var kMediaRouter_GetLogger_Name = 157731512;
  var kMediaRouter_GetLogsAsString_Name = 986200716;
  var kMediaRouter_GetMirroringServiceHostForTab_Name = 1095075326;
  var kMediaRouter_GetMirroringServiceHostForDesktop_Name = 1409141523;
  var kMediaRouter_GetMirroringServiceHostForOffscreenTab_Name = 177315002;
  ...
  MediaRouterStub.prototype.accept = function(message) {
    ...
    case kMediaRouter_RegisterMediaRouteProvider_Name:
      ...
      this.registerMediaRouteProvider(params.providerId, params.mediaRouterProvider);
      return true;
  ...
  MediaRouter.SinkAvailability.toKnownEnumValue = function(value) {
    return value;
  };
