...
(function() {
  ...
  SVCScalabilityMode.kL2T2Key = 3;
  SVCScalabilityMode.kL2T3Key = 4;
  SVCScalabilityMode.kL3T2Key = 5;
  SVCScalabilityMode.kL3T3Key = 6;
  SVCScalabilityMode.MIN_VALUE = 0;
  SVCScalabilityMode.MAX_VALUE = 6;
  ...
  VideoFrameMetadata.decode = function(decoder) {
    ...
    val.textureOriginIsTopLeft = (packed >> 4) & 1 ? true : false;
  ...
  VideoFrameMetadata.encode = function(encoder, val) {
    ...
    packed |= (val.textureOriginIsTopLeft & 1) << 4
  ...
  StatusData.validate = function(messageValidator, offset) {
    ...
    // validate StatusData.causes
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 32, 8, new codec.PointerTo(StatusData), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  StatusData.decode = function(decoder) {
    ...
    val.causes =
        decoder.decodeArrayPointer(new codec.PointerTo(StatusData));
    val.data =
  ...
  StatusData.encode = function(encoder, val) {
    ...
    encoder.encodeArrayPointer(new codec.PointerTo(StatusData), val.causes);
