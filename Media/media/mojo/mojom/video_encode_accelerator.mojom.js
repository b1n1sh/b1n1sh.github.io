...
(function() {
  ...
  VideoEncodeAcceleratorSupportedProfile.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 32, 4, new codec.Enum(media_types$.SVCScalabilityMode), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  VideoEncodeAcceleratorSupportedProfile.encodedSize = codec.kStructHeaderSize + 40;
  ...
  function Bitrate(values) {
    this.initDefaults_();
    this.initFields_(values);
  }

  Bitrate.Mode = {};
  Bitrate.Mode.kConstant = 0;
  Bitrate.Mode.kVariable = 1;
  Bitrate.Mode.MIN_VALUE = 0;
  Bitrate.Mode.MAX_VALUE = 1;
  Bitrate.Mode.DEFAULT_VALUE = 0;

  Bitrate.Mode.isKnownEnumValue = function(value) {
    switch (value) {
    case 0:
    case 1:
      return true;
  ...
  Bitrate.Mode.toKnownEnumValue = function(value) {
    if (this.isKnownEnumValue(value))
      return value;
    return this.DEFAULT_VALUE;
  };

  Bitrate.Mode.validate = function(enumValue) {
  ...
  Bitrate.prototype.initDefaults_ = function() {
    this.mode = Bitrate.Mode.kConstant;
    this.target = 0;
    this.peak = 0;
  };
  Bitrate.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  Bitrate.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 0, Bitrate.Mode);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  Bitrate.encodedSize = codec.kStructHeaderSize + 16;
  ...
  Bitrate.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.mode =
        decoder.decodeStruct(new codec.Enum(Bitrate.Mode));
    val.target =
        decoder.decodeStruct(codec.Uint32);
    val.peak =
        decoder.decodeStruct(codec.Uint32);
  ...
  Bitrate.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(Bitrate.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.Int32, val.mode);
    encoder.encodeStruct(codec.Uint32, val.target);
    encoder.encodeStruct(codec.Uint32, val.peak);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
  ...
  VideoEncodeAcceleratorConfig.InterLayerPredMode = {};
  VideoEncodeAcceleratorConfig.InterLayerPredMode.kOff = 0;
  VideoEncodeAcceleratorConfig.InterLayerPredMode.kOn = 1;
  VideoEncodeAcceleratorConfig.InterLayerPredMode.kOnKeyPic = 2;
  VideoEncodeAcceleratorConfig.InterLayerPredMode.MIN_VALUE = 0;
  VideoEncodeAcceleratorConfig.InterLayerPredMode.MAX_VALUE = 2;

  VideoEncodeAcceleratorConfig.InterLayerPredMode.isKnownEnumValue = function(value) {
    switch (value) {
    case 0:
    case 1:
    case 2:
  ...
  VideoEncodeAcceleratorConfig.InterLayerPredMode.toKnownEnumValue = function(value) {
    return value;
  };

  VideoEncodeAcceleratorConfig.InterLayerPredMode.validate = function(enumValue) {
    const isExtensible = false;
    if (isExtensible || this.isKnownEnumValue(enumValue))
      return validator.validationError.NONE;
  ...
  VideoEncodeAcceleratorConfig.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 16, Bitrate, false);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 48, 8, new codec.PointerTo(SpatialLayer), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;


    // validate VideoEncodeAcceleratorConfig.interLayerPred
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 44, VideoEncodeAcceleratorConfig.InterLayerPredMode);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  VideoEncodeAcceleratorConfig.encodedSize = codec.kStructHeaderSize + 56;
  ...
  VideoEncodeAcceleratorConfig.decode = function(decoder) {
    ...
    val.inputVisibleSize =
        decoder.decodeStructPointer(geometry$.Size);
    val.bitrate =
        decoder.decodeStructPointer(Bitrate);
    ...
    val.interLayerPred =
        decoder.decodeStruct(new codec.Enum(VideoEncodeAcceleratorConfig.InterLayerPredMode));
    val.spatialLayers =
  ...
  VideoEncodeAcceleratorConfig.encode = function(encoder, val) {
    ...
    encoder.encodeStructPointer(Bitrate, val.bitrate);
  ...
  VideoEncodeAccelerator_RequestEncodingParametersChangeWithBitrate_Params.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, Bitrate, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  VideoEncodeAccelerator_RequestEncodingParametersChangeWithBitrate_Params.encodedSize = codec.kStructHeaderSize + 16;
  ...
  VideoEncodeAcceleratorClient_NotifyError_Params.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.error =
        decoder.decodeStruct(new codec.Enum(VideoEncodeAccelerator.Error));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  var kVideoEncodeAcceleratorProvider_CreateVideoEncodeAccelerator_Name = 220849902;
  var kVideoEncodeAcceleratorProvider_GetVideoEncodeAcceleratorSupportedProfiles_Name = 1467391679;
  ...
  var kVideoEncodeAccelerator_Initialize_Name = 1511939638;
  var kVideoEncodeAccelerator_Encode_Name = 184873937;
  var kVideoEncodeAccelerator_UseOutputBitstreamBuffer_Name = 90205298;
  var kVideoEncodeAccelerator_RequestEncodingParametersChangeWithLayers_Name = 567032913;
  var kVideoEncodeAccelerator_RequestEncodingParametersChangeWithBitrate_Name = 867558785;
  var kVideoEncodeAccelerator_IsFlushSupported_Name = 1608360320;
  var kVideoEncodeAccelerator_Flush_Name = 67113228;
  ...
  VideoEncodeAccelerator.Error.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  var kVideoEncodeAcceleratorClient_RequireBitstreamBuffers_Name = 712090251;
  var kVideoEncodeAcceleratorClient_BitstreamBufferReady_Name = 496096264;
  var kVideoEncodeAcceleratorClient_NotifyError_Name = 88759236;
  var kVideoEncodeAcceleratorClient_NotifyEncoderInfoChange_Name = 166367715;
