...
(function() {
  ...
  RendererClient_OnBufferingStateChange_Params.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.state =
        decoder.decodeStruct(new codec.Enum(media_types$.BufferingState));
    val.reason =
        decoder.decodeStruct(new codec.Enum(media_types$.BufferingStateChangeReason));
    return val;
  };
  ...
  var kRenderer_Initialize_Name = 982639567;
  var kRenderer_Flush_Name = 1385921411;
  var kRenderer_StartPlayingFrom_Name = 1254787564;
  var kRenderer_SetPlaybackRate_Name = 777099415;
  var kRenderer_SetVolume_Name = 165104315;
  var kRenderer_SetCdm_Name = 573394648;
  ...
  var kRendererClient_OnTimeUpdate_Name = 2133257961;
  var kRendererClient_OnBufferingStateChange_Name = 299499867;
  var kRendererClient_OnEnded_Name = 1495029421;
  var kRendererClient_OnError_Name = 913586555;
  var kRendererClient_OnAudioConfigChange_Name = 1500689431;
  var kRendererClient_OnVideoConfigChange_Name = 2108857183;
  var kRendererClient_OnVideoNaturalSizeChange_Name = 2039538799;
  var kRendererClient_OnVideoOpacityChange_Name = 2130711356;
  var kRendererClient_OnStatisticsUpdate_Name = 1886264324;
  var kRendererClient_OnWaiting_Name = 1266554609;
