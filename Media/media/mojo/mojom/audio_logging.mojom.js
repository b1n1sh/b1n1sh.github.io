...
(function() {
  ...
  AudioLogComponent.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  AudioLogFactory_CreateAudioLog_Params.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.component =
        decoder.decodeStruct(new codec.Enum(AudioLogComponent));
    val.componentId =
  ...
  var kAudioLog_OnCreated_Name = 1642364305;
  var kAudioLog_OnStarted_Name = 2017772768;
  var kAudioLog_OnStopped_Name = 1795821140;
  var kAudioLog_OnClosed_Name = 1806225578;
  var kAudioLog_OnError_Name = 229480306;
  var kAudioLog_OnSetVolume_Name = 469920691;
  var kAudioLog_OnProcessingStateChanged_Name = 1078421261;
  var kAudioLog_OnLogMessage_Name = 1599177056;
  ...
  var kAudioLogFactory_CreateAudioLog_Name = 1563121530;
